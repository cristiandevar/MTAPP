...
namespace GeneXus.Programs {
   public class paymentmethodgeneral : GXWebComponent
   {
      public paymentmethodgeneral( )
      {
      ...
      public paymentmethodgeneral( IGxContext context )
      {
      ...
      {
         this.A115PaymentMethodId = aP0_PaymentMethodId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A115PaymentMethodId", StringUtil.LTrimStr( (decimal)(A115PaymentMethodId), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)A115PaymentMethodId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Payment Method General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paymentmethodgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A115PaymentMethodId,6,0))}, new string[] {"PaymentMethodId"}) +"\">") ;
      ...
      {
         return "PaymentMethodGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Payment Method General" ;
      }
      ...
      protected void WB4C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paymentmethodgeneral.aspx");
            }
            ...
            GxWebStd.gx_label_element( context, edtPaymentMethodDescription_Internalname, "Method", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtPaymentMethodDescription_Internalname, A116PaymentMethodDescription, "", "", 0, 1, edtPaymentMethodDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "GeneXusUnanimo\\Description", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_PaymentMethodGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtPaymentMethodDiscount_Internalname, "Discount", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaymentMethodDiscount_Internalname, StringUtil.LTrim( StringUtil.NToC( A129PaymentMethodDiscount, 8, 2, ".", "")), StringUtil.LTrim( ((edtPaymentMethodDiscount_Enabled!=0) ? context.localUtil.Format( A129PaymentMethodDiscount, "ZZZZ9.99") : context.localUtil.Format( A129PaymentMethodDiscount, "ZZZZ9.99"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaymentMethodDiscount_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaymentMethodDiscount_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Percentage", "right", false, "", "HLP_PaymentMethodGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtPaymentMethodRecarge_Internalname, "Recarge", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPaymentMethodRecarge_Internalname, StringUtil.LTrim( StringUtil.NToC( A130PaymentMethodRecarge, 8, 2, ".", "")), StringUtil.LTrim( ((edtPaymentMethodRecarge_Enabled!=0) ? context.localUtil.Format( A130PaymentMethodRecarge, "ZZZZ9.99") : context.localUtil.Format( A130PaymentMethodRecarge, "ZZZZ9.99"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaymentMethodRecarge_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPaymentMethodRecarge_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "Percentage", "right", false, "", "HLP_PaymentMethodGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkPaymentMethodActive_Internalname, "Active", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkPaymentMethodActive_Internalname, StringUtil.BoolToStr( A117PaymentMethodActive), "", "Active", 1, chkPaymentMethodActive.Enabled, "true", "", StyleString, ClassString, "", "", "");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Payment Method General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF4C2( )
      {
         ...
         {
            /* Using cursor H004C2 */
            pr_default.execute(0, new Object[] {A115PaymentMethodId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               AssignAttri(sPrefix, false, "A129PaymentMethodDiscount", StringUtil.LTrimStr( A129PaymentMethodDiscount, 8, 2));
               A116PaymentMethodDescription = H004C2_A116PaymentMethodDescription[0];
               AssignAttri(sPrefix, false, "A116PaymentMethodDescription", A116PaymentMethodDescription);
               /* Execute user event: Load */
               E134C2 ();
      ...
      protected void STRUP4C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA115PaymentMethodId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA115PaymentMethodId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E134C2( )
      {
         ...
         AssignProp(sPrefix, false, edtPaymentMethodId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtPaymentMethodId_Visible), 5, 0), true);
      }
      ...
      protected void S112( )
      {
         ...
         AV8TrnContextAtt.gxTpr_Attributename = "PaymentMethodId";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A115PaymentMethodId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "A115PaymentMethodId", StringUtil.LTrimStr( (decimal)(A115PaymentMethodId), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA115PaymentMethodId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paymentmethodgeneral", GetJustCreated( ));
         ...
         {
            A115PaymentMethodId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "A115PaymentMethodId", StringUtil.LTrimStr( (decimal)(A115PaymentMethodId), 6, 0));
         }
         wcpOA115PaymentMethodId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA115PaymentMethodId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A115PaymentMethodId != wcpOA115PaymentMethodId ) ) )
         {
            setjustcreated();
         }
         wcpOA115PaymentMethodId = A115PaymentMethodId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA115PaymentMethodId = cgiGet( sPrefix+"A115PaymentMethodId_CTRL");
         if ( StringUtil.Len( sCtrlA115PaymentMethodId) > 0 )
         {
            A115PaymentMethodId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA115PaymentMethodId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A115PaymentMethodId", StringUtil.LTrimStr( (decimal)(A115PaymentMethodId), 6, 0));
         }
         else
         {
            A115PaymentMethodId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A115PaymentMethodId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A115PaymentMethodId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A115PaymentMethodId), 6, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA115PaymentMethodId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A115PaymentMethodId_CTRL", StringUtil.RTrim( sCtrlA115PaymentMethodId));
         }
      }
      ...
      protected void init_web_controls( )
      {
         ...
         AssignProp(sPrefix, false, chkPaymentMethodActive_Internalname, "TitleCaption", chkPaymentMethodActive.Caption, true);
      ...
      protected void init_default_properties( )
      {
         ...
         chkPaymentMethodActive_Internalname = sPrefix+"PAYMENTMETHODACTIVE";
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         chkPaymentMethodActive.Caption = "Active";
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H004C2_A115PaymentMethodId = new int[1] ;
         H004C2_A117PaymentMethodActive = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paymentmethodgeneral__default(),
            new Object[][] {
                new Object[] {
               H004C2_A115PaymentMethodId, H004C2_A117PaymentMethodActive, H004C2_A130PaymentMethodRecarge, H004C2_A129PaymentMethodDiscount, H004C2_A116PaymentMethodDescription
               }
            }
         );
         AV16Pgmname = "PaymentMethodGeneral";
      ...
      private int wcpOA115PaymentMethodId ;
      ...
      private int AV6PaymentMethodId ;
      private int idxLst ;
      ...
      private int[] H004C2_A115PaymentMethodId ;
      private bool[] H004C2_A117PaymentMethodActive ;
      private decimal[] H004C2_A130PaymentMethodRecarge ;
      private decimal[] H004C2_A129PaymentMethodDiscount ;
      private string[] H004C2_A116PaymentMethodDescription ;
   ...
   public class paymentmethodgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@PaymentMethodId",GXType.Int32,6,0)
          };
          def= new CursorDef[] {
              new CursorDef("H004C2", "SELECT [PaymentMethodId], [PaymentMethodActive], [PaymentMethodRecarge], [PaymentMethodDiscount], [PaymentMethodDescription] FROM [PaymentMethod] WHERE [PaymentMethodId] = @PaymentMethodId ORDER BY [PaymentMethodId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004C2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
