...
namespace GeneXus.Programs {
   public class aproductsrankingpurchasesubtotal1 : GXWebProcedure
   {
      ...
      public aproductsrankingpurchasesubtotal1( )
      {
      ...
      public aproductsrankingpurchasesubtotal1( IGxContext context )
      {
      ...
      public void executeSubmit( int aP0_SupplierId ,
                                 ref int aP1_SectorId )
      {
         aproductsrankingpurchasesubtotal1 objaproductsrankingpurchasesubtotal1;
         objaproductsrankingpurchasesubtotal1 = new aproductsrankingpurchasesubtotal1();
         objaproductsrankingpurchasesubtotal1.AV11SupplierId = aP0_SupplierId;
         objaproductsrankingpurchasesubtotal1.AV10SectorId = aP1_SectorId;
         objaproductsrankingpurchasesubtotal1.context.SetSubmitInitialConfig(context);
         objaproductsrankingpurchasesubtotal1.initialize();
         Submit( executePrivateCatch,objaproductsrankingpurchasesubtotal1);
         aP1_SectorId=this.AV10SectorId;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((aproductsrankingpurchasesubtotal1)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               AV19GXV1 = 1;
               while ( AV19GXV1 <= AV9Products.Count )
               {
                  AV8OneProduct = ((SdtSDTProductsRankingPurchases_SDTProductsRankingPurchasesItem)AV9Products.Item(AV19GXV1));
                  AV14Total = (decimal)(AV14Total+AV8OneProduct.gxTpr_Subtotal);
                  H0T0( false, 50) ;
                  getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(AV8OneProduct.gxTpr_Name, 0, Gx_line+13, 120, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( (decimal)(AV8OneProduct.gxTpr_Stock), "ZZZZZ9"), 147, Gx_line+13, 274, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( (decimal)(AV8OneProduct.gxTpr_Quantitypurchases), "ZZZ9"), 327, Gx_line+13, 487, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( AV8OneProduct.gxTpr_Subtotal, "ZZZZZZ9.99"), 727, Gx_line+13, 814, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( (decimal)(AV8OneProduct.gxTpr_Quantityunitspurchases), "ZZZ9"), 540, Gx_line+13, 680, Gx_line+28, 0, 0, 0, 1) ;
                  Gx_OldLine = Gx_line;
            ...
            else
            {
               if ( (0==AV11SupplierId) || (0==AV10SectorId) )
               {
                  ...
                  {
                     AV20GXV2 = 1;
                     while ( AV20GXV2 <= AV9Products.Count )
                     {
                        AV8OneProduct = ((SdtSDTProductsRankingPurchases_SDTProductsRankingPurchasesItem)AV9Products.Item(AV20GXV2));
                  ...
                  {
                     AV21GXV3 = 1;
                     while ( AV21GXV3 <= AV9Products.Count )
                     {
                        AV8OneProduct = ((SdtSDTProductsRankingPurchases_SDTProductsRankingPurchasesItem)AV9Products.Item(AV21GXV3));
               ...
               {
                  AV22GXV4 = 1;
                  while ( AV22GXV4 <= AV9Products.Count )
                  {
                     AV8OneProduct = ((SdtSDTProductsRankingPurchases_SDTProductsRankingPurchasesItem)AV9Products.Item(AV22GXV4));
            ...
            getPrinter().GxDrawText("Total", 547, Gx_line+40, 620, Gx_line+80, 2, 0, 0, 1) ;
            getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
            getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV14Total, "ZZZZZZ9.99")), 653, Gx_line+40, 717, Gx_line+80, 0, 0, 0, 1) ;
            getPrinter().GxDrawLine(7, Gx_line+27, 827, Gx_line+27, 1, 0, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxDrawText("Ranking Products Purchases", 100, Gx_line+13, 447, Gx_line+54, 0, 0, 0, 0) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Name", 0, Gx_line+93, 107, Gx_line+120, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Stock", 147, Gx_line+93, 274, Gx_line+120, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Quantity Purchase", 327, Gx_line+93, 474, Gx_line+120, 0, 0, 0, 1) ;
               ...
               getPrinter().GxAttris("Microsoft Sans Serif", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Subtotal", 727, Gx_line+93, 827, Gx_line+120, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Units Purchased", 547, Gx_line+93, 680, Gx_line+120, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aproductsrankingpurchasesubtotal1__default(),
            new Object[][] {
                new Object[] {
   ...
   public class aproductsrankingpurchasesubtotal1__default : DataStoreHelperBase, IDataStoreHelper
   {
