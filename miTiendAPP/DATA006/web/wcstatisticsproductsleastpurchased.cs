...
namespace GeneXus.Programs {
   public class wcstatisticsproductsleastpurchased : GXWebComponent
   {
      public wcstatisticsproductsleastpurchased( )
      {
      ...
      public wcstatisticsproductsleastpurchased( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCStatistics Products Least Purchased") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcstatisticsproductsleastpurchased.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV20Year,4,0)),UrlEncode(StringUtil.LTrimStr(AV14Month,4,0))}, new string[] {"Year","Month"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"QUERYVIEWERPURCHASE_Title", StringUtil.RTrim( Queryviewerpurchase_Title));
      ...
      {
         return "WCStatisticsProductsLeastPurchased" ;
      }

      public override string GetPgmdesc( )
      {
         return "WCStatistics Products Least Purchased" ;
      }
      ...
      protected void WB400( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcstatisticsproductsleastpurchased.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
            }
            ...
            ucQueryviewerpurchase.SetProperty("Elements", AV8Elements);
            ucQueryviewerpurchase.SetProperty("Parameters", AV16Parameters);
            ...
            ucQueryviewerpurchase.SetProperty("ItemClickData", AV10ItemClickData);
            ucQueryviewerpurchase.SetProperty("ItemDoubleClickData", AV12ItemDoubleClickData);
            ucQueryviewerpurchase.SetProperty("DragAndDropData", AV6DragAndDropData);
            ucQueryviewerpurchase.SetProperty("FilterChangedData", AV9FilterChangedData);
            ucQueryviewerpurchase.SetProperty("ItemExpandData", AV13ItemExpandData);
      ...
      protected void START402( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCStatistics Products Least Purchased", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP400( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Queryviewerpurchase_Title = cgiGet( sPrefix+"QUERYVIEWERPURCHASE_Title");
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcstatisticsproductsleastpurchased", GetJustCreated( ));
