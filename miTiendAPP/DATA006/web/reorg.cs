...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizePurchaseOrder( )
      {
         string cmdBuffer = "";
         /* Indices for table PurchaseOrder */
         cmdBuffer=" ALTER TABLE [PurchaseOrder] ALTER COLUMN [PurchaseOrderPaidDate] datetime NULL  "
         ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            PurchaseOrderCount = P00012_APurchaseOrderCount[0];
            pr_default.close(0);
            PrintRecordCount ( "PurchaseOrder" ,  PurchaseOrderCount );
         }
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizePurchaseOrder" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"PurchaseOrder", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_APurchaseOrderCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int PurchaseOrderCount ;
      ...
      protected int[] P00012_APurchaseOrderCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [PurchaseOrder] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
