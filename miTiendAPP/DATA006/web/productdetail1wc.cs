...
namespace GeneXus.Programs {
   public class productdetail1wc : GXWebComponent
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"USERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A99UserId), 6, 0, ".", "")));
      ...
      protected void WB2U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductDetail1WC.htm");
      ...
      protected void RF2U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A20InvoiceId = H002U7_A20InvoiceId[0];
               A99UserId = H002U7_A99UserId[0];
               A15ProductId = H002U7_A15ProductId[0];
               AssignAttri(sPrefix, false, "A15ProductId", StringUtil.LTrimStr( (decimal)(A15ProductId), 6, 0));
               A94InvoiceActive = H002U7_A94InvoiceActive[0];
               A39InvoiceModifiedDate = H002U7_A39InvoiceModifiedDate[0];
               n39InvoiceModifiedDate = H002U7_n39InvoiceModifiedDate[0];
               A100UserName = H002U7_A100UserName[0];
               A38InvoiceCreatedDate = H002U7_A38InvoiceCreatedDate[0];
               A131InvoiceLastPaymentMethodId = H002U7_A131InvoiceLastPaymentMethodId[0];
               n131InvoiceLastPaymentMethodId = H002U7_n131InvoiceLastPaymentMethodId[0];
               A68InvoiceProductQuantity = H002U7_A68InvoiceProductQuantity[0];
               n68InvoiceProductQuantity = H002U7_n68InvoiceProductQuantity[0];
               A80InvoiceTotalReceivable = H002U7_A80InvoiceTotalReceivable[0];
               n80InvoiceTotalReceivable = H002U7_n80InvoiceTotalReceivable[0];
               A99UserId = H002U7_A99UserId[0];
               A94InvoiceActive = H002U7_A94InvoiceActive[0];
               A39InvoiceModifiedDate = H002U7_A39InvoiceModifiedDate[0];
               n39InvoiceModifiedDate = H002U7_n39InvoiceModifiedDate[0];
      ...
      {
         /* Using cursor H002U13 */
         pr_default.execute(1, new Object[] {AV6ProductId});
         GRID_nRecordCount = H002U13_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E112U2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         new exportproductdetail1wc(context ).execute(  AV6ProductId, out  AV15ExcelFilename, out  AV16ErrorMessage) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241261104694", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productdetail1wc.js", "?20241261104695", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtUserName_Internalname = sPrefix+"USERNAME_"+sGXsfl_22_idx;
         ...
         edtInvoiceLastPaymentMethodId_Internalname = sPrefix+"INVOICELASTPAYMENTMETHODID_"+sGXsfl_22_idx;
      }
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtUserName_Internalname = sPrefix+"USERNAME_"+sGXsfl_22_fel_idx;
         ...
         edtInvoiceLastPaymentMethodId_Internalname = sPrefix+"INVOICELASTPAYMENTMETHODID_"+sGXsfl_22_fel_idx;
      }
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvoiceTotalReceivable_Internalname,StringUtil.LTrim( StringUtil.NToC( A80InvoiceTotalReceivable, 18, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A80InvoiceTotalReceivable, "ZZZZZZZZZZZZZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtInvoiceTotalReceivable_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Price",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvoiceLastPaymentMethodId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A131InvoiceLastPaymentMethodId), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A131InvoiceLastPaymentMethodId), "ZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtInvoiceLastPaymentMethodId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
      ...
      protected void StartGridControl22( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A131InvoiceLastPaymentMethodId), 6, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E132U2',iparms:[{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtUserName_Link',ctrl:'USERNAME',prop:'Link'}]}");
         setEventMetadata("'DOEXPORT'","{handler:'E112U2',iparms:[{av:'AV6ProductId',fld:'vPRODUCTID',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Invoicelastpaymentmethodid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002U7_A25InvoiceDetailId = new int[1] ;
         H002U7_A20InvoiceId = new int[1] ;
         H002U7_A99UserId = new int[1] ;
         H002U7_A15ProductId = new int[1] ;
         H002U7_A94InvoiceActive = new bool[] {false} ;
         H002U7_A39InvoiceModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H002U7_n39InvoiceModifiedDate = new bool[] {false} ;
         H002U7_A100UserName = new string[] {""} ;
         H002U7_A38InvoiceCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H002U7_A131InvoiceLastPaymentMethodId = new int[1] ;
         H002U7_n131InvoiceLastPaymentMethodId = new bool[] {false} ;
         H002U7_A68InvoiceProductQuantity = new short[1] ;
         H002U7_n68InvoiceProductQuantity = new bool[] {false} ;
         H002U7_A80InvoiceTotalReceivable = new decimal[1] ;
         H002U7_n80InvoiceTotalReceivable = new bool[] {false} ;
         H002U13_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productdetail1wc__default(),
            new Object[][] {
                new Object[] {
               H002U7_A25InvoiceDetailId, H002U7_A20InvoiceId, H002U7_A99UserId, H002U7_A15ProductId, H002U7_A94InvoiceActive, H002U7_A39InvoiceModifiedDate, H002U7_n39InvoiceModifiedDate, H002U7_A100UserName, H002U7_A38InvoiceCreatedDate, H002U7_A131InvoiceLastPaymentMethodId,
               H002U7_n131InvoiceLastPaymentMethodId, H002U7_A68InvoiceProductQuantity, H002U7_n68InvoiceProductQuantity, H002U7_A80InvoiceTotalReceivable, H002U7_n80InvoiceTotalReceivable
               }
               , new Object[] {
               H002U13_AGRID_nRecordCount
               }
            }
         );
         AV19Pgmname = "ProductDetail1WC";
      ...
      private int[] H002U7_A25InvoiceDetailId ;
      private int[] H002U7_A20InvoiceId ;
      private int[] H002U7_A99UserId ;
      private int[] H002U7_A15ProductId ;
      private bool[] H002U7_A94InvoiceActive ;
      private DateTime[] H002U7_A39InvoiceModifiedDate ;
      private bool[] H002U7_n39InvoiceModifiedDate ;
      private string[] H002U7_A100UserName ;
      private DateTime[] H002U7_A38InvoiceCreatedDate ;
      private int[] H002U7_A131InvoiceLastPaymentMethodId ;
      private bool[] H002U7_n131InvoiceLastPaymentMethodId ;
      private short[] H002U7_A68InvoiceProductQuantity ;
      private bool[] H002U7_n68InvoiceProductQuantity ;
      private decimal[] H002U7_A80InvoiceTotalReceivable ;
      private bool[] H002U7_n80InvoiceTotalReceivable ;
      private long[] H002U13_AGRID_nRecordCount ;
   ...
   public class productdetail1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH002U13;
          prmH002U13 = new Object[] {
          new ParDef("@AV6ProductId",GXType.Int32,6,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002U7", "SELECT T1.[InvoiceDetailId], T1.[InvoiceId], T2.[UserId], T1.[ProductId], T2.[InvoiceActive], T2.[InvoiceModifiedDate], T3.[UserName], T2.[InvoiceCreatedDate], COALESCE( T4.[InvoiceLastPaymentMethodId], 0) AS InvoiceLastPaymentMethodId, COALESCE( T5.[InvoiceProductQuantity], 0) AS InvoiceProductQuantity, COALESCE( T6.[InvoiceTotalReceivable], 0) AS InvoiceTotalReceivable FROM ((((([InvoiceDetail] T1 INNER JOIN [Invoice] T2 ON T2.[InvoiceId] = T1.[InvoiceId]) INNER JOIN [User] T3 ON T3.[UserId] = T2.[UserId]) LEFT JOIN (SELECT MAX([InvoicePaymentMethodId]) AS InvoiceLastPaymentMethodId, [InvoiceId] FROM [InvoicePaymentMethod] GROUP BY [InvoiceId] ) T4 ON T4.[InvoiceId] = T1.[InvoiceId]) LEFT JOIN (SELECT COUNT(*) AS InvoiceProductQuantity, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T5 ON T5.[InvoiceId] = T1.[InvoiceId]) INNER JOIN (SELECT COALESCE( T9.[GXC1], 0) - COALESCE( T8.[GXC2], 0) + COALESCE( T8.[GXC3], 0) AS InvoiceTotalReceivable, T7.[InvoiceId] FROM (([Invoice] T7 LEFT JOIN (SELECT SUM([InvoicePaymentMethodDiscountIm]) AS GXC2, [InvoiceId], SUM([InvoicePaymentMethodRechargeIm]) AS GXC3 FROM [InvoicePaymentMethod] GROUP BY [InvoiceId] ) T8 ON T8.[InvoiceId] = T7.[InvoiceId]) LEFT JOIN (SELECT SUM([InvoiceDetailQuantity] * CAST([InvoiceDetailHistoricPrice] AS decimal( 28, 10))) AS GXC1, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T9 ON T9.[InvoiceId] = T7.[InvoiceId]) ) T6 ON T6.[InvoiceId] = T1.[InvoiceId]) WHERE T1.[ProductId] = @AV6ProductId ORDER BY T1.[ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002U7,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002U13", "SELECT COUNT(*) FROM ((((([InvoiceDetail] T1 INNER JOIN [Invoice] T2 ON T2.[InvoiceId] = T1.[InvoiceId]) INNER JOIN [User] T3 ON T3.[UserId] = T2.[UserId]) LEFT JOIN (SELECT MAX([InvoicePaymentMethodId]) AS InvoiceLastPaymentMethodId, [InvoiceId] FROM [InvoicePaymentMethod] GROUP BY [InvoiceId] ) T4 ON T4.[InvoiceId] = T1.[InvoiceId]) LEFT JOIN (SELECT COUNT(*) AS InvoiceProductQuantity, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T5 ON T5.[InvoiceId] = T1.[InvoiceId]) INNER JOIN (SELECT COALESCE( T9.[GXC1], 0) - COALESCE( T8.[GXC2], 0) + COALESCE( T8.[GXC3], 0) AS InvoiceTotalReceivable, T7.[InvoiceId] FROM (([Invoice] T7 LEFT JOIN (SELECT SUM([InvoicePaymentMethodDiscountIm]) AS GXC2, [InvoiceId], SUM([InvoicePaymentMethodRechargeIm]) AS GXC3 FROM [InvoicePaymentMethod] GROUP BY [InvoiceId] ) T8 ON T8.[InvoiceId] = T7.[InvoiceId]) LEFT JOIN (SELECT SUM([InvoiceDetailQuantity] * CAST([InvoiceDetailHistoricPrice] AS decimal( 28, 10))) AS GXC1, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T9 ON T9.[InvoiceId] = T7.[InvoiceId]) ) T6 ON T6.[InvoiceId] = T1.[InvoiceId]) WHERE T1.[ProductId] = @AV6ProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002U13,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
