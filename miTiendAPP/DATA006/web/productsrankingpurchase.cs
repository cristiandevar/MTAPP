...
namespace GeneXus.Programs {
   public class productsrankingpurchase : GXProcedure
   {
      public productsrankingpurchase( )
      {
      ...
      public productsrankingpurchase( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_Name ,
                                 ...
                                 ref short aP6_Order )
      {
         productsrankingpurchase objproductsrankingpurchase;
         objproductsrankingpurchase = new productsrankingpurchase();
         objproductsrankingpurchase.AV2Name = aP0_Name;
         objproductsrankingpurchase.AV3SupplierId = aP1_SupplierId;
         objproductsrankingpurchase.AV4SectorId = aP2_SectorId;
         objproductsrankingpurchase.AV5BrandId = aP3_BrandId;
         objproductsrankingpurchase.AV6FromDate = aP4_FromDate;
         objproductsrankingpurchase.AV7ToDate = aP5_ToDate;
         objproductsrankingpurchase.AV8Order = aP6_Order;
         objproductsrankingpurchase.context.SetSubmitInitialConfig(context);
         objproductsrankingpurchase.initialize();
         Submit( executePrivateCatch,objproductsrankingpurchase);
         aP1_SupplierId=this.AV3SupplierId;
         aP2_SectorId=this.AV4SectorId;
         aP3_BrandId=this.AV5BrandId;
         aP4_FromDate=this.AV6FromDate;
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((productsrankingpurchase)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         ClassLoader.Execute("aproductsrankingpurchase","GeneXus.Programs","aproductsrankingpurchase", new Object[] {context }, "execute", args);
