...
namespace GeneXus.Programs {
   public class wwhistoryofdircardedproducts : GXDataArea
   {
      public wwhistoryofdircardedproducts( )
      {
      ...
      public wwhistoryofdircardedproducts( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11HistoryOfDircardedProductsDescription = GetPar( "HistoryOfDircardedProductsDescription");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11HistoryOfDircardedProductsDescription, AV12Update, AV13Delete, A81HistoryOfDircardedProductsId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwhistoryofdircardedproducts.aspx") +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "HISTORYOFDIRCARDEDPRODUCTSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A81HistoryOfDircardedProductsId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_HISTORYOFDIRCARDEDPRODUCTSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A81HistoryOfDircardedProductsId), "ZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vHISTORYOFDIRCARDEDPRODUCTSDESCRIPTION", AV11HistoryOfDircardedProductsDescription);
         /* Send saved values. */
      ...
      {
         return formatLink("wwhistoryofdircardedproducts.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWHistoryOfDircardedProducts" ;
      }
      ...
      protected void WB2D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "History Of Dircarded Products", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWHistoryOfDircardedProducts.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWHistoryOfDircardedProducts.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavHistoryofdircardedproductsdescription_Internalname, "History Of Dircarded Products Description", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Multiple line edit */
            ...
            ClassString = "attribute-search";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavHistoryofdircardedproductsdescription_Internalname, AV11HistoryOfDircardedProductsDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", 0, 1, edtavHistoryofdircardedproductsdescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "Products Description", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWHistoryOfDircardedProducts.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Historyofdircardedproductsdescription Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vHISTORYOFDIRCARDEDPRODUCTSDESCRIPTION"), AV11HistoryOfDircardedProductsDescription) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA2D2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavHistoryofdircardedproductsdescription_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11HistoryOfDircardedProductsDescription ,
                                       string AV12Update ,
                                       string AV13Delete ,
                                       int A81HistoryOfDircardedProductsId )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         /* GeneXus formulas. */
         AV17Pgmname = "WWHistoryOfDircardedProducts";
         context.Gx_err = 0;
      ...
      protected void RF2D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11HistoryOfDircardedProductsDescription ,
                                                 A82HistoryOfDircardedProductsDesc } ,
                                                 new int[]{
                                                 }
            });
            lV11HistoryOfDircardedProductsDescription = StringUtil.Concat( StringUtil.RTrim( AV11HistoryOfDircardedProductsDescription), "%", "");
            /* Using cursor H002D2 */
            pr_default.execute(0, new Object[] {lV11HistoryOfDircardedProductsDescription, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A81HistoryOfDircardedProductsId = H002D2_A81HistoryOfDircardedProductsId[0];
               A17ProductStock = H002D2_A17ProductStock[0];
               A82HistoryOfDircardedProductsDesc = H002D2_A82HistoryOfDircardedProductsDesc[0];
               A84HistoryOfDircardedProductsQuan = H002D2_A84HistoryOfDircardedProductsQuan[0];
               A16ProductName = H002D2_A16ProductName[0];
               A15ProductId = H002D2_A15ProductId[0];
               A83HistoryOfDircardedProductsDate = H002D2_A83HistoryOfDircardedProductsDate[0];
               A17ProductStock = H002D2_A17ProductStock[0];
               A16ProductName = H002D2_A16ProductName[0];
               E142D2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11HistoryOfDircardedProductsDescription = StringUtil.Concat( StringUtil.RTrim( AV11HistoryOfDircardedProductsDescription), "%", "");
         /* Using cursor H002D3 */
         pr_default.execute(1, new Object[] {lV11HistoryOfDircardedProductsDescription});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11HistoryOfDircardedProductsDescription = GridState.FilterValues("Historyofdircardedproductsdescription");
            AssignAttri("", false, "AV11HistoryOfDircardedProductsDescription", AV11HistoryOfDircardedProductsDescription);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("HistoryOfDircardedProductsDescription", AV11HistoryOfDircardedProductsDescription);
      }
      ...
      protected void STRUP2D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11HistoryOfDircardedProductsDescription = cgiGet( edtavHistoryofdircardedproductsdescription_Internalname);
            AssignAttri("", false, "AV11HistoryOfDircardedProductsDescription", AV11HistoryOfDircardedProductsDescription);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "HistoryOfDircardedProducts";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023121823153732", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwhistoryofdircardedproducts.js", "?2023121823153732", false, true);
         }
      ...
      {
         edtHistoryOfDircardedProductsDate_Internalname = "HISTORYOFDIRCARDEDPRODUCTSDATE_"+sGXsfl_27_idx;
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_27_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_27_idx;
         edtHistoryOfDircardedProductsQuan_Internalname = "HISTORYOFDIRCARDEDPRODUCTSQUAN_"+sGXsfl_27_idx;
         edtHistoryOfDircardedProductsDesc_Internalname = "HISTORYOFDIRCARDEDPRODUCTSDESC_"+sGXsfl_27_idx;
      ...
      {
         edtHistoryOfDircardedProductsDate_Internalname = "HISTORYOFDIRCARDEDPRODUCTSDATE_"+sGXsfl_27_fel_idx;
         edtProductId_Internalname = "PRODUCTID_"+sGXsfl_27_fel_idx;
         edtProductName_Internalname = "PRODUCTNAME_"+sGXsfl_27_fel_idx;
         edtHistoryOfDircardedProductsQuan_Internalname = "HISTORYOFDIRCARDEDPRODUCTSQUAN_"+sGXsfl_27_fel_idx;
         edtHistoryOfDircardedProductsDesc_Internalname = "HISTORYOFDIRCARDEDPRODUCTSDESC_"+sGXsfl_27_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavHistoryofdircardedproductsdescription_Internalname = "vHISTORYOFDIRCARDEDPRODUCTSDESCRIPTION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavHistoryofdircardedproductsdescription_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11HistoryOfDircardedProductsDescription',fld:'vHISTORYOFDIRCARDEDPRODUCTSDESCRIPTION',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'A81HistoryOfDircardedProductsId',fld:'HISTORYOFDIRCARDEDPRODUCTSID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E142D2',iparms:[{av:'A81HistoryOfDircardedProductsId',fld:'HISTORYOFDIRCARDEDPRODUCTSID',pic:'ZZZZZ9',hsh:true},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtProductName_Link',ctrl:'PRODUCTNAME',prop:'Link'},{av:'edtHistoryOfDircardedProductsDesc_Link',ctrl:'HISTORYOFDIRCARDEDPRODUCTSDESC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E112D2',iparms:[{av:'A81HistoryOfDircardedProductsId',fld:'HISTORYOFDIRCARDEDPRODUCTSID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11HistoryOfDircardedProductsDescription = "";
         H002D2_A81HistoryOfDircardedProductsId = new int[1] ;
         H002D2_A17ProductStock = new int[1] ;
         H002D2_A82HistoryOfDircardedProductsDesc = new string[] {""} ;
         H002D2_A84HistoryOfDircardedProductsQuan = new short[1] ;
         H002D2_A16ProductName = new string[] {""} ;
         H002D2_A15ProductId = new int[1] ;
         H002D2_A83HistoryOfDircardedProductsDate = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwhistoryofdircardedproducts__default(),
            new Object[][] {
                new Object[] {
               H002D2_A81HistoryOfDircardedProductsId, H002D2_A17ProductStock, H002D2_A82HistoryOfDircardedProductsDesc, H002D2_A84HistoryOfDircardedProductsQuan, H002D2_A16ProductName, H002D2_A15ProductId, H002D2_A83HistoryOfDircardedProductsDate
               }
               , new Object[] {
      ...
      private int edtavHistoryofdircardedproductsdescription_Enabled ;
      ...
      private string edtavHistoryofdircardedproductsdescription_Internalname ;
      ...
      private string AV11HistoryOfDircardedProductsDescription ;
      private string A16ProductName ;
      private string A82HistoryOfDircardedProductsDesc ;
      private string lV11HistoryOfDircardedProductsDescription ;
      ...
      private int[] H002D2_A81HistoryOfDircardedProductsId ;
      private int[] H002D2_A17ProductStock ;
      private string[] H002D2_A82HistoryOfDircardedProductsDesc ;
      private short[] H002D2_A84HistoryOfDircardedProductsQuan ;
      private string[] H002D2_A16ProductName ;
      private int[] H002D2_A15ProductId ;
      private DateTime[] H002D2_A83HistoryOfDircardedProductsDate ;
   ...
   public class wwhistoryofdircardedproducts__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H002D2( IGxContext context ,
                                             string AV11HistoryOfDircardedProductsDescription ,
                                             string A82HistoryOfDircardedProductsDesc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[HistoryOfDircardedProductsId], T2.[ProductStock], T1.[HistoryOfDircardedProductsDesc], T1.[HistoryOfDircardedProductsQuan], T2.[ProductName], T1.[ProductId], T1.[HistoryOfDircardedProductsDate]";
         sFromString = " FROM ([HistoryOfDircardedProducts] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11HistoryOfDircardedProductsDescription)) )
         {
            AddWhere(sWhereString, "(T1.[HistoryOfDircardedProductsDesc] like @lV11HistoryOfDircardedProductsDescription)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[HistoryOfDircardedProductsDesc]";
                                             ...
                                             string A82HistoryOfDircardedProductsDesc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([HistoryOfDircardedProducts] T1 INNER JOIN [Product] T2 ON T2.[ProductId] = T1.[ProductId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11HistoryOfDircardedProductsDescription)) )
         {
            AddWhere(sWhereString, "(T1.[HistoryOfDircardedProductsDesc] like @lV11HistoryOfDircardedProductsDescription)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002D2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H002D3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11HistoryOfDircardedProductsDescription",GXType.NVarChar,200,0) ,
