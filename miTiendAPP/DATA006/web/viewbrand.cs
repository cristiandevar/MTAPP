...
namespace GeneXus.Programs {
   public class viewbrand : GXDataArea
   {
      public viewbrand( )
      {
      ...
      public viewbrand( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12BrandId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12BrandId", StringUtil.LTrimStr( (decimal)(AV12BrandId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vBRANDID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BrandId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewbrand.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12BrandId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"BrandId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vBRANDID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12BrandId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBRANDID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BrandId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewBrand");
         forbiddenHiddens.Add("BrandName", StringUtil.RTrim( context.localUtil.Format( A2BrandName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewbrand:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewbrand.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12BrandId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"BrandId","TabCode"})  ;
      }
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Brands", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewBrand.htm");
            ...
            GxWebStd.gx_label_element( context, edtBrandName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBrandName_Internalname, A2BrandName, StringUtil.RTrim( context.localUtil.Format( A2BrandName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBrandName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtBrandName_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_ViewBrand.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewBrand.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewBrand.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0E2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Brand", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0E2( )
      {
         ...
         {
            /* Using cursor H000E2 */
            pr_default.execute(0, new Object[] {AV12BrandId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1BrandId = H000E2_A1BrandId[0];
               A2BrandName = H000E2_A2BrandName[0];
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("viewbrand:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E120E2( )
      {
         ...
         AV16GXLvl16 = 0;
         /* Using cursor H000E3 */
         pr_default.execute(1, new Object[] {AV12BrandId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A1BrandId = H000E3_A1BrandId[0];
            A2BrandName = H000E3_A2BrandName[0];
            AssignAttri("", false, "A2BrandName", A2BrandName);
            AV16GXLvl16 = 1;
            Form.Caption = A2BrandName;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwbrand.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BrandGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "brandgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BrandGeneral";
               WebComp_Generalwc_Component = "BrandGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12BrandId});
         ...
         if ( ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) ) && new haspermission(context).executeUdp(  "product view") )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "BrandProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "brandproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "BrandProductWC";
               WebComp_Productwc_Component = "BrandProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12BrandId});
         ...
         else
         {
            AV7SelectedTabCode = "";
            AssignAttri("", false, "AV7SelectedTabCode", AV7SelectedTabCode);
            this.executeUsercontrolMethod("", false, "TABContainer", "ShowTab", "", new Object[] {(short)1});
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12BrandId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12BrandId", StringUtil.LTrimStr( (decimal)(AV12BrandId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vBRANDID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BrandId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241115213413", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewbrand.js", "?20241115213414", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12BrandId',fld:'vBRANDID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A2BrandName',fld:'BRANDNAME',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TAB.TABCHANGED","{handler:'E110E2',iparms:[{av:'Tab_Activepagecontrolname',ctrl:'TAB',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV7SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV12BrandId',fld:'vBRANDID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("TAB.TABCHANGED",",oparms:[{av:'AV7SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'},{ctrl:'PRODUCTWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000E2_A1BrandId = new int[1] ;
         H000E2_A2BrandName = new string[] {""} ;
         hsh = "";
         GXt_SdtSDTContextSession1 = new GeneXus.Programs.general.ui.SdtSDTContextSession(context);
         H000E3_A1BrandId = new int[1] ;
         H000E3_A2BrandName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewbrand__default(),
            new Object[][] {
                new Object[] {
               H000E2_A1BrandId, H000E2_A2BrandName
               }
               , new Object[] {
               H000E3_A1BrandId, H000E3_A2BrandName
               }
            }
         );
      ...
      private int AV12BrandId ;
      private int wcpOAV12BrandId ;
      ...
      private int[] H000E2_A1BrandId ;
      private string[] H000E2_A2BrandName ;
      private int[] H000E3_A1BrandId ;
      private string[] H000E3_A2BrandName ;
   ...
   public class viewbrand__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12BrandId",GXType.Int32,6,0)
          };
          Object[] prmH000E3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000E2", "SELECT [BrandId], [BrandName] FROM [Brand] WHERE [BrandId] = @AV12BrandId ORDER BY [BrandId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000E3", "SELECT [BrandId], [BrandName] FROM [Brand] WHERE [BrandId] = @AV12BrandId ORDER BY [BrandId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
