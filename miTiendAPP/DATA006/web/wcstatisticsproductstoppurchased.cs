...
namespace GeneXus.Programs {
   public class wcstatisticsproductstoppurchased : GXWebComponent
   {
      public wcstatisticsproductstoppurchased( )
      {
      ...
      public wcstatisticsproductstoppurchased( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCStatistics Products Top Purchased") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcstatisticsproductstoppurchased.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV20Year,4,0)),UrlEncode(StringUtil.LTrimStr(AV14Month,4,0))}, new string[] {"Year","Month"}) +"\">") ;
      ...
      {
         return "WCStatisticsProductsTopPurchased" ;
      }

      public override string GetPgmdesc( )
      {
         return "WCStatistics Products Top Purchased" ;
      }
      ...
      protected void WB3Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcstatisticsproductstoppurchased.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
            }
      ...
      protected void START3Y2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCStatistics Products Top Purchased", 0) ;
            }
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcstatisticsproductstoppurchased", GetJustCreated( ));
