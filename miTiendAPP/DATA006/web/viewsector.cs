   ...
   public class viewsector : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12SectorId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12SectorId", StringUtil.LTrimStr( (decimal)(AV12SectorId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewsector.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SectorId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SectorId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSECTORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12SectorId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZZZ9"), context));
         ...
         forbiddenHiddens.Add("SectorName", StringUtil.RTrim( context.localUtil.Format( A10SectorName, "")));
      ...
      {
         return formatLink("viewsector.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12SectorId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"SectorId","TabCode"})  ;
      }
      ...
      protected void WB150( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtSectorName_Internalname, "Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSectorName_Internalname, A10SectorName, StringUtil.RTrim( context.localUtil.Format( A10SectorName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtSectorName_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_ViewSector.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduct_title_Internalname, "Product", "", "", lblProduct_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewSector.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void RF152( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9SectorId = H00152_A9SectorId[0];
               A10SectorName = H00152_A10SectorName[0];
      ...
      protected void E12152( )
      {
         ...
         {
            A9SectorId = H00153_A9SectorId[0];
            A10SectorName = H00153_A10SectorName[0];
            AssignAttri("", false, "A10SectorName", A10SectorName);
            AV16GXLvl16 = 1;
            Form.Caption = A10SectorName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12SectorId});
         ...
         if ( ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Product") == 0 ) ) && new haspermission(context).executeUdp(  "product view") )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productwc_Component), StringUtil.Lower( "SectorProductWC")) != 0 )
            {
               WebComp_Productwc = getWebComponent(GetType(), "GeneXus.Programs", "sectorproductwc", new Object[] {context} );
               WebComp_Productwc.ComponentInit();
               WebComp_Productwc.Name = "SectorProductWC";
               WebComp_Productwc_Component = "SectorProductWC";
            }
            if ( StringUtil.Len( WebComp_Productwc_Component) != 0 )
            {
               WebComp_Productwc.setjustcreated();
               WebComp_Productwc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12SectorId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12SectorId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12SectorId", StringUtil.LTrimStr( (decimal)(AV12SectorId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECTORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12SectorId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241115213692", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewsector.js", "?20241115213694", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12SectorId',fld:'vSECTORID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A10SectorName',fld:'SECTORNAME',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("TAB.TABCHANGED","{handler:'E11152',iparms:[{av:'Tab_Activepagecontrolname',ctrl:'TAB',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV7SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV12SectorId',fld:'vSECTORID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00152_A9SectorId = new int[1] ;
         H00152_A10SectorName = new string[] {""} ;
         hsh = "";
         GXt_SdtSDTContextSession1 = new GeneXus.Programs.general.ui.SdtSDTContextSession(context);
         H00153_A9SectorId = new int[1] ;
         H00153_A10SectorName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewsector__default(),
            new Object[][] {
                new Object[] {
               H00152_A9SectorId, H00152_A10SectorName
               }
               , new Object[] {
               H00153_A9SectorId, H00153_A10SectorName
               }
            }
         );
      ...
      private int[] H00152_A9SectorId ;
      private string[] H00152_A10SectorName ;
      private int[] H00153_A9SectorId ;
      private string[] H00153_A10SectorName ;
   ...
   public class viewsector__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00152", "SELECT [SectorId], [SectorName] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00152,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00153", "SELECT [SectorId], [SectorName] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00153,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
