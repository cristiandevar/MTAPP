...
namespace GeneXus.Programs {
   public class alistproductsprice : GXWebProcedure
   {
      ...
      public alistproductsprice( IGxContext context )
      {
      ...
      {
         alistproductsprice objalistproductsprice;
         objalistproductsprice = new alistproductsprice();
         objalistproductsprice.AV8Supplier = aP0_Supplier;
         objalistproductsprice.context.SetSubmitInitialConfig(context);
         objalistproductsprice.initialize();
         Submit( executePrivateCatch,objalistproductsprice);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((alistproductsprice)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A4SupplierId = P000K2_A4SupplierId[0];
               A29ProductModifiedDate = P000K2_A29ProductModifiedDate[0];
               n29ProductModifiedDate = P000K2_n29ProductModifiedDate[0];
               A28ProductCreatedDate = P000K2_A28ProductCreatedDate[0];
               A69ProductMiniumStock = P000K2_A69ProductMiniumStock[0];
               A17ProductStock = P000K2_A17ProductStock[0];
               A55ProductCode = P000K2_A55ProductCode[0];
               n55ProductCode = P000K2_n55ProductCode[0];
               A16ProductName = P000K2_A16ProductName[0];
               A18ProductPrice = P000K2_A18ProductPrice[0];
               A15ProductId = P000K2_A15ProductId[0];
               H0K0( false, 100) ;
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm = "";
         scmdbuf = "";
         P000K2_A4SupplierId = new int[1] ;
         P000K2_A29ProductModifiedDate = new DateTime[] {DateTime.MinValue} ;
         P000K2_n29ProductModifiedDate = new bool[] {false} ;
         P000K2_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         P000K2_A69ProductMiniumStock = new int[1] ;
         P000K2_A17ProductStock = new int[1] ;
         P000K2_A55ProductCode = new string[] {""} ;
         P000K2_n55ProductCode = new bool[] {false} ;
         P000K2_A16ProductName = new string[] {""} ;
         P000K2_A18ProductPrice = new decimal[1] ;
         P000K2_A15ProductId = new int[1] ;
         ...
         A5SupplierName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.alistproductsprice__default(),
            new Object[][] {
                new Object[] {
               P000K2_A4SupplierId, P000K2_A29ProductModifiedDate, P000K2_n29ProductModifiedDate, P000K2_A28ProductCreatedDate, P000K2_A69ProductMiniumStock, P000K2_A17ProductStock, P000K2_A55ProductCode, P000K2_n55ProductCode, P000K2_A16ProductName, P000K2_A18ProductPrice,
               P000K2_A15ProductId
               }
            }
         );
      ...
      private int[] P000K2_A4SupplierId ;
      private DateTime[] P000K2_A29ProductModifiedDate ;
      private bool[] P000K2_n29ProductModifiedDate ;
      private DateTime[] P000K2_A28ProductCreatedDate ;
      private int[] P000K2_A69ProductMiniumStock ;
      private int[] P000K2_A17ProductStock ;
      private string[] P000K2_A55ProductCode ;
      private bool[] P000K2_n55ProductCode ;
      private string[] P000K2_A16ProductName ;
      private decimal[] P000K2_A18ProductPrice ;
      private int[] P000K2_A15ProductId ;
   }

   public class alistproductsprice__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A4SupplierId )
      {
         ...
         scmdbuf = "SELECT [SupplierId], [ProductModifiedDate], [ProductCreatedDate], [ProductMiniumStock], [ProductStock], [ProductCode], [ProductName], [ProductPrice], [ProductId] FROM [Product]";
         if ( ! (0==AV8Supplier) )
         {
         ...
         scmdbuf += " ORDER BY [ProductPrice], [ProductName], [ProductCode]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P000K2(context, (short)dynConstraints[0] , (int)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000K2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000K2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
