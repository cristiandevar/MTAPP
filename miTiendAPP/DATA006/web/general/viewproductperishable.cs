...
namespace GeneXus.Programs.general {
   public class viewproductperishable : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("general.viewproductperishable.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductPerishableId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductPerishableId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("general\\viewproductperishable:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("general.viewproductperishable.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProductPerishableId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProductPerishableId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "General.ViewProductPerishable" ;
      }
      ...
      protected void WB1L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Product Perishables", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_General\\ViewProductPerishable.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_General\\ViewProductPerishable.htm");
            /* Div Control */
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "General.ViewProductPerishable";
         context.Gx_err = 0;
      }
      ...
      protected void STRUP1L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProductPerishableId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vPRODUCTPERISHABLEID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("general\\viewproductperishable:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111L2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            lblViewall_Link = formatLink("general.wwproductperishable.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "General.ProductPerishableGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "general.productperishablegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "General.ProductPerishableGeneral";
               WebComp_Generalwc_Component = "General.ProductPerishableGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12ProductPerishableId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311322331676", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/viewproductperishable.js", "?202311322331676", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.general.viewproductperishable__default(),
            new Object[][] {
                new Object[] {
