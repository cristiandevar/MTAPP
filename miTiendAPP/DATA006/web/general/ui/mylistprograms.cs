...
namespace GeneXus.Programs.general.ui {
   public class mylistprograms : GXProcedure
   {
      public mylistprograms( )
      {
      ...
      public mylistprograms( IGxContext context )
      {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "mtaKB") ;
         initialize();
         executePrivate();
      ...
      {
         mylistprograms objmylistprograms;
         objmylistprograms = new mylistprograms();
         objmylistprograms.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "mtaKB") ;
         objmylistprograms.context.SetSubmitInitialConfig(context);
         objmylistprograms.initialize();
         Submit( executePrivateCatch,objmylistprograms);
         aP0_ProgramNames=this.AV9ProgramNames;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((mylistprograms)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "mtaKB");
         this.cleanup();
      }
