   ...
   public class viewinvoice : GXDataArea
   {
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Invoices", "", "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, lblViewall_Enabled, 1, 0, "HLP_ViewInvoice.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablefixeddata_1_Internalname, divTablefixeddata_1_Visible, 0, "px", 0, "px", "Flex ww__view__title-table", "left", "top", " "+"data-gx-flex"+" ", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", " "+"classref"+" ", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtUserId_Internalname, "Id", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtUserId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A99UserId), 6, 0, ".", "")), StringUtil.LTrim( ((edtUserId_Enabled!=0) ? context.localUtil.Format( (decimal)(A99UserId), "ZZZZZ9") : context.localUtil.Format( (decimal)(A99UserId), "ZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUserId_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtUserId_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_ViewInvoice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablefixeddata_2_Internalname, divTablefixeddata_2_Visible, 0, "px", 0, "px", "Flex ww__view__title-table", "left", "top", " "+"data-gx-flex"+" ", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", " "+"classref"+" ", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtInvoiceCreatedDate_Internalname, "Created Date", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtInvoiceCreatedDate_Internalname, context.localUtil.Format(A38InvoiceCreatedDate, "99/99/99"), context.localUtil.Format( A38InvoiceCreatedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvoiceCreatedDate_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtInvoiceCreatedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_ViewInvoice.htm");
            GxWebStd.gx_bitmap( context, edtInvoiceCreatedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtInvoiceCreatedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewInvoice.htm");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0032"+"", StringUtil.RTrim( WebComp_Generalwc_Component));
               context.WriteHtmlText( "<div") ;
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0040"+"", StringUtil.RTrim( WebComp_Detailwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaymentmethod_title_Internalname, "Payment Method", "", "", lblPaymentmethod_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewInvoice.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0048"+"", StringUtil.RTrim( WebComp_Paymentmethodwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 32 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
                           {
                              WebComp_Generalwc.componentprocess("W0032", "", sEvt);
                           }
                           WebComp_Generalwc_Component = OldGeneralwc;
                        }
                        else if ( nCmpId == 40 )
                        {
                           OldDetailwc = cgiGet( "W0040");
                           ...
                           if ( StringUtil.Len( WebComp_Detailwc_Component) != 0 )
                           {
                              WebComp_Detailwc.componentprocess("W0040", "", sEvt);
                           }
                           WebComp_Detailwc_Component = OldDetailwc;
                        }
                        else if ( nCmpId == 48 )
                        {
                           OldPaymentmethodwc = cgiGet( "W0048");
                           ...
                           WebComp_Paymentmethodwc.componentprocess("W0048", "", sEvt);
                           WebComp_Paymentmethodwc_Component = OldPaymentmethodwc;
                        }
                     }
                     context.wbHandled = 1;
      ...
      protected void RF262( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A20InvoiceId = H00262_A20InvoiceId[0];
               A38InvoiceCreatedDate = H00262_A38InvoiceCreatedDate[0];
               AssignAttri("", false, "A38InvoiceCreatedDate", context.localUtil.Format(A38InvoiceCreatedDate, "99/99/99"));
               A99UserId = H00262_A99UserId[0];
      ...
      protected void E11262( )
      {
         ...
         {
            A20InvoiceId = H00263_A20InvoiceId[0];
            A38InvoiceCreatedDate = H00263_A38InvoiceCreatedDate[0];
            AssignAttri("", false, "A38InvoiceCreatedDate", context.localUtil.Format(A38InvoiceCreatedDate, "99/99/99"));
            AV16GXLvl8 = 1;
            Form.Caption = context.localUtil.DToC( A38InvoiceCreatedDate, 1, "/")+" - Details";
         ...
         divTablefixeddata_1_Visible = 0;
         AssignProp("", false, divTablefixeddata_1_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTablefixeddata_1_Visible), 5, 0), true);
         divTablefixeddata_2_Visible = 0;
         AssignProp("", false, divTablefixeddata_2_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTablefixeddata_2_Visible), 5, 0), true);
      }
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0032",(string)"",(int)AV12InvoiceId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detail") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Detailwc_Component) != 0 )
            {
               ...
               WebComp_Detailwc.componentprepare(new Object[] {(string)"W0040",(string)"",(int)AV12InvoiceId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112009072", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinvoice.js", "?2024112009073", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTablefixeddata_2_Internalname = "TABLEFIXEDDATA_2";
      ...
      public override void initialize_properties( )
      {
         ...
         divTablefixeddata_2_Visible = 1;
         edtUserId_Jsonclick = "";
         edtUserId_Enabled = 0;
         divTablefixeddata_1_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12InvoiceId',fld:'vINVOICEID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A38InvoiceCreatedDate',fld:'INVOICECREATEDDATE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00262_A20InvoiceId = new int[1] ;
         H00262_A38InvoiceCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H00262_A99UserId = new int[1] ;
         hsh = "";
         GXt_SdtSDTContextSession1 = new GeneXus.Programs.general.ui.SdtSDTContextSession(context);
         H00263_A20InvoiceId = new int[1] ;
         H00263_A38InvoiceCreatedDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinvoice__default(),
            new Object[][] {
                new Object[] {
               H00262_A20InvoiceId, H00262_A38InvoiceCreatedDate, H00262_A99UserId
               }
               , new Object[] {
               H00263_A20InvoiceId, H00263_A38InvoiceCreatedDate
               }
            }
         );
      ...
      private int divTablefixeddata_1_Visible ;
      private int A99UserId ;
      private int edtUserId_Enabled ;
      private int divTablefixeddata_2_Visible ;
      ...
      private string divTablefixeddata_2_Internalname ;
      ...
      private int[] H00262_A20InvoiceId ;
      private DateTime[] H00262_A38InvoiceCreatedDate ;
      private int[] H00262_A99UserId ;
      private int[] H00263_A20InvoiceId ;
      private DateTime[] H00263_A38InvoiceCreatedDate ;
   ...
   public class viewinvoice__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00262", "SELECT [InvoiceId], [InvoiceCreatedDate], [UserId] FROM [Invoice] WHERE [InvoiceId] = @AV12InvoiceId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00262,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00263", "SELECT [InvoiceId], [InvoiceCreatedDate] FROM [Invoice] WHERE [InvoiceId] = @AV12InvoiceId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00263,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
