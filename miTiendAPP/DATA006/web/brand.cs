...
namespace GeneXus.Programs {
   public class brand : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtBrandModifiedDate_Internalname, context.localUtil.Format(A31BrandModifiedDate, "99/99/99"), context.localUtil.Format( A31BrandModifiedDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBrandModifiedDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBrandModifiedDate_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_Brand.htm");
      ...
      protected void E11012( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 ) && ! new haspermission(context).executeUdp(  "brand view") )
         {
         ...
         else if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! new haspermission(context).executeUdp(  "brand insert") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
         else if ( ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 ) && ! new haspermission(context).executeUdp(  "brand update") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
         else if ( ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 ) && ! new haspermission(context).executeUdp(  "brand delete") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
      ...
      {
         /* Using cursor T00017 */
         pr_default.execute(3, new Object[] {n1BrandId, A1BrandId});
      ...
      protected void gxLoad_10( int A1BrandId )
      {
         /* Using cursor T00019 */
         pr_default.execute(4, new Object[] {n1BrandId, A1BrandId});
      ...
      protected void GetKey011( )
      {
         ...
         pr_default.execute(5, new Object[] {n1BrandId, A1BrandId});
      ...
      protected void move_next( )
      {
         ...
         pr_default.execute(6, new Object[] {n1BrandId, A1BrandId});
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A2BrandName, n3BrandDescription, A3BrandDescription, A30BrandCreatedDate, n31BrandModifiedDate, A31BrandModifiedDate, n1BrandId, A1BrandId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("Brand");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(10, new Object[] {n1BrandId, A1BrandId});
                  pr_default.close(10);
                  pr_default.SmartCacheProvider.SetUpdated("Brand");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls011( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(12, new Object[] {n1BrandId, A1BrandId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411152124365", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("brand.js", "?202411152124365", false, true);
      ...
      public override void initialize( )
      {
         ...
         T00017_n1BrandId = new bool[] {false} ;
         ...
         T000110_n1BrandId = new bool[] {false} ;
         T00013_A1BrandId = new int[1] ;
         T00013_n1BrandId = new bool[] {false} ;
         ...
         T000111_n1BrandId = new bool[] {false} ;
         T000112_A1BrandId = new int[1] ;
         T000112_n1BrandId = new bool[] {false} ;
         T00012_A1BrandId = new int[1] ;
         T00012_n1BrandId = new bool[] {false} ;
         ...
         T000113_n1BrandId = new bool[] {false} ;
         ...
         T000119_n1BrandId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
      ...
      private bool[] T000110_n1BrandId ;
      private int[] T00013_A1BrandId ;
      private bool[] T00013_n1BrandId ;
      ...
      private bool[] T000111_n1BrandId ;
      private int[] T000112_A1BrandId ;
      private bool[] T000112_n1BrandId ;
      private int[] T00012_A1BrandId ;
      private bool[] T00012_n1BrandId ;
      ...
      private bool[] T000113_n1BrandId ;
      ...
      private bool[] T000119_n1BrandId ;
