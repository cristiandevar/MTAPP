   ...
   public class suppliergeneral : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV20Pgmname = "SupplierGeneral";
               context.Gx_err = 0;
               edtavState_Enabled = 0;
               AssignProp(sPrefix, false, edtavState_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavState_Enabled), 5, 0), true);
               /* Using cursor H001B3 */
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIERACTIVE", GetSecureSignedToken( sPrefix, A112SupplierActive, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"SupplierGeneral");
         forbiddenHiddens.Add("SupplierActive", StringUtil.BoolToStr( A112SupplierActive));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("suppliergeneral:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vCAN", AV16Can);
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vMESSAGES", AV17Messages);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vMESSAGES", AV17Messages);
         }
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, bttBtnupdate_Enabled, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111b1_client"+"'", TempTags, "", 2, "HLP_SupplierGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndisable_Internalname, "", bttBtndisable_Caption, bttBtndisable_Jsonclick, 5, "Disable", "", StyleString, ClassString, bttBtndisable_Visible, bttBtndisable_Enabled, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DODISABLE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtavState_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavState_Internalname, "State", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavState_Internalname, AV11State, StringUtil.RTrim( context.localUtil.Format( AV11State, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,36);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavState_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavState_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_SupplierGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtSupplierCreatedDate_Internalname, "Created", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtSupplierModifiedDate_Internalname, "Modified", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtSupplierModifiedDate_Internalname, context.localUtil.Format(A33SupplierModifiedDate, "99/99/99"), context.localUtil.Format( A33SupplierModifiedDate, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierModifiedDate_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", edtSupplierModifiedDate_Visible, edtSupplierModifiedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_SupplierGeneral.htm");
            GxWebStd.gx_bitmap( context, edtSupplierModifiedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((edtSupplierModifiedDate_Visible==0)||(edtSupplierModifiedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_SupplierGeneral.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtSupplierActive_Internalname, "Supplier Active", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSupplierActive_Internalname, StringUtil.BoolToStr( A112SupplierActive), StringUtil.BoolToStr( A112SupplierActive), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierActive_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierActive_Visible, edtSupplierActive_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 0, 0, 0, true, "", "right", false, "", "HLP_SupplierGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'DODISABLE'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP1B0( ) ;
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A112SupplierActive = H001B5_A112SupplierActive[0];
               AssignAttri(sPrefix, false, "A112SupplierActive", A112SupplierActive);
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIERACTIVE", GetSecureSignedToken( sPrefix, A112SupplierActive, context));
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AssignAttri(sPrefix, false, "A33SupplierModifiedDate", context.localUtil.Format(A33SupplierModifiedDate, "99/99/99"));
            A112SupplierActive = StringUtil.StrToBool( cgiGet( edtSupplierActive_Internalname));
            AssignAttri(sPrefix, false, "A112SupplierActive", A112SupplierActive);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIERACTIVE", GetSecureSignedToken( sPrefix, A112SupplierActive, context));
            ...
            {
               GXUtil.WriteLogError("suppliergeneral:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E121B2( )
      {
         ...
         {
            bttBtndisable_Visible = 0;
            AssignProp(sPrefix, false, bttBtndisable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(bttBtndisable_Visible), 5, 0), true);
            bttBtndisable_Enabled = 0;
            AssignProp(sPrefix, false, bttBtndisable_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtndisable_Enabled), 5, 0), true);
         }
         /* Using cursor H001B8 */
         pr_default.execute(3, new Object[] {A4SupplierId});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A112SupplierActive = H001B8_A112SupplierActive[0];
            AssignAttri(sPrefix, false, "A112SupplierActive", A112SupplierActive);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIERACTIVE", GetSecureSignedToken( sPrefix, A112SupplierActive, context));
            if ( A112SupplierActive )
            {
               bttBtndisable_Caption = "Disable";
               AssignProp(sPrefix, false, bttBtndisable_Internalname, "Caption", bttBtndisable_Caption, true);
               AV11State = "Enabled";
               AssignAttri(sPrefix, false, "AV11State", AV11State);
            }
            else
            {
               bttBtndisable_Caption = "Enable";
               AssignProp(sPrefix, false, bttBtndisable_Internalname, "Caption", bttBtndisable_Caption, true);
               AV11State = "Disabled";
               AssignAttri(sPrefix, false, "AV11State", AV11State);
            }
         ...
         AssignProp(sPrefix, false, edtSupplierModifiedDate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplierModifiedDate_Visible), 5, 0), true);
         edtSupplierActive_Visible = 0;
         AssignProp(sPrefix, false, edtSupplierActive_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplierActive_Visible), 5, 0), true);
      ...
      protected void E131B2( )
      {
         ...
         if ( A112SupplierActive )
         {
            new suppliercandisable(context ).execute(  A4SupplierId, out  AV16Can, out  AV17Messages) ;
            AssignAttri(sPrefix, false, "AV16Can", AV16Can);
         }
         if ( ( A112SupplierActive && AV16Can ) || ( ! A112SupplierActive ) )
         {
            new supplieractivedeactive(context ).execute(  A4SupplierId,  !A112SupplierActive, out  AV12AllOk, out  AV17Messages) ;
            if ( ! AV12AllOk )
            {
               GX_msglist.addItem((A112SupplierActive ? "Disable " : "Enable ")+"Failed: "+AV17Messages.ToJSonString(false));
            }
            else
            {
         ...
         {
            GX_msglist.addItem("Cant Disable: "+((GeneXus.Utils.SdtMessages_Message)AV17Messages.Item(1)).gxTpr_Description);
         }
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV17Messages", AV17Messages);
      }
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Callerobject = AV20Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411152124094", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("suppliergeneral.js", "?202411152124094", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttBtndisable_Internalname = sPrefix+"BTNDISABLE";
         ...
         edtSupplierActive_Internalname = sPrefix+"SUPPLIERACTIVE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtSupplierActive_Jsonclick = "";
         edtSupplierActive_Enabled = 0;
         edtSupplierActive_Visible = 1;
         ...
         bttBtndisable_Caption = "Disable";
         bttBtndisable_Enabled = 1;
         bttBtndisable_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'},{av:'A112SupplierActive',fld:'SUPPLIERACTIVE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E111B1',iparms:[{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODISABLE'","{handler:'E131B2',iparms:[{av:'A112SupplierActive',fld:'SUPPLIERACTIVE',pic:'',hsh:true},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'},{av:'AV16Can',fld:'vCAN',pic:''},{av:'AV17Messages',fld:'vMESSAGES',pic:''}]");
         setEventMetadata("'DODISABLE'",",oparms:[{av:'AV17Messages',fld:'vMESSAGES',pic:''},{av:'AV16Can',fld:'vCAN',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         H001B5_A112SupplierActive = new bool[] {false} ;
         ...
         hsh = "";
         H001B8_A4SupplierId = new int[1] ;
         H001B8_A112SupplierActive = new bool[] {false} ;
         AV7TrnContext = new GeneXus.Programs.general.ui.SdtTransactionContext(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.suppliergeneral__default(),
            new Object[][] {
               ...
               , new Object[] {
               H001B5_A4SupplierId, H001B5_A112SupplierActive, H001B5_A33SupplierModifiedDate, H001B5_A32SupplierCreatedDate, H001B5_A6SupplierDescription, H001B5_n6SupplierDescription, H001B5_A7SupplierPhone, H001B5_n7SupplierPhone, H001B5_A8SupplierEmail, H001B5_n8SupplierEmail,
               H001B5_A5SupplierName, H001B5_A57SupplierProductQuantity, H001B5_n57SupplierProductQuantity
               }
               , new Object[] {
               H001B7_A57SupplierProductQuantity, H001B7_n57SupplierProductQuantity
               }
               , new Object[] {
               H001B8_A4SupplierId, H001B8_A112SupplierActive
               }
            }
         );
         AV20Pgmname = "SupplierGeneral";
      ...
      private int bttBtndisable_Visible ;
      private int bttBtndisable_Enabled ;
      ...
      private int edtSupplierActive_Visible ;
      private int edtSupplierActive_Enabled ;
      ...
      private string bttBtndisable_Internalname ;
      private string bttBtndisable_Caption ;
      private string bttBtndisable_Jsonclick ;
      ...
      private string edtSupplierActive_Internalname ;
      private string edtSupplierActive_Jsonclick ;
      ...
      private bool[] H001B5_A112SupplierActive ;
      ...
      private int[] H001B8_A4SupplierId ;
      private bool[] H001B8_A112SupplierActive ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H001B5", "SELECT T1.[SupplierId], T1.[SupplierActive], T1.[SupplierModifiedDate], T1.[SupplierCreatedDate], T1.[SupplierDescription], T1.[SupplierPhone], T1.[SupplierEmail], T1.[SupplierName], COALESCE( T2.[SupplierProductQuantity], 0) AS SupplierProductQuantity FROM ([Supplier] T1 LEFT JOIN (SELECT COUNT(*) AS SupplierProductQuantity, [SupplierId] FROM [Product] GROUP BY [SupplierId] ) T2 ON T2.[SupplierId] = T1.[SupplierId]) WHERE T1.[SupplierId] = @SupplierId ORDER BY T1.[SupplierId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B5,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001B7", "SELECT COALESCE( T1.[SupplierProductQuantity], 0) AS SupplierProductQuantity FROM (SELECT COUNT(*) AS SupplierProductQuantity, [SupplierId] FROM [Product] GROUP BY [SupplierId] ) T1 WHERE T1.[SupplierId] = @SupplierId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B7,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001B8", "SELECT [SupplierId], [SupplierActive] FROM [Supplier] WHERE [SupplierId] = @SupplierId ORDER BY [SupplierId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B8,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
