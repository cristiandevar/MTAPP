...
namespace GeneXus.Programs {
   public class permissionpermissionwc : GXWebComponent
   {
      public permissionpermissionwc( )
      {
      ...
      public permissionpermissionwc( IGxContext context )
      {
      ...
      {
         this.AV6PermissionId = aP0_PermissionId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6PermissionId = (int)(Math.Round(NumberUtil.Val( GetPar( "PermissionId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6PermissionId", StringUtil.LTrimStr( (decimal)(AV6PermissionId), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV6PermissionId});
                  componentstart();
      ...
      protected void gxnrGrid_newrow_invoke( )
      {
         ...
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavUpdate_Visible), 5, 0), !bGXsfl_22_Refreshing);
         ...
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDelete_Visible), 5, 0), !bGXsfl_22_Refreshing);
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6PermissionId, AV12Update, AV13Delete, A104RoleId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "PermissionPermissionWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Permission Permission WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("permissionpermissionwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PermissionId,6,0))}, new string[] {"PermissionId"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"ROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A104RoleId), 6, 0, ".", "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6PermissionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6PermissionId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"ROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A104RoleId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ROLEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A104RoleId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPERMISSIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PermissionId), 6, 0, ".", "")));
      ...
      {
         return "PermissionPermissionWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Permission Permission WC" ;
      }
      ...
      protected void WB3E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "permissionpermissionwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PermissionPermissionWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_label_element( context, edtPermissionId_Internalname, "Permission Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPermissionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A106PermissionId), 6, 0, ".", "")), StringUtil.LTrim( ((edtPermissionId_Enabled!=0) ? context.localUtil.Format( (decimal)(A106PermissionId), "ZZZZZ9") : context.localUtil.Format( (decimal)(A106PermissionId), "ZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPermissionId_Jsonclick, 0, "Attribute", "", "", "", "", edtPermissionId_Visible, edtPermissionId_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_PermissionPermissionWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Permission Permission WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H003E2 */
            pr_default.execute(0, new Object[] {AV6PermissionId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A104RoleId = H003E2_A104RoleId[0];
               A106PermissionId = H003E2_A106PermissionId[0];
               AssignAttri(sPrefix, false, "A106PermissionId", StringUtil.LTrimStr( (decimal)(A106PermissionId), 6, 0));
               A105RoleName = H003E2_A105RoleName[0];
               A105RoleName = H003E2_A105RoleName[0];
               E133E2 ();
      ...
      {
         /* Using cursor H003E3 */
         pr_default.execute(1, new Object[] {AV6PermissionId});
      ...
      protected void STRUP3E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PermissionId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PermissionId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E123E2( )
      {
         ...
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         if ( new haspermission(context).executeUdp(  "role update") )
         {
            AV12Update = "Update";
            AssignAttri(sPrefix, false, edtavUpdate_Internalname, AV12Update);
         }
         ...
         if ( new haspermission(context).executeUdp(  "role delete") )
         {
            AV13Delete = "Delete";
            AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         }
         ...
         edtPermissionId_Visible = 0;
         AssignProp(sPrefix, false, edtPermissionId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtPermissionId_Visible), 5, 0), true);
      ...
      private void E133E2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("role.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A104RoleId,6,0))}, new string[] {"Mode","RoleId"}) ;
         edtavDelete_Link = formatLink("role.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A104RoleId,6,0))}, new string[] {"Mode","RoleId"}) ;
      ...
      protected void E113E2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("role.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","RoleId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Role";
         AV11TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "PermissionId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6PermissionId), 6, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6PermissionId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6PermissionId", StringUtil.LTrimStr( (decimal)(AV6PermissionId), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6PermissionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "permissionpermissionwc", GetJustCreated( ));
         ...
         {
            AV6PermissionId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6PermissionId", StringUtil.LTrimStr( (decimal)(AV6PermissionId), 6, 0));
         }
         wcpOAV6PermissionId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PermissionId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV6PermissionId != wcpOAV6PermissionId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6PermissionId = AV6PermissionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6PermissionId = cgiGet( sPrefix+"AV6PermissionId_CTRL");
         if ( StringUtil.Len( sCtrlAV6PermissionId) > 0 )
         {
            AV6PermissionId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6PermissionId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6PermissionId", StringUtil.LTrimStr( (decimal)(AV6PermissionId), 6, 0));
         }
         else
         {
            AV6PermissionId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6PermissionId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6PermissionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PermissionId), 6, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6PermissionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6PermissionId_CTRL", StringUtil.RTrim( sCtrlAV6PermissionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245211262740", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("permissionpermissionwc.js", "?20245211262740", false, true);
         }
      ...
      {
         edtRoleName_Internalname = sPrefix+"ROLENAME_"+sGXsfl_22_idx;
      ...
      {
         edtRoleName_Internalname = sPrefix+"ROLENAME_"+sGXsfl_22_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtPermissionId_Internalname = sPrefix+"PERMISSIONID";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PermissionId',fld:'vPERMISSIONID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'sPrefix'},{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E133E2',iparms:[{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtRoleName_Link',ctrl:'ROLENAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E113E2',iparms:[{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6PermissionId',fld:'vPERMISSIONID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         A105RoleName = "";
         scmdbuf = "";
         H003E2_A104RoleId = new int[1] ;
         H003E2_A106PermissionId = new int[1] ;
         H003E2_A105RoleName = new string[] {""} ;
         ...
         sCtrlAV6PermissionId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.permissionpermissionwc__default(),
            new Object[][] {
                new Object[] {
               H003E2_A104RoleId, H003E2_A106PermissionId, H003E2_A105RoleName
               }
               , new Object[] {
      ...
      private int AV6PermissionId ;
      private int wcpOAV6PermissionId ;
      ...
      private int edtPermissionId_Visible ;
      ...
      private string sCtrlAV6PermissionId ;
      ...
      private int[] H003E2_A104RoleId ;
      private int[] H003E2_A106PermissionId ;
      private string[] H003E2_A105RoleName ;
   ...
   public class permissionpermissionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6PermissionId",GXType.Int32,6,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H003E2", "SELECT T1.[RoleId], T1.[PermissionId], T2.[RoleName] FROM ([RolePermission] T1 INNER JOIN [Role] T2 ON T2.[RoleId] = T1.[RoleId]) WHERE T1.[PermissionId] = @AV6PermissionId ORDER BY T1.[PermissionId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003E2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003E3", "SELECT COUNT(*) FROM ([RolePermission] T1 INNER JOIN [Role] T2 ON T2.[RoleId] = T1.[RoleId]) WHERE T1.[PermissionId] = @AV6PermissionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003E3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
