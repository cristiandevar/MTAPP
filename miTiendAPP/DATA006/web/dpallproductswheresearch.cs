...
namespace GeneXus.Programs {
   public class dpallproductswheresearch : GXProcedure
   {
      public dpallproductswheresearch( )
      {
      ...
      public dpallproductswheresearch( IGxContext context )
      {
      ...
      public void execute( string aP0_Name ,
                           ...
                           decimal aP8_PriceTo ,
                           short aP9_Order ,
                           bool aP10_Descending ,
                           out GXBaseCollection<SdtSDTProductsSelected_SDTProductsSelectedItem> aP11_Gxm2rootcol )
      {
         ...
         this.AV14Order = aP9_Order;
         this.AV15Descending = aP10_Descending;
         ...
         initialize();
         executePrivate();
         aP11_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      public GXBaseCollection<SdtSDTProductsSelected_SDTProductsSelectedItem> executeUdp( string aP0_Name ,
                                                                                          ...
                                                                                          bool aP10_Descending )
      {
         execute(aP0_Name, aP1_Code, aP2_SupplierId, aP3_SectorId, aP4_BrandId, aP5_StockFrom, aP6_StockTo, aP7_PriceFrom, aP8_PriceTo, aP9_Order, aP10_Descending, out aP11_Gxm2rootcol);
         return Gxm2rootcol ;
      }
      ...
      public void executeSubmit( string aP0_Name ,
                                 ...
                                 out GXBaseCollection<SdtSDTProductsSelected_SDTProductsSelectedItem> aP11_Gxm2rootcol )
      {
         dpallproductswheresearch objdpallproductswheresearch;
         objdpallproductswheresearch = new dpallproductswheresearch();
         objdpallproductswheresearch.AV7Name = aP0_Name;
         objdpallproductswheresearch.AV6Code = aP1_Code;
         objdpallproductswheresearch.AV5SupplierId = aP2_SupplierId;
         objdpallproductswheresearch.AV8SectorId = aP3_SectorId;
         objdpallproductswheresearch.AV9BrandId = aP4_BrandId;
         objdpallproductswheresearch.AV10StockFrom = aP5_StockFrom;
         objdpallproductswheresearch.AV11StockTo = aP6_StockTo;
         objdpallproductswheresearch.AV12PriceFrom = aP7_PriceFrom;
         objdpallproductswheresearch.AV13PriceTo = aP8_PriceTo;
         objdpallproductswheresearch.AV14Order = aP9_Order;
         objdpallproductswheresearch.AV15Descending = aP10_Descending;
         objdpallproductswheresearch.Gxm2rootcol = new GXBaseCollection<SdtSDTProductsSelected_SDTProductsSelectedItem>( context, "SDTProductsSelectedItem", "mtaKB") ;
         objdpallproductswheresearch.context.SetSubmitInitialConfig(context);
         objdpallproductswheresearch.initialize();
         Submit( executePrivateCatch,objdpallproductswheresearch);
         aP11_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((dpallproductswheresearch)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A28ProductCreatedDate = P00062_A28ProductCreatedDate[0];
      ...
      public override void initialize( )
      {
         ...
         P00062_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         ...
         A5SupplierName = "";
         Gxm1sdtproductsselected = new SdtSDTProductsSelected_SDTProductsSelectedItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dpallproductswheresearch__default(),
            new Object[][] {
                new Object[] {
               P00062_A4SupplierId, P00062_A9SectorId, P00062_A1BrandId, P00062_A16ProductName, P00062_A55ProductCode, P00062_n55ProductCode, P00062_A17ProductStock, P00062_A18ProductPrice, P00062_A15ProductId, P00062_A28ProductCreatedDate,
               P00062_A10SectorName, P00062_A2BrandName, P00062_A5SupplierName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private DateTime[] P00062_A28ProductCreatedDate ;
      private string[] P00062_A10SectorName ;
      private string[] P00062_A2BrandName ;
      private string[] P00062_A5SupplierName ;
      private GXBaseCollection<SdtSDTProductsSelected_SDTProductsSelectedItem> aP11_Gxm2rootcol ;
   ...
   public class dpallproductswheresearch__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV15Descending )
      {
         ...
         scmdbuf = "SELECT T1.[SupplierId], T1.[SectorId], T1.[BrandId], T1.[ProductName], T1.[ProductCode], T1.[ProductStock], T1.[ProductPrice], T1.[ProductId], T1.[ProductCreatedDate], T3.[SectorName], T4.[BrandName], T2.[SupplierName] FROM ((([Product] T1 INNER JOIN [Supplier] T2 ON T2.[SupplierId] = T1.[SupplierId]) INNER JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) INNER JOIN [Brand] T4 ON T4.[BrandId] = T1.[BrandId])";
         ...
         if ( ! (0==AV14Order) && ( AV14Order == 1 ) && ! AV15Descending )
         {
            scmdbuf += " ORDER BY T1.[ProductName]";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 1 ) && AV15Descending )
         {
            scmdbuf += " ORDER BY T1.[ProductName] DESC";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 2 ) && ! AV15Descending )
         {
            scmdbuf += " ORDER BY T2.[SupplierName]";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 2 ) && AV15Descending )
         {
            scmdbuf += " ORDER BY T2.[SupplierName] DESC";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 3 ) && ! AV15Descending )
         {
            scmdbuf += " ORDER BY T4.[BrandName]";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 3 ) && AV15Descending )
         {
            scmdbuf += " ORDER BY T4.[BrandName] DESC";
         }
         else if ( ! (0==AV14Order) && ( AV14Order == 4 ) && ! AV15Descending )
         {
         ...
         else if ( ! (0==AV14Order) && ( AV14Order == 5 ) && ! AV15Descending )
         {
         ...
         else if ( ! (0==AV14Order) && ( AV14Order == 6 ) && ! AV15Descending )
         {
         ...
         else if ( ! (0==AV14Order) && ( AV14Order == 7 ) && ! AV15Descending )
         {
