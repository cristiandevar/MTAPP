...
namespace GeneXus.Programs {
   public class aproductsrankingpurchaseunits : GXWebProcedure
   {
      ...
      public aproductsrankingpurchaseunits( )
      {
      ...
      public aproductsrankingpurchaseunits( IGxContext context )
      {
      ...
      public void executeSubmit( int aP0_SupplierId ,
                                 ref int aP1_SectorId )
      {
         aproductsrankingpurchaseunits objaproductsrankingpurchaseunits;
         objaproductsrankingpurchaseunits = new aproductsrankingpurchaseunits();
         objaproductsrankingpurchaseunits.AV11SupplierId = aP0_SupplierId;
         objaproductsrankingpurchaseunits.AV10SectorId = aP1_SectorId;
         objaproductsrankingpurchaseunits.context.SetSubmitInitialConfig(context);
         objaproductsrankingpurchaseunits.initialize();
         Submit( executePrivateCatch,objaproductsrankingpurchaseunits);
         aP1_SectorId=this.AV10SectorId;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((aproductsrankingpurchaseunits)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A4SupplierId = P000S2_A4SupplierId[0];
               A5SupplierName = P000S2_A5SupplierName[0];
            ...
            {
               A9SectorId = P000S3_A9SectorId[0];
               A10SectorName = P000S3_A10SectorName[0];
            ...
            if ( (0==AV11SupplierId) && (0==AV10SectorId) )
            {
               ...
               while ( AV21GXV1 <= AV9Products.Count )
               {
                  ...
                  getPrinter().GxDrawText(AV8OneProduct.gxTpr_Name, 7, Gx_line+13, 200, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( (decimal)(AV8OneProduct.gxTpr_Stock), "ZZZZZ9"), 213, Gx_line+13, 340, Gx_line+28, 0, 0, 0, 1) ;
                  getPrinter().GxDrawText(context.localUtil.Format( (decimal)(AV8OneProduct.gxTpr_Quantitypurchases), "ZZZ9"), 353, Gx_line+13, 513, Gx_line+28, 0, 0, 0, 1) ;
                  ...
                  getPrinter().GxDrawText(context.localUtil.Format( AV8OneProduct.gxTpr_Total, "ZZZZZZ9.99"), 753, Gx_line+13, 817, Gx_line+26, 0, 0, 0, 1) ;
                  Gx_OldLine = Gx_line;
                           ...
                           int Inc )
      {
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               ...
               getPrinter().GxDrawText("Ranking Products - Units Purchased", 13, Gx_line+40, 540, Gx_line+81, 0, 0, 0, 0) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Name", 13, Gx_line+120, 120, Gx_line+147, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Stock", 213, Gx_line+120, 340, Gx_line+147, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Quantity Purchase", 353, Gx_line+120, 500, Gx_line+147, 0, 0, 0, 1) ;
               getPrinter().GxDrawLine(0, Gx_line+160, 825, Gx_line+160, 1, 0, 0, 0, 0) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV13SupplierName, "")), 673, Gx_line+13, 793, Gx_line+40, 0, 0, 0, 1) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV12SectorName, "")), 673, Gx_line+40, 793, Gx_line+67, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Supplier:", 553, Gx_line+13, 646, Gx_line+40, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Sector:", 553, Gx_line+40, 646, Gx_line+67, 2, 0, 0, 1) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 10, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Units Purchased", 553, Gx_line+120, 700, Gx_line+147, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("SubTotal", 747, Gx_line+120, 820, Gx_line+147, 0, 0, 0, 1) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Total Paid:", 553, Gx_line+67, 646, Gx_line+94, 2, 0, 0, 1) ;
               getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( AV14Total, "ZZZZZZ9.99")), 673, Gx_line+67, 793, Gx_line+94, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         AV15Name = "";
         scmdbuf = "";
         P000S2_A4SupplierId = new int[1] ;
         P000S2_A5SupplierName = new string[] {""} ;
         A5SupplierName = "";
         AV13SupplierName = "";
         P000S3_A9SectorId = new int[1] ;
         P000S3_A10SectorName = new string[] {""} ;
         A10SectorName = "";
         AV12SectorName = "";
         AV8OneProduct = new SdtSDTProductsRankingPurchases_SDTProductsRankingPurchasesItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aproductsrankingpurchaseunits__default(),
            new Object[][] {
                new Object[] {
               P000S2_A4SupplierId, P000S2_A5SupplierName
               }
               , new Object[] {
               P000S3_A9SectorId, P000S3_A10SectorName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] P000S2_A4SupplierId ;
      private string[] P000S2_A5SupplierName ;
      private int[] P000S3_A9SectorId ;
      private string[] P000S3_A10SectorName ;
   ...
   public class aproductsrankingpurchaseunits__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000S2", "SELECT [SupplierId], [SupplierName] FROM [Supplier] WHERE [SupplierId] = @AV11SupplierId ORDER BY [SupplierId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000S2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P000S3", "SELECT [SectorId], [SectorName] FROM [Sector] WHERE [SectorId] = @AV10SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000S3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
