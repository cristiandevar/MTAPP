...
namespace GeneXus.Programs {
   public class rolepermissionwc : GXWebComponent
   {
      public rolepermissionwc( )
      {
      ...
      public rolepermissionwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6RoleId, A106PermissionId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Role Permission WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("rolepermissionwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6RoleId,6,0))}, new string[] {"RoleId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PERMISSIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A106PermissionId), "ZZZZZ9"), context));
      ...
      {
         return "RolePermissionWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Role Permission WC" ;
      }
      ...
      protected void WB390( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "rolepermissionwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnassignpermission_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Assign Permission", bttBtnassignpermission_Jsonclick, 5, "Assign Permission", "", StyleString, ClassString, bttBtnassignpermission_Visible, bttBtnassignpermission_Enabled, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'ASSIGN PERMISSION\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_RolePermissionWC.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_RolePermissionWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START392( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Role Permission WC", 0) ;
            }
            context.wjLoc = "";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'ASSIGN PERMISSION'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP390( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'Assign Permission' */
                                    E11392 ();
                                 }
                              }
                           }
      ...
      protected void RF392( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A106PermissionId = H00392_A106PermissionId[0];
               A104RoleId = H00392_A104RoleId[0];
               AssignAttri(sPrefix, false, "A104RoleId", StringUtil.LTrimStr( (decimal)(A104RoleId), 6, 0));
               A107PermissionName = H00392_A107PermissionName[0];
               A107PermissionName = H00392_A107PermissionName[0];
               E13392 ();
      ...
      protected void E12392( )
      {
         ...
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         if ( ! ( new haspermission(context).executeUdp(  "permission update") && new haspermission(context).executeUdp(  "permission delete") ) )
         {
            bttBtnassignpermission_Visible = 0;
            AssignProp(sPrefix, false, bttBtnassignpermission_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(bttBtnassignpermission_Visible), 5, 0), true);
            bttBtnassignpermission_Enabled = 0;
            AssignProp(sPrefix, false, bttBtnassignpermission_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtnassignpermission_Enabled), 5, 0), true);
         }
         edtRoleId_Visible = 0;
      ...
      {
         /* 'Assign Permission' Routine */
         returnInSub = false;
         context.PopUp(formatLink("wprolepromptassignpermission.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6RoleId,6,0))}, new string[] {"RoleId"}) , new Object[] {});
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "rolepermissionwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241115213050", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rolepermissionwc.js", "?20241115213050", false, true);
         }
      ...
      {
         edtPermissionName_Internalname = sPrefix+"PERMISSIONNAME_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtPermissionName_Internalname = sPrefix+"PERMISSIONNAME_"+sGXsfl_24_fel_idx;
      }
      ...
      {
         bttBtnassignpermission_Internalname = sPrefix+"BTNASSIGNPERMISSION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtRoleId_Enabled = 0;
         edtRoleId_Visible = 1;
         bttBtnassignpermission_Enabled = 1;
         bttBtnassignpermission_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'sPrefix'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13392',iparms:[{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtPermissionName_Link',ctrl:'PERMISSIONNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E14392',iparms:[{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("'ASSIGN PERMISSION'","{handler:'E11392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("'ASSIGN PERMISSION'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A106PermissionId',fld:'PERMISSIONID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         ClassString = "";
         StyleString = "";
         bttBtnassignpermission_Jsonclick = "";
         ...
         A107PermissionName = "";
         scmdbuf = "";
         H00392_A106PermissionId = new int[1] ;
         H00392_A104RoleId = new int[1] ;
         H00392_A107PermissionName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rolepermissionwc__default(),
            new Object[][] {
                new Object[] {
               H00392_A106PermissionId, H00392_A104RoleId, H00392_A107PermissionName
               }
               , new Object[] {
      ...
      private int bttBtnassignpermission_Visible ;
      private int bttBtnassignpermission_Enabled ;
      ...
      private string bttBtnassignpermission_Internalname ;
      private string bttBtnassignpermission_Jsonclick ;
      ...
      private int[] H00392_A106PermissionId ;
      private int[] H00392_A104RoleId ;
      private string[] H00392_A107PermissionName ;
   ...
   public class rolepermissionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00392", "SELECT T1.[PermissionId], T1.[RoleId], T2.[PermissionName] FROM ([RolePermission] T1 INNER JOIN [Permission] T2 ON T2.[PermissionId] = T1.[PermissionId]) WHERE T1.[RoleId] = @AV6RoleId ORDER BY T1.[RoleId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00392,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00393", "SELECT COUNT(*) FROM ([RolePermission] T1 INNER JOIN [Permission] T2 ON T2.[PermissionId] = T1.[PermissionId]) WHERE T1.[RoleId] = @AV6RoleId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00393,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
