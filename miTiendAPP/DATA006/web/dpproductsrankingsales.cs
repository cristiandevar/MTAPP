...
namespace GeneXus.Programs {
   public class dpproductsrankingsales : GXProcedure
   {
      public dpproductsrankingsales( )
      {
      ...
      public dpproductsrankingsales( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_Name ,
                                 ...
                                 out GXBaseCollection<SdtSDTRankingProducts_SDTRankingProductsItem> aP4_Gxm2rootcol )
      {
         dpproductsrankingsales objdpproductsrankingsales;
         objdpproductsrankingsales = new dpproductsrankingsales();
         objdpproductsrankingsales.AV10Name = aP0_Name;
         objdpproductsrankingsales.AV8SupplierId = aP1_SupplierId;
         objdpproductsrankingsales.AV5SectorId = aP2_SectorId;
         objdpproductsrankingsales.AV6BrandId = aP3_BrandId;
         objdpproductsrankingsales.Gxm2rootcol = new GXBaseCollection<SdtSDTRankingProducts_SDTRankingProductsItem>( context, "SDTRankingProductsItem", "mtaKB") ;
         objdpproductsrankingsales.context.SetSubmitInitialConfig(context);
         objdpproductsrankingsales.initialize();
         Submit( executePrivateCatch,objdpproductsrankingsales);
         aP4_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((dpproductsrankingsales)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            n9SectorId = P00053_n9SectorId[0];
            A1BrandId = P00053_A1BrandId[0];
            n1BrandId = P00053_n1BrandId[0];
            A16ProductName = P00053_A16ProductName[0];
            A15ProductId = P00053_A15ProductId[0];
            A85ProductCostPrice = P00053_A85ProductCostPrice[0];
            n85ProductCostPrice = P00053_n85ProductCostPrice[0];
            A17ProductStock = P00053_A17ProductStock[0];
            n17ProductStock = P00053_n17ProductStock[0];
            ...
            Gxm1sdtrankingproducts.gxTpr_Price = A85ProductCostPrice;
            ...
            Gxm1sdtrankingproducts.gxTpr_Subtotal = A40002GXC3;
      ...
      public override void initialize( )
      {
         ...
         P00053_n9SectorId = new bool[] {false} ;
         P00053_A1BrandId = new int[1] ;
         P00053_n1BrandId = new bool[] {false} ;
         P00053_A16ProductName = new string[] {""} ;
         P00053_A15ProductId = new int[1] ;
         P00053_A85ProductCostPrice = new decimal[1] ;
         P00053_n85ProductCostPrice = new bool[] {false} ;
         P00053_A17ProductStock = new int[1] ;
         P00053_n17ProductStock = new bool[] {false} ;
         ...
         P00053_A40002GXC3 = new decimal[1] ;
         P00053_n40002GXC3 = new bool[] {false} ;
         A5SupplierName = "";
         A10SectorName = "";
         A2BrandName = "";
         Gxm1sdtrankingproducts = new SdtSDTRankingProducts_SDTRankingProductsItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dpproductsrankingsales__default(),
            new Object[][] {
                new Object[] {
               P00053_A4SupplierId, P00053_A9SectorId, P00053_n9SectorId, P00053_A1BrandId, P00053_n1BrandId, P00053_A16ProductName, P00053_A15ProductId, P00053_A85ProductCostPrice, P00053_n85ProductCostPrice, P00053_A17ProductStock,
               P00053_n17ProductStock, P00053_A5SupplierName, P00053_A10SectorName, P00053_A2BrandName, P00053_A40000GXC1, P00053_n40000GXC1, P00053_A40001GXC2, P00053_n40001GXC2, P00053_A40002GXC3, P00053_n40002GXC3
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P00053_n9SectorId ;
      private int[] P00053_A1BrandId ;
      private bool[] P00053_n1BrandId ;
      private string[] P00053_A16ProductName ;
      private int[] P00053_A15ProductId ;
      private decimal[] P00053_A85ProductCostPrice ;
      private bool[] P00053_n85ProductCostPrice ;
      private int[] P00053_A17ProductStock ;
      private bool[] P00053_n17ProductStock ;
      ...
      private decimal[] P00053_A40002GXC3 ;
   ...
   public class dpproductsrankingsales__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A4SupplierId )
      {
         ...
         scmdbuf = "SELECT T1.[SupplierId], T1.[SectorId], T1.[BrandId], T1.[ProductName], T1.[ProductId], T1.[ProductCostPrice], T1.[ProductStock], T2.[SupplierName], T3.[SectorName], T4.[BrandName], COALESCE( T5.[GXC1], 0) AS GXC1, COALESCE( T5.[GXC2], 0) AS GXC2, COALESCE( T5.[GXC3], 0) AS GXC3 FROM (((([Product] T1 INNER JOIN [Supplier] T2 ON T2.[SupplierId] = T1.[SupplierId]) LEFT JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) LEFT JOIN [Brand] T4 ON T4.[BrandId] = T1.[BrandId]) LEFT JOIN (SELECT COUNT(*) AS GXC1, [ProductId], SUM([InvoiceDetailQuantity]) AS GXC2, SUM([InvoiceDetailQuantity] * CAST([InvoiceDetailHistoricPrice] AS decimal( 28, 10))) AS GXC3 FROM [InvoiceDetail] GROUP BY [ProductId] ) T5 ON T5.[ProductId] = T1.[ProductId])";
