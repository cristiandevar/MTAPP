...
namespace GeneXus.Programs {
   public class roleuserwc : GXWebComponent
   {
      public roleuserwc( )
      {
      ...
      public roleuserwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6RoleId, A99UserId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV18Pgmname = "RoleUserWC";
               context.Gx_err = 0;
               cmbavState.Enabled = 0;
               AssignProp(sPrefix, false, cmbavState_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavState.Enabled), 5, 0), !bGXsfl_22_Refreshing);
               WS3A2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Role User WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("roleuserwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6RoleId,6,0))}, new string[] {"RoleId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USERID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A99UserId), "ZZZZZ9"), context));
      ...
      protected void WB3A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "roleuserwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnassignroletouser_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Asign To User", bttBtnassignroletouser_Jsonclick, 5, "Asign To User", "", StyleString, ClassString, bttBtnassignroletouser_Visible, bttBtnassignroletouser_Enabled, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOASSIGNROLETOUSER\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_RoleUserWC.htm");
      ...
      protected void START3A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Role User WC", 0) ;
            }
            context.wjLoc = "";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'DOASSIGNROLETOUSER'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP3A0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'DoAssignRoleToUser' */
                                    E113A2 ();
                                 }
                              }
                           }
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "'DOINSERT'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV15State = cgiGet( cmbavState_Internalname);
                              AssignAttri(sPrefix, false, cmbavState_Internalname, AV15State);
      ...
      protected void RF3A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H003A2 */
            pr_default.execute(0, new Object[] {AV6RoleId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A99UserId = H003A2_A99UserId[0];
               A104RoleId = H003A2_A104RoleId[0];
               n104RoleId = H003A2_n104RoleId[0];
               AssignAttri(sPrefix, false, "A104RoleId", StringUtil.LTrimStr( (decimal)(A104RoleId), 6, 0));
               A137UserEmail = H003A2_A137UserEmail[0];
               n137UserEmail = H003A2_n137UserEmail[0];
               A111UserActive = H003A2_A111UserActive[0];
               n111UserActive = H003A2_n111UserActive[0];
               A103UserModifiedDate = H003A2_A103UserModifiedDate[0];
               A102UserCreatedDate = H003A2_A102UserCreatedDate[0];
               A100UserName = H003A2_A100UserName[0];
               E133A2 ();
      ...
      {
         /* Using cursor H003A3 */
         pr_default.execute(1, new Object[] {AV6RoleId});
      ...
      protected void E123A2( )
      {
         ...
         {
            bttBtnassignroletouser_Visible = 0;
            AssignProp(sPrefix, false, bttBtnassignroletouser_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(bttBtnassignroletouser_Visible), 5, 0), true);
            bttBtnassignroletouser_Enabled = 0;
            AssignProp(sPrefix, false, bttBtnassignroletouser_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtnassignroletouser_Enabled), 5, 0), true);
         }
         edtRoleId_Visible = 0;
      ...
      private void E133A2( )
      {
         ...
         AV15State = (A111UserActive ? "Enabled" : "Disabled");
         AssignAttri(sPrefix, false, cmbavState_Internalname, AV15State);
         /* Load Method */
         if ( wbStart != -1 )
         {
         ...
         cmbavState.CurrentValue = StringUtil.RTrim( AV15State);
      }
      ...
      {
         /* 'DoAssignRoleToUser' Routine */
         returnInSub = false;
         context.PopUp(formatLink("wprolepromptassignuser.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6RoleId,6,0))}, new string[] {"RoleId"}) , new Object[] {});
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "roleuserwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241261222250", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("roleuserwc.js", "?20241261222250", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtUserCreatedDate_Internalname = sPrefix+"USERCREATEDDATE_"+sGXsfl_22_idx;
         cmbavState_Internalname = sPrefix+"vSTATE_"+sGXsfl_22_idx;
         edtUserModifiedDate_Internalname = sPrefix+"USERMODIFIEDDATE_"+sGXsfl_22_idx;
         chkUserActive_Internalname = sPrefix+"USERACTIVE_"+sGXsfl_22_idx;
         edtUserEmail_Internalname = sPrefix+"USEREMAIL_"+sGXsfl_22_idx;
      }

      protected void SubsflControlProps_fel_222( )
      {
         edtUserName_Internalname = sPrefix+"USERNAME_"+sGXsfl_22_fel_idx;
         edtUserCreatedDate_Internalname = sPrefix+"USERCREATEDDATE_"+sGXsfl_22_fel_idx;
         cmbavState_Internalname = sPrefix+"vSTATE_"+sGXsfl_22_fel_idx;
         edtUserModifiedDate_Internalname = sPrefix+"USERMODIFIEDDATE_"+sGXsfl_22_fel_idx;
         chkUserActive_Internalname = sPrefix+"USERACTIVE_"+sGXsfl_22_fel_idx;
         edtUserEmail_Internalname = sPrefix+"USEREMAIL_"+sGXsfl_22_fel_idx;
      }
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUserCreatedDate_Internalname,context.localUtil.Format(A102UserCreatedDate, "99/99/99"),context.localUtil.Format( A102UserCreatedDate, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUserCreatedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUserModifiedDate_Internalname,context.localUtil.Format(A103UserModifiedDate, "99/99/99"),context.localUtil.Format( A103UserModifiedDate, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUserModifiedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "USERACTIVE_" + sGXsfl_22_idx;
            chkUserActive.Name = GXCCtl;
            chkUserActive.WebTags = "";
            chkUserActive.Caption = "";
            AssignProp(sPrefix, false, chkUserActive_Internalname, "TitleCaption", chkUserActive.Caption, !bGXsfl_22_Refreshing);
      ...
      protected void StartGridControl22( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV15State));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbavState.Enabled), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A103UserModifiedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         bttBtnassignroletouser_Internalname = sPrefix+"BTNASSIGNROLETOUSER";
         ...
         chkUserActive_Internalname = sPrefix+"USERACTIVE";
         edtUserEmail_Internalname = sPrefix+"USEREMAIL";
      ...
      public override void initialize_properties( )
      {
         ...
         edtRoleId_Enabled = 0;
         edtRoleId_Visible = 1;
         bttBtnassignroletouser_Enabled = 1;
         bttBtnassignroletouser_Visible = 1;
         subGrid_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'sPrefix'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E133A2',iparms:[{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'A111UserActive',fld:'USERACTIVE',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtUserName_Link',ctrl:'USERNAME',prop:'Link'},{av:'cmbavState'},{av:'AV15State',fld:'vSTATE',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E143A2',iparms:[{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("'DOASSIGNROLETOUSER'","{handler:'E113A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("'DOASSIGNROLETOUSER'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RoleId',fld:'vROLEID',pic:'ZZZZZ9'},{av:'A99UserId',fld:'USERID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_LASTPAGE",",oparms:[]}");
         setEventMetadata("VALIDV_STATE","{handler:'Validv_State',iparms:[]");
         setEventMetadata("VALIDV_STATE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Useremail',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         ClassString = "";
         StyleString = "";
         bttBtnassignroletouser_Jsonclick = "";
         GridContainer = new GXWebGrid( context);
         sStyleString = "";
         Form = new GXWebForm();
         sXEvt = "";
         ...
         A137UserEmail = "";
         scmdbuf = "";
         H003A2_A99UserId = new int[1] ;
         H003A2_A104RoleId = new int[1] ;
         H003A2_n104RoleId = new bool[] {false} ;
         H003A2_A137UserEmail = new string[] {""} ;
         H003A2_n137UserEmail = new bool[] {false} ;
         H003A2_A111UserActive = new bool[] {false} ;
         H003A2_n111UserActive = new bool[] {false} ;
         H003A2_A103UserModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H003A2_A102UserCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H003A2_A100UserName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.roleuserwc__default(),
            new Object[][] {
                new Object[] {
               H003A2_A99UserId, H003A2_A104RoleId, H003A2_n104RoleId, H003A2_A137UserEmail, H003A2_n137UserEmail, H003A2_A111UserActive, H003A2_n111UserActive, H003A2_A103UserModifiedDate, H003A2_A102UserCreatedDate, H003A2_A100UserName
               }
               , new Object[] {
      ...
      private int bttBtnassignroletouser_Visible ;
      private int bttBtnassignroletouser_Enabled ;
      ...
      private string bttBtnassignroletouser_Internalname ;
      private string bttBtnassignroletouser_Jsonclick ;
      ...
      private int[] H003A2_A99UserId ;
      private int[] H003A2_A104RoleId ;
      private bool[] H003A2_n104RoleId ;
      private string[] H003A2_A137UserEmail ;
      private bool[] H003A2_n137UserEmail ;
      private bool[] H003A2_A111UserActive ;
      private bool[] H003A2_n111UserActive ;
      private DateTime[] H003A2_A103UserModifiedDate ;
      private DateTime[] H003A2_A102UserCreatedDate ;
      private string[] H003A2_A100UserName ;
   ...
   public class roleuserwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003A2", "SELECT [UserId], [RoleId], [UserEmail], [UserActive], [UserModifiedDate], [UserCreatedDate], [UserName] FROM [User] WHERE [RoleId] = @AV6RoleId ORDER BY [RoleId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003A2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003A3", "SELECT COUNT(*) FROM [User] WHERE [RoleId] = @AV6RoleId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003A3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
