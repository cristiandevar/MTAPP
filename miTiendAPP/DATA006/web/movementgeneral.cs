...
namespace GeneXus.Programs {
   public class movementgeneral : GXWebComponent
   {
      public movementgeneral( )
      {
      ...
      public movementgeneral( IGxContext context )
      {
      ...
      public void execute( int aP0_MovementId )
      {
         this.A123MovementId = aP0_MovementId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "MovementId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A123MovementId", StringUtil.LTrimStr( (decimal)(A123MovementId), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)A123MovementId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Movement General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("movementgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A123MovementId,6,0))}, new string[] {"MovementId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA123MovementId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA123MovementId), 6, 0, ".", "")));
      }
      ...
      {
         return "MovementGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Movement General" ;
      }
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "movementgeneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e114f1_client"+"'", TempTags, "", 2, "HLP_MovementGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e124f1_client"+"'", TempTags, "", 2, "HLP_MovementGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, cmbMovementType_Internalname, "Type", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbMovementType, cmbMovementType_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(A124MovementType), 4, 0)), 1, cmbMovementType_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbMovementType.Enabled, 0, 0, 0, "em", 0, "", "", "ReadonlyAttribute", "", "", "", "", true, 0, "HLP_MovementGeneral.htm");
            cmbMovementType.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(A124MovementType), 4, 0));
            AssignProp(sPrefix, false, cmbMovementType_Internalname, "Values", (string)(cmbMovementType.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtMovementCreatedDate_Internalname, "Created Date", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtMovementCreatedDate_Internalname, context.localUtil.Format(A125MovementCreatedDate, "99/99/99"), context.localUtil.Format( A125MovementCreatedDate, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMovementCreatedDate_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtMovementCreatedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_MovementGeneral.htm");
            GxWebStd.gx_bitmap( context, edtMovementCreatedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtMovementCreatedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_MovementGeneral.htm");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtMovementKeyAditional_Internalname, "Key Aditional", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMovementKeyAditional_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A128MovementKeyAditional), 6, 0, ".", "")), StringUtil.LTrim( ((edtMovementKeyAditional_Enabled!=0) ? context.localUtil.Format( (decimal)(A128MovementKeyAditional), "ZZZZZ9") : context.localUtil.Format( (decimal)(A128MovementKeyAditional), "ZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMovementKeyAditional_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtMovementKeyAditional_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_MovementGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtMovementId_Internalname, "Movement Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMovementId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A123MovementId), 6, 0, ".", "")), StringUtil.LTrim( ((edtMovementId_Enabled!=0) ? context.localUtil.Format( (decimal)(A123MovementId), "ZZZZZ9") : context.localUtil.Format( (decimal)(A123MovementId), "ZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMovementId_Jsonclick, 0, "Attribute", "", "", "", "", edtMovementId_Visible, edtMovementId_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "Id", "right", false, "", "HLP_MovementGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Movement General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         if ( cmbMovementType.ItemCount > 0 )
         {
            ...
            AssignAttri(sPrefix, false, "A124MovementType", StringUtil.LTrimStr( (decimal)(A124MovementType), 4, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbMovementType.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(A124MovementType), 4, 0));
            AssignProp(sPrefix, false, cmbMovementType_Internalname, "Values", cmbMovementType.ToJavascriptSource(), true);
         }
      }
      ...
      protected void RF4F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A124MovementType = H004F2_A124MovementType[0];
               AssignAttri(sPrefix, false, "A124MovementType", StringUtil.LTrimStr( (decimal)(A124MovementType), 4, 0));
               /* Execute user event: Load */
               E144F2 ();
      ...
      protected void STRUP4F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA123MovementId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA123MovementId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E144F2( )
      {
         /* Load Routine */
         returnInSub = false;
         edtMovementId_Visible = 0;
         AssignProp(sPrefix, false, edtMovementId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMovementId_Visible), 5, 0), true);
      }
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "Movement";
         AV8TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "MovementId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6MovementId), 6, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A123MovementId = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "A123MovementId", StringUtil.LTrimStr( (decimal)(A123MovementId), 6, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA123MovementId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "movementgeneral", GetJustCreated( ));
         ...
         {
            A123MovementId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "A123MovementId", StringUtil.LTrimStr( (decimal)(A123MovementId), 6, 0));
         }
         wcpOA123MovementId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA123MovementId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A123MovementId != wcpOA123MovementId ) ) )
         {
            setjustcreated();
         }
         wcpOA123MovementId = A123MovementId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA123MovementId = cgiGet( sPrefix+"A123MovementId_CTRL");
         if ( StringUtil.Len( sCtrlA123MovementId) > 0 )
         {
            A123MovementId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA123MovementId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A123MovementId", StringUtil.LTrimStr( (decimal)(A123MovementId), 6, 0));
         }
         else
         {
            A123MovementId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A123MovementId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A123MovementId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A123MovementId), 6, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA123MovementId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A123MovementId_CTRL", StringUtil.RTrim( sCtrlA123MovementId));
         }
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A123MovementId',fld:'MOVEMENTID',pic:'ZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E114F1',iparms:[{av:'A123MovementId',fld:'MOVEMENTID',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E124F1',iparms:[{av:'A123MovementId',fld:'MOVEMENTID',pic:'ZZZZZ9'}]");
      ...
      private int wcpOA123MovementId ;
      ...
      private string sCtrlA123MovementId ;
   ...
   public class movementgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
