...
namespace GeneXus.Programs {
   public class supplier : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierName_Internalname, A5SupplierName, StringUtil.RTrim( context.localUtil.Format( A5SupplierName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierName_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_Supplier.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierPhone_Internalname, StringUtil.RTrim( A7SupplierPhone), StringUtil.RTrim( context.localUtil.Format( A7SupplierPhone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", gxphoneLink, "", "", "", edtSupplierPhone_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierPhone_Enabled, 0, "tel", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Phone", "left", true, "", "HLP_Supplier.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierEmail_Internalname, A8SupplierEmail, StringUtil.RTrim( context.localUtil.Format( A8SupplierEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "mailto:"+A8SupplierEmail, "", "", "", edtSupplierEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "left", true, "", "HLP_Supplier.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", edtSupplierCreatedDate_Visible, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtSupplierCreatedDate_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierCreatedDate_Internalname, "Created", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierCreatedDate_Internalname, context.localUtil.Format(A32SupplierCreatedDate, "99/99/99"), context.localUtil.Format( A32SupplierCreatedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierCreatedDate_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierCreatedDate_Visible, edtSupplierCreatedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_Supplier.htm");
         GxWebStd.gx_bitmap( context, edtSupplierCreatedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((edtSupplierCreatedDate_Visible==0)||(edtSupplierCreatedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Supplier.htm");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", edtSupplierModifiedDate_Visible, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtSupplierModifiedDate_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierModifiedDate_Internalname, "Modified", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierModifiedDate_Internalname, context.localUtil.Format(A33SupplierModifiedDate, "99/99/99"), context.localUtil.Format( A33SupplierModifiedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierModifiedDate_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierModifiedDate_Visible, edtSupplierModifiedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_Supplier.htm");
         GxWebStd.gx_bitmap( context, edtSupplierModifiedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((edtSupplierModifiedDate_Visible==0)||(edtSupplierModifiedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_Supplier.htm");
         context.WriteHtmlTextNl( "</div>") ;
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "left", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", edtSupplierProductQuantity_Visible, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtSupplierProductQuantity_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z112SupplierActive = StringUtil.StrToBool( cgiGet( "Z112SupplierActive"));
               ...
               A112SupplierActive = StringUtil.StrToBool( cgiGet( "Z112SupplierActive"));
               ...
               A4SupplierId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "SUPPLIERID"), ".", ","), 18, MidpointRounding.ToEven));
               A112SupplierActive = StringUtil.StrToBool( cgiGet( "SUPPLIERACTIVE"));
               ...
               A33SupplierModifiedDate = context.localUtil.CToD( cgiGet( edtSupplierModifiedDate_Internalname), 1);
               AssignAttri("", false, "A33SupplierModifiedDate", context.localUtil.Format(A33SupplierModifiedDate, "99/99/99"));
               forbiddenHiddens.Add("SupplierModifiedDate", context.localUtil.Format(A33SupplierModifiedDate, "99/99/99"));
      ...
      protected void E11022( )
      {
         ...
         {
            edtSupplierModifiedDate_Visible = 0;
            AssignProp("", false, edtSupplierModifiedDate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplierModifiedDate_Visible), 5, 0), true);
            edtSupplierCreatedDate_Visible = 0;
            AssignProp("", false, edtSupplierCreatedDate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplierCreatedDate_Visible), 5, 0), true);
            edtSupplierProductQuantity_Visible = 0;
            AssignProp("", false, edtSupplierProductQuantity_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplierProductQuantity_Visible), 5, 0), true);
         }
      }
      ...
      protected void ZM022( short GX_JID )
      {
         if ( ( GX_JID == 10 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z112SupplierActive = T00023_A112SupplierActive[0];
      ...
      protected void standaloneModal( )
      {
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            AssignAttri("", false, "A112SupplierActive", A112SupplierActive);
         }
      ...
      protected void Load022( )
      {
         ...
         {
            RcdFound2 = 1;
            A112SupplierActive = T00027_A112SupplierActive[0];
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A112SupplierActive = T00023_A112SupplierActive[0];
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T000210_A4SupplierId[0] < A4SupplierId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T000210_A4SupplierId[0] > A4SupplierId ) ) )
            {
               A4SupplierId = T000210_A4SupplierId[0];
               RcdFound2 = 1;
            }
         }
         pr_default.close(6);
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( T000211_A4SupplierId[0] > A4SupplierId ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( T000211_A4SupplierId[0] < A4SupplierId ) ) )
            {
      ...
      protected void CheckOptimisticConcurrency022( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( Z112SupplierActive != T00022_A112SupplierActive[0] ) || ( StringUtil.StrCmp(Z5SupplierName, T00022_A5SupplierName[0]) != 0 ) || ( StringUtil.StrCmp(Z6SupplierDescription, T00022_A6SupplierDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z7SupplierPhone, T00022_A7SupplierPhone[0]) != 0 ) || ( StringUtil.StrCmp(Z8SupplierEmail, T00022_A8SupplierEmail[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( DateTimeUtil.ResetTime ( Z32SupplierCreatedDate ) != DateTimeUtil.ResetTime ( T00022_A32SupplierCreatedDate[0] ) ) || ( DateTimeUtil.ResetTime ( Z33SupplierModifiedDate ) != DateTimeUtil.ResetTime ( T00022_A33SupplierModifiedDate[0] ) ) )
            {
               if ( Z112SupplierActive != T00022_A112SupplierActive[0] )
               {
                  GXUtil.WriteLog("supplier:[seudo value changed for attri]"+"SupplierActive");
                  GXUtil.WriteLogRaw("Old: ",Z112SupplierActive);
                  GXUtil.WriteLogRaw("Current: ",T00022_A112SupplierActive[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A112SupplierActive, A5SupplierName, n6SupplierDescription, A6SupplierDescription, n7SupplierPhone, A7SupplierPhone, n8SupplierEmail, A8SupplierEmail, A32SupplierCreatedDate, A33SupplierModifiedDate});
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A112SupplierActive, A5SupplierName, n6SupplierDescription, A6SupplierDescription, n7SupplierPhone, A7SupplierPhone, n8SupplierEmail, A8SupplierEmail, A32SupplierCreatedDate, A33SupplierModifiedDate, A4SupplierId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("Supplier");
      ...
      public void ScanStart022( )
      {
         ...
         {
            RcdFound2 = 1;
            A4SupplierId = T000217_A4SupplierId[0];
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "Z112SupplierActive", Z112SupplierActive);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024113012491524", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supplier.js", "?2024113012491525", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         edtSupplierProductQuantity_Enabled = 0;
         edtSupplierProductQuantity_Visible = 1;
         edtSupplierModifiedDate_Jsonclick = "";
         edtSupplierModifiedDate_Enabled = 0;
         edtSupplierModifiedDate_Visible = 1;
         edtSupplierCreatedDate_Jsonclick = "";
         edtSupplierCreatedDate_Enabled = 0;
         edtSupplierCreatedDate_Visible = 1;
      ...
      public void Valid_Suppliername( )
      {
         ...
         pr_default.execute(14, new Object[] {A5SupplierName, A4SupplierId});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV9TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9',hsh:true},{av:'A32SupplierCreatedDate',fld:'SUPPLIERCREATEDDATE',pic:''},{av:'A33SupplierModifiedDate',fld:'SUPPLIERMODIFIEDDATE',pic:''},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("VALID_SUPPLIERNAME","{handler:'Valid_Suppliername',iparms:[{av:'A5SupplierName',fld:'SUPPLIERNAME',pic:''},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         setEventMetadata("VALID_SUPPLIERNAME",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         T00027_A112SupplierActive = new bool[] {false} ;
         ...
         T00028_A5SupplierName = new string[] {""} ;
         T00029_A4SupplierId = new int[1] ;
         T00023_A4SupplierId = new int[1] ;
         T00023_A112SupplierActive = new bool[] {false} ;
         ...
         T00022_A112SupplierActive = new bool[] {false} ;
         ...
         T000215_A50PurchaseOrderId = new int[1] ;
         T000216_A15ProductId = new int[1] ;
         T000217_A4SupplierId = new int[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         T000218_A5SupplierName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier__default(),
            new Object[][] {
                new Object[] {
               T00022_A4SupplierId, T00022_A112SupplierActive, T00022_A5SupplierName, T00022_A6SupplierDescription, T00022_n6SupplierDescription, T00022_A7SupplierPhone, T00022_n7SupplierPhone, T00022_A8SupplierEmail, T00022_n8SupplierEmail, T00022_A32SupplierCreatedDate,
               T00022_A33SupplierModifiedDate
               }
               , new Object[] {
               T00023_A4SupplierId, T00023_A112SupplierActive, T00023_A5SupplierName, T00023_A6SupplierDescription, T00023_n6SupplierDescription, T00023_A7SupplierPhone, T00023_n7SupplierPhone, T00023_A8SupplierEmail, T00023_n8SupplierEmail, T00023_A32SupplierCreatedDate,
               T00023_A33SupplierModifiedDate
               }
               , new Object[] {
               T00025_A57SupplierProductQuantity, T00025_n57SupplierProductQuantity
               }
               , new Object[] {
               T00027_A4SupplierId, T00027_A112SupplierActive, T00027_A5SupplierName, T00027_A6SupplierDescription, T00027_n6SupplierDescription, T00027_A7SupplierPhone, T00027_n7SupplierPhone, T00027_A8SupplierEmail, T00027_n8SupplierEmail, T00027_A32SupplierCreatedDate,
               T00027_A33SupplierModifiedDate, T00027_A57SupplierProductQuantity, T00027_n57SupplierProductQuantity
               }
               , new Object[] {
               T00028_A5SupplierName
               }
               , new Object[] {
               T00029_A4SupplierId
               }
               ...
               , new Object[] {
               T000215_A50PurchaseOrderId
               }
               , new Object[] {
               T000216_A15ProductId
               }
               , new Object[] {
               T000217_A4SupplierId
               }
               , new Object[] {
               T000218_A5SupplierName
               }
            }
         );
         AV12Pgmname = "Supplier";
      ...
      private int edtSupplierCreatedDate_Visible ;
      private int edtSupplierCreatedDate_Enabled ;
      private int edtSupplierModifiedDate_Visible ;
      private int edtSupplierModifiedDate_Enabled ;
      private int edtSupplierProductQuantity_Visible ;
      ...
      private bool[] T00027_A112SupplierActive ;
      ...
      private string[] T00028_A5SupplierName ;
      private int[] T00029_A4SupplierId ;
      private int[] T00023_A4SupplierId ;
      private bool[] T00023_A112SupplierActive ;
      ...
      private bool[] T00022_A112SupplierActive ;
      ...
      private int[] T000215_A50PurchaseOrderId ;
      private int[] T000216_A15ProductId ;
      private int[] T000217_A4SupplierId ;
      private string[] T000218_A5SupplierName ;
   ...
   public class supplier__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00022", "SELECT [SupplierId], [SupplierActive], [SupplierName], [SupplierDescription], [SupplierPhone], [SupplierEmail], [SupplierCreatedDate], [SupplierModifiedDate] FROM [Supplier] WITH (UPDLOCK) WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00022,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00023", "SELECT [SupplierId], [SupplierActive], [SupplierName], [SupplierDescription], [SupplierPhone], [SupplierEmail], [SupplierCreatedDate], [SupplierModifiedDate] FROM [Supplier] WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00023,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T00028", "SELECT [SupplierName] FROM [Supplier] WHERE ([SupplierName] = @SupplierName) AND (Not ( [SupplierId] = @SupplierId)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT00028,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00029", "SELECT [SupplierId] FROM [Supplier] WHERE [SupplierId] = @SupplierId  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT00029,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000210", "SELECT TOP 1 [SupplierId] FROM [Supplier] WHERE ( [SupplierId] > @SupplierId) ORDER BY [SupplierId]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000210,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000211", "SELECT TOP 1 [SupplierId] FROM [Supplier] WHERE ( [SupplierId] < @SupplierId) ORDER BY [SupplierId] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000211,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000212", "INSERT INTO [Supplier]([SupplierActive], [SupplierName], [SupplierDescription], [SupplierPhone], [SupplierEmail], [SupplierCreatedDate], [SupplierModifiedDate]) VALUES(@SupplierActive, @SupplierName, @SupplierDescription, @SupplierPhone, @SupplierEmail, @SupplierCreatedDate, @SupplierModifiedDate); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT000212,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000213", "UPDATE [Supplier] SET [SupplierActive]=@SupplierActive, [SupplierName]=@SupplierName, [SupplierDescription]=@SupplierDescription, [SupplierPhone]=@SupplierPhone, [SupplierEmail]=@SupplierEmail, [SupplierCreatedDate]=@SupplierCreatedDate, [SupplierModifiedDate]=@SupplierModifiedDate  WHERE [SupplierId] = @SupplierId", GxErrorMask.GX_NOMASK,prmT000213)
             ,new CursorDef("T000214", "DELETE FROM [Supplier]  WHERE [SupplierId] = @SupplierId", GxErrorMask.GX_NOMASK,prmT000214)
             ,new CursorDef("T000215", "SELECT TOP 1 [PurchaseOrderId] FROM [PurchaseOrder] WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000215,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000216", "SELECT TOP 1 [ProductId] FROM [Product] WHERE [SupplierId] = @SupplierId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000216,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000217", "SELECT [SupplierId] FROM [Supplier] ORDER BY [SupplierId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000217,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000218", "SELECT [SupplierName] FROM [Supplier] WHERE ([SupplierName] = @SupplierName) AND (Not ( [SupplierId] = @SupplierId)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000218,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
