   ...
   public class viewemployee : GXDataArea
   {
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Employees", "", "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEmployee.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202441123545226", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewemployee.js", "?202441123545226", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewemployee__default(),
            new Object[][] {
                new Object[] {
               H000I2_A20InvoiceId, H000I2_A12EmployeeId, H000I2_A13EmployeeFirstName
               }
               , new Object[] {
               H000I3_A20InvoiceId, H000I3_A12EmployeeId, H000I3_A13EmployeeFirstName
               }
            }
         );
   ...
   public class viewemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [InvoiceId], [EmployeeId], [EmployeeFirstName] FROM [Invoice] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000I3", "SELECT [InvoiceId], [EmployeeId], [EmployeeFirstName] FROM [Invoice] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
