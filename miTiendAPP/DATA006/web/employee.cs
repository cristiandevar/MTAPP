...
namespace GeneXus.Programs {
   public class employee : GXDataArea
   {
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               A37EmployeeModifiedDate = context.localUtil.CToD( cgiGet( edtEmployeeModifiedDate_Internalname), 1);
               AssignAttri("", false, "A37EmployeeModifiedDate", context.localUtil.Format(A37EmployeeModifiedDate, "99/99/99"));
               forbiddenHiddens.Add("EmployeeModifiedDate", context.localUtil.Format(A37EmployeeModifiedDate, "99/99/99"));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202432623581667", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("employee.js", "?202432623581667", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV9TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7EmployeeId',fld:'vEMPLOYEEID',pic:'ZZZZZ9',hsh:true},{av:'A12EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZ9'},{av:'A36EmployeeCreatedDate',fld:'EMPLOYEECREATEDDATE',pic:''},{av:'A37EmployeeModifiedDate',fld:'EMPLOYEEMODIFIEDDATE',pic:''}]");
