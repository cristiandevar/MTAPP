...
namespace GeneXus.Programs {
   public class listproductsnamewp : GXDataArea
   {
      public listproductsnamewp( )
      {
      ...
      public listproductsnamewp( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("listproductsnamewp.aspx") +"\">") ;
      ...
      {
         return formatLink("listproductsnamewp.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "ListProductsNameWP" ;
      }

      public override string GetPgmdesc( )
      {
         return "List Products Name WP" ;
      }
      ...
      protected void WB1Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Products to Purchase to:", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ListProductsNameWP.htm");
         ...
         if ( wbEnd == 15 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGeneratepdf_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Generate PDF", bttGeneratepdf_Jsonclick, 5, "Generate PDF", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GENERATEPDF\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ListProductsNameWP.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1Q2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "List Products Name WP", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023112517253294", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("listproductsnamewp.js", "?2023112517253296", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "List Products Name WP";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.listproductsnamewp__default(),
            new Object[][] {
                new Object[] {
   ...
   public class listproductsnamewp__default : DataStoreHelperBase, IDataStoreHelper
   {
