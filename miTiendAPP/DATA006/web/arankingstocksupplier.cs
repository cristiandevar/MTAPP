...
namespace GeneXus.Programs {
   public class arankingstocksupplier : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9Supplier = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
            }
            if ( toggleJsOutput )
            {
            }
      ...
      public arankingstocksupplier( IGxContext context )
      {
      ...
      {
         arankingstocksupplier objarankingstocksupplier;
         objarankingstocksupplier = new arankingstocksupplier();
         objarankingstocksupplier.AV9Supplier = aP0_Supplier;
         objarankingstocksupplier.context.SetSubmitInitialConfig(context);
         objarankingstocksupplier.initialize();
         Submit( executePrivateCatch,objarankingstocksupplier);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((arankingstocksupplier)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A4SupplierId = P000H2_A4SupplierId[0];
               A29ProductModifiedDate = P000H2_A29ProductModifiedDate[0];
               n29ProductModifiedDate = P000H2_n29ProductModifiedDate[0];
               A28ProductCreatedDate = P000H2_A28ProductCreatedDate[0];
               A18ProductPrice = P000H2_A18ProductPrice[0];
               A69ProductMiniumStock = P000H2_A69ProductMiniumStock[0];
               A55ProductCode = P000H2_A55ProductCode[0];
               n55ProductCode = P000H2_n55ProductCode[0];
               A16ProductName = P000H2_A16ProductName[0];
               A17ProductStock = P000H2_A17ProductStock[0];
               A15ProductId = P000H2_A15ProductId[0];
               H0H0( false, 100) ;
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm = "";
         scmdbuf = "";
         P000H2_A4SupplierId = new int[1] ;
         P000H2_A29ProductModifiedDate = new DateTime[] {DateTime.MinValue} ;
         P000H2_n29ProductModifiedDate = new bool[] {false} ;
         P000H2_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         P000H2_A18ProductPrice = new decimal[1] ;
         P000H2_A69ProductMiniumStock = new int[1] ;
         P000H2_A55ProductCode = new string[] {""} ;
         P000H2_n55ProductCode = new bool[] {false} ;
         P000H2_A16ProductName = new string[] {""} ;
         P000H2_A17ProductStock = new int[1] ;
         P000H2_A15ProductId = new int[1] ;
         ...
         A5SupplierName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.arankingstocksupplier__default(),
            new Object[][] {
                new Object[] {
               P000H2_A4SupplierId, P000H2_A29ProductModifiedDate, P000H2_n29ProductModifiedDate, P000H2_A28ProductCreatedDate, P000H2_A18ProductPrice, P000H2_A69ProductMiniumStock, P000H2_A55ProductCode, P000H2_n55ProductCode, P000H2_A16ProductName, P000H2_A17ProductStock,
               P000H2_A15ProductId
               }
            }
         );
      ...
      private int[] P000H2_A4SupplierId ;
      private DateTime[] P000H2_A29ProductModifiedDate ;
      private bool[] P000H2_n29ProductModifiedDate ;
      private DateTime[] P000H2_A28ProductCreatedDate ;
      private decimal[] P000H2_A18ProductPrice ;
      private int[] P000H2_A69ProductMiniumStock ;
      private string[] P000H2_A55ProductCode ;
      private bool[] P000H2_n55ProductCode ;
      private string[] P000H2_A16ProductName ;
      private int[] P000H2_A17ProductStock ;
      private int[] P000H2_A15ProductId ;
   }

   public class arankingstocksupplier__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P000H2( IGxContext context ,
                                             short AV9Supplier ,
                                             int A4SupplierId )
      {
         ...
         scmdbuf = "SELECT [SupplierId], [ProductModifiedDate], [ProductCreatedDate], [ProductPrice], [ProductMiniumStock], [ProductCode], [ProductName], [ProductStock], [ProductId] FROM [Product]";
         if ( ! (0==AV9Supplier) )
         {
         ...
         scmdbuf += " ORDER BY [ProductStock], [ProductName]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P000H2(context, (short)dynConstraints[0] , (int)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000H2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000H2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
