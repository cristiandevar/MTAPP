...
namespace GeneXus.Programs {
   public class wwpaymentmethod : GXDataArea
   {
      public wwpaymentmethod( )
      {
      ...
      public wwpaymentmethod( IGxContext context )
      {
      ...
      protected void gxnrGrid_newrow_invoke( )
      {
         ...
         AssignProp("", false, edtavDelete_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDelete_Visible), 5, 0), !bGXsfl_27_Refreshing);
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11PaymentMethodDescription = GetPar( "PaymentMethodDescription");
         AV12Update = GetPar( "Update");
         edtavUpdate_Enabled = (int)(Math.Round(NumberUtil.Val( GetNextPar( ), "."), 18, MidpointRounding.ToEven));
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_27_Refreshing);
         edtavUpdate_Visible = (int)(Math.Round(NumberUtil.Val( GetNextPar( ), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11PaymentMethodDescription, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpaymentmethod.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPAYMENTMETHODDESCRIPTION", AV11PaymentMethodDescription);
         /* Send saved values. */
      ...
      {
         return formatLink("wwpaymentmethod.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWPaymentMethod" ;
      }

      public override string GetPgmdesc( )
      {
         return "Payment Method of Sales" ;
      }
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Payment Method of Sales", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWPaymentMethod.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, bttBtninsert_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPaymentMethod.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavPaymentmethoddescription_Internalname, "Payment Method Description", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Multiple line edit */
            ...
            ClassString = "attribute-search";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavPaymentmethoddescription_Internalname, AV11PaymentMethodDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", 0, 1, edtavPaymentmethoddescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "Method Description", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPaymentMethod.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Payment Method of Sales", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Paymentmethoddescription Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPAYMENTMETHODDESCRIPTION"), AV11PaymentMethodDescription) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA4B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavPaymentmethoddescription_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11PaymentMethodDescription ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PAYMENTMETHODACTIVE", GetSecureSignedToken( "", A117PaymentMethodActive, context));
         GxWebStd.gx_hidden_field( context, "PAYMENTMETHODACTIVE", StringUtil.BoolToStr( A117PaymentMethodActive));
      }
      ...
      protected void RF4B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11PaymentMethodDescription ,
                                                 A116PaymentMethodDescription } ,
                                                 new int[]{
                                                 }
            });
            lV11PaymentMethodDescription = StringUtil.Concat( StringUtil.RTrim( AV11PaymentMethodDescription), "%", "");
            /* Using cursor H004B2 */
            pr_default.execute(0, new Object[] {lV11PaymentMethodDescription, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A117PaymentMethodActive = H004B2_A117PaymentMethodActive[0];
               A130PaymentMethodRecarge = H004B2_A130PaymentMethodRecarge[0];
               A129PaymentMethodDiscount = H004B2_A129PaymentMethodDiscount[0];
               A116PaymentMethodDescription = H004B2_A116PaymentMethodDescription[0];
               A115PaymentMethodId = H004B2_A115PaymentMethodId[0];
               E144B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAYMENTMETHODID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A115PaymentMethodId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_PAYMENTMETHODACTIVE"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, A117PaymentMethodActive, context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11PaymentMethodDescription = StringUtil.Concat( StringUtil.RTrim( AV11PaymentMethodDescription), "%", "");
         /* Using cursor H004B3 */
         pr_default.execute(1, new Object[] {lV11PaymentMethodDescription});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11PaymentMethodDescription = GridState.FilterValues("Paymentmethoddescription");
            AssignAttri("", false, "AV11PaymentMethodDescription", AV11PaymentMethodDescription);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PaymentMethodDescription", AV11PaymentMethodDescription);
      }
      ...
      protected void STRUP4B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11PaymentMethodDescription = cgiGet( edtavPaymentmethoddescription_Internalname);
            AssignAttri("", false, "AV11PaymentMethodDescription", AV11PaymentMethodDescription);
      ...
      protected void E124B2( )
      {
         ...
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         if ( new haspermission(context).executeUdp(  "payment update") )
         {
            AV12Update = "Update";
            AssignAttri("", false, edtavUpdate_Internalname, AV12Update);
         }
         ...
         if ( new haspermission(context).executeUdp(  "payment delete") )
         {
            AV13Delete = "Deactive";
            AssignAttri("", false, edtavDelete_Internalname, AV13Delete);
         }
         ...
         Form.Caption = "Payment Method of Sales";
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( new haspermission(context).executeUdp(  "payment insert") )
         {
      ...
      private void E144B2( )
      {
         ...
         if ( new haspermission(context).executeUdp(  "payment update") )
         {
            edtavUpdate_Link = formatLink("paymentmethod.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A115PaymentMethodId,6,0))}, new string[] {"Mode","PaymentMethodId"}) ;
         }
         else
         {
            edtavUpdate_Link = "";
         ...
         if ( new haspermission(context).executeUdp(  "payment delete") )
         {
            edtavDelete_Link = formatLink("paymentmethod.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A115PaymentMethodId,6,0))}, new string[] {"Mode","PaymentMethodId"}) ;
         }
         else
         {
            edtavDelete_Link = "";
      ...
      protected void E114B2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("paymentmethod.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","PaymentMethodId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void E154B2( )
      {
         ...
         else
         {
            ...
            GX_msglist.addItem("Payment Method "+AV17ErrorMessageAux+" failed! : "+AV16ErrorMessage);
         }
         /*  Sending Event outputs  */
      }
      ...
      {
         edtPaymentMethodId_Internalname = "PAYMENTMETHODID_"+sGXsfl_27_idx;
         edtPaymentMethodDescription_Internalname = "PAYMENTMETHODDESCRIPTION_"+sGXsfl_27_idx;
         edtPaymentMethodDiscount_Internalname = "PAYMENTMETHODDISCOUNT_"+sGXsfl_27_idx;
         edtPaymentMethodRecarge_Internalname = "PAYMENTMETHODRECARGE_"+sGXsfl_27_idx;
         chkPaymentMethodActive_Internalname = "PAYMENTMETHODACTIVE_"+sGXsfl_27_idx;
      ...
      {
         edtPaymentMethodId_Internalname = "PAYMENTMETHODID_"+sGXsfl_27_fel_idx;
         edtPaymentMethodDescription_Internalname = "PAYMENTMETHODDESCRIPTION_"+sGXsfl_27_fel_idx;
         edtPaymentMethodDiscount_Internalname = "PAYMENTMETHODDISCOUNT_"+sGXsfl_27_fel_idx;
         edtPaymentMethodRecarge_Internalname = "PAYMENTMETHODRECARGE_"+sGXsfl_27_fel_idx;
         chkPaymentMethodActive_Internalname = "PAYMENTMETHODACTIVE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaymentMethodRecarge_Internalname,StringUtil.LTrim( StringUtil.NToC( A130PaymentMethodRecarge, 8, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A130PaymentMethodRecarge, "ZZZZ9.99")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPaymentMethodRecarge_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Percentage",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "PAYMENTMETHODACTIVE_" + sGXsfl_27_idx;
            chkPaymentMethodActive.Name = GXCCtl;
            chkPaymentMethodActive.WebTags = "";
            chkPaymentMethodActive.Caption = "";
            AssignProp("", false, chkPaymentMethodActive_Internalname, "TitleCaption", chkPaymentMethodActive.Caption, !bGXsfl_27_Refreshing);
            ...
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkPaymentMethodActive_Internalname,StringUtil.BoolToStr( A117PaymentMethodActive),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"column WWOptionalColumn",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavDelete_Enabled!=0)&&(edtavDelete_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 34,'',false,'"+sGXsfl_27_idx+"',27)\"" : " ");
            ROClassString = "TextActionAttribute TextLikeLink";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavDelete_Internalname,StringUtil.RTrim( AV13Delete),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavDelete_Enabled!=0)&&(edtavDelete_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,34);\"" : " "),"'"+""+"'"+",false,"+"'"+"EVDELETE.CLICK."+sGXsfl_27_idx+"'",(string)edtavDelete_Link,(string)"",(string)"",(string)"",(string)edtavDelete_Jsonclick,(short)5,(string)"TextActionAttribute TextLikeLink",(string)"",(string)ROClassString,(string)"WWTextActionColumn",(string)"",(int)edtavDelete_Visible,(int)edtavDelete_Enabled,(short)1,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A117PaymentMethodActive)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavPaymentmethoddescription_Internalname = "vPAYMENTMETHODDESCRIPTION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavPaymentmethoddescription_Enabled = 1;
         bttBtninsert_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH",",oparms:[{ctrl:'BTNINSERT',prop:'Enabled'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E144B2',iparms:[{av:'A115PaymentMethodId',fld:'PAYMENTMETHODID',pic:'ZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("GRID_PREVPAGE",",oparms:[{ctrl:'BTNINSERT',prop:'Enabled'}]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaymentMethodDescription',fld:'vPAYMENTMETHODDESCRIPTION',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[{ctrl:'BTNINSERT',prop:'Enabled'}]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11PaymentMethodDescription',fld:'vPAYMENTMETHODDESCRIPTION',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'}]");
         setEventMetadata("GRID_LASTPAGE",",oparms:[{ctrl:'BTNINSERT',prop:'Enabled'}]}");
      ...
      public override void initialize( )
      {
         ...
         H004B2_A117PaymentMethodActive = new bool[] {false} ;
         H004B2_A130PaymentMethodRecarge = new decimal[1] ;
         H004B2_A129PaymentMethodDiscount = new decimal[1] ;
         H004B2_A116PaymentMethodDescription = new string[] {""} ;
         H004B2_A115PaymentMethodId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpaymentmethod__default(),
            new Object[][] {
                new Object[] {
               H004B2_A117PaymentMethodActive, H004B2_A130PaymentMethodRecarge, H004B2_A129PaymentMethodDiscount, H004B2_A116PaymentMethodDescription, H004B2_A115PaymentMethodId
               }
               , new Object[] {
      ...
      private int edtavPaymentmethoddescription_Enabled ;
      ...
      private string edtavPaymentmethoddescription_Internalname ;
      ...
      private bool[] H004B2_A117PaymentMethodActive ;
      private decimal[] H004B2_A130PaymentMethodRecarge ;
      private decimal[] H004B2_A129PaymentMethodDiscount ;
      private string[] H004B2_A116PaymentMethodDescription ;
      private int[] H004B2_A115PaymentMethodId ;
   ...
   public class wwpaymentmethod__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H004B2( IGxContext context ,
                                             string AV11PaymentMethodDescription ,
                                             string A116PaymentMethodDescription )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [PaymentMethodActive], [PaymentMethodRecarge], [PaymentMethodDiscount], [PaymentMethodDescription], [PaymentMethodId]";
         sFromString = " FROM [PaymentMethod]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11PaymentMethodDescription)) )
         {
            AddWhere(sWhereString, "([PaymentMethodDescription] like '%' + @lV11PaymentMethodDescription + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [PaymentMethodDescription]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004B2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H004B3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PaymentMethodDescription",GXType.NVarChar,200,0) ,
