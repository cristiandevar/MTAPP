...
namespace GeneXus.Programs {
   public class supplierproductwc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6SupplierId, A15ProductId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplierproductwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SupplierId,6,0))}, new string[] {"SupplierId"}) +"\">") ;
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lbllbl13_Internalname, "", "", "", lbllbl13_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "navbar-brand", 0, "", 1, 1, 0, 0, "HLP_SupplierProductWC.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, bttBtninsert_Enabled, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierProductWC.htm");
            context.WriteHtmlText( "</li>") ;
            context.WriteHtmlText( "<li>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button button-tertiary";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierProductWC.htm");
            context.WriteHtmlText( "</li>") ;
      ...
      protected void RF1C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15ProductId = H001C2_A15ProductId[0];
               A1BrandId = H001C2_A1BrandId[0];
               n1BrandId = H001C2_n1BrandId[0];
               A9SectorId = H001C2_A9SectorId[0];
               n9SectorId = H001C2_n9SectorId[0];
               A4SupplierId = H001C2_A4SupplierId[0];
               AssignAttri(sPrefix, false, "A4SupplierId", StringUtil.LTrimStr( (decimal)(A4SupplierId), 6, 0));
               A110ProductActive = H001C2_A110ProductActive[0];
               n110ProductActive = H001C2_n110ProductActive[0];
               A29ProductModifiedDate = H001C2_A29ProductModifiedDate[0];
               A28ProductCreatedDate = H001C2_A28ProductCreatedDate[0];
               A19ProductDescription = H001C2_A19ProductDescription[0];
               n19ProductDescription = H001C2_n19ProductDescription[0];
               A10SectorName = H001C2_A10SectorName[0];
               A2BrandName = H001C2_A2BrandName[0];
               A93ProductMiniumQuantityWholesale = H001C2_A93ProductMiniumQuantityWholesale[0];
               n93ProductMiniumQuantityWholesale = H001C2_n93ProductMiniumQuantityWholesale[0];
               A69ProductMiniumStock = H001C2_A69ProductMiniumStock[0];
               n69ProductMiniumStock = H001C2_n69ProductMiniumStock[0];
               A17ProductStock = H001C2_A17ProductStock[0];
               n17ProductStock = H001C2_n17ProductStock[0];
               A16ProductName = H001C2_A16ProductName[0];
               A55ProductCode = H001C2_A55ProductCode[0];
               n55ProductCode = H001C2_n55ProductCode[0];
               A89ProductRetailProfit = H001C2_A89ProductRetailProfit[0];
               n89ProductRetailProfit = H001C2_n89ProductRetailProfit[0];
               A85ProductCostPrice = H001C2_A85ProductCostPrice[0];
               n85ProductCostPrice = H001C2_n85ProductCostPrice[0];
               A87ProductWholesaleProfit = H001C2_A87ProductWholesaleProfit[0];
               n87ProductWholesaleProfit = H001C2_n87ProductWholesaleProfit[0];
               A2BrandName = H001C2_A2BrandName[0];
               A10SectorName = H001C2_A10SectorName[0];
      ...
      private void E141C2( )
      {
         ...
         AV17State = (A110ProductActive ? "Enabled" : "Disabled");
         AssignAttri(sPrefix, false, edtavState_Internalname, AV17State);
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E121C2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         new exportsupplierproductwc(context ).execute(  AV6SupplierId, out  AV15ExcelFilename, out  AV16ErrorMessage) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411222332554", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("supplierproductwc.js", "?202411222332554", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtSectorName_Internalname = sPrefix+"SECTORNAME_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtSectorName_Internalname = sPrefix+"SECTORNAME_"+sGXsfl_25_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'sPrefix'},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141C2',iparms:[{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'A1BrandId',fld:'BRANDID',pic:'ZZZZZ9'},{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9'},{av:'A110ProductActive',fld:'PRODUCTACTIVE',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtProductName_Link',ctrl:'PRODUCTNAME',prop:'Link'},{av:'edtBrandName_Link',ctrl:'BRANDNAME',prop:'Link'},{av:'edtSectorName_Link',ctrl:'SECTORNAME',prop:'Link'},{av:'AV17State',fld:'vSTATE',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111C2',iparms:[{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("'DOEXPORT'","{handler:'E121C2',iparms:[{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'}]");
         setEventMetadata("'DOEXPORT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001C2_A15ProductId = new int[1] ;
         H001C2_A1BrandId = new int[1] ;
         H001C2_n1BrandId = new bool[] {false} ;
         H001C2_A9SectorId = new int[1] ;
         H001C2_n9SectorId = new bool[] {false} ;
         H001C2_A4SupplierId = new int[1] ;
         H001C2_A110ProductActive = new bool[] {false} ;
         H001C2_n110ProductActive = new bool[] {false} ;
         H001C2_A29ProductModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H001C2_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H001C2_A19ProductDescription = new string[] {""} ;
         H001C2_n19ProductDescription = new bool[] {false} ;
         H001C2_A10SectorName = new string[] {""} ;
         H001C2_A2BrandName = new string[] {""} ;
         H001C2_A93ProductMiniumQuantityWholesale = new short[1] ;
         H001C2_n93ProductMiniumQuantityWholesale = new bool[] {false} ;
         H001C2_A69ProductMiniumStock = new int[1] ;
         H001C2_n69ProductMiniumStock = new bool[] {false} ;
         H001C2_A17ProductStock = new int[1] ;
         H001C2_n17ProductStock = new bool[] {false} ;
         H001C2_A16ProductName = new string[] {""} ;
         H001C2_A55ProductCode = new string[] {""} ;
         H001C2_n55ProductCode = new bool[] {false} ;
         H001C2_A89ProductRetailProfit = new decimal[1] ;
         H001C2_n89ProductRetailProfit = new bool[] {false} ;
         H001C2_A85ProductCostPrice = new decimal[1] ;
         H001C2_n85ProductCostPrice = new bool[] {false} ;
         H001C2_A87ProductWholesaleProfit = new decimal[1] ;
         H001C2_n87ProductWholesaleProfit = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplierproductwc__default(),
            new Object[][] {
                new Object[] {
               H001C2_A15ProductId, H001C2_A1BrandId, H001C2_n1BrandId, H001C2_A9SectorId, H001C2_n9SectorId, H001C2_A4SupplierId, H001C2_A110ProductActive, H001C2_n110ProductActive, H001C2_A29ProductModifiedDate, H001C2_A28ProductCreatedDate,
               H001C2_A19ProductDescription, H001C2_n19ProductDescription, H001C2_A10SectorName, H001C2_A2BrandName, H001C2_A93ProductMiniumQuantityWholesale, H001C2_n93ProductMiniumQuantityWholesale, H001C2_A69ProductMiniumStock, H001C2_n69ProductMiniumStock, H001C2_A17ProductStock, H001C2_n17ProductStock,
               H001C2_A16ProductName, H001C2_A55ProductCode, H001C2_n55ProductCode, H001C2_A89ProductRetailProfit, H001C2_n89ProductRetailProfit, H001C2_A85ProductCostPrice, H001C2_n85ProductCostPrice, H001C2_A87ProductWholesaleProfit, H001C2_n87ProductWholesaleProfit
               }
               , new Object[] {
      ...
      private int[] H001C2_A15ProductId ;
      private int[] H001C2_A1BrandId ;
      private bool[] H001C2_n1BrandId ;
      private int[] H001C2_A9SectorId ;
      private bool[] H001C2_n9SectorId ;
      private int[] H001C2_A4SupplierId ;
      private bool[] H001C2_A110ProductActive ;
      private bool[] H001C2_n110ProductActive ;
      private DateTime[] H001C2_A29ProductModifiedDate ;
      private DateTime[] H001C2_A28ProductCreatedDate ;
      private string[] H001C2_A19ProductDescription ;
      private bool[] H001C2_n19ProductDescription ;
      private string[] H001C2_A10SectorName ;
      private string[] H001C2_A2BrandName ;
      private short[] H001C2_A93ProductMiniumQuantityWholesale ;
      private bool[] H001C2_n93ProductMiniumQuantityWholesale ;
      private int[] H001C2_A69ProductMiniumStock ;
      private bool[] H001C2_n69ProductMiniumStock ;
      private int[] H001C2_A17ProductStock ;
      private bool[] H001C2_n17ProductStock ;
      private string[] H001C2_A16ProductName ;
      private string[] H001C2_A55ProductCode ;
      private bool[] H001C2_n55ProductCode ;
      private decimal[] H001C2_A89ProductRetailProfit ;
      private bool[] H001C2_n89ProductRetailProfit ;
      private decimal[] H001C2_A85ProductCostPrice ;
      private bool[] H001C2_n85ProductCostPrice ;
      private decimal[] H001C2_A87ProductWholesaleProfit ;
      private bool[] H001C2_n87ProductWholesaleProfit ;
   ...
   public class supplierproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001C2", "SELECT T1.[ProductId], T1.[BrandId], T1.[SectorId], T1.[SupplierId], T1.[ProductActive], T1.[ProductModifiedDate], T1.[ProductCreatedDate], T1.[ProductDescription], T3.[SectorName], T2.[BrandName], T1.[ProductMiniumQuantityWholesale], T1.[ProductMiniumStock], T1.[ProductStock], T1.[ProductName], T1.[ProductCode], T1.[ProductRetailProfit], T1.[ProductCostPrice], T1.[ProductWholesaleProfit] FROM (([Product] T1 LEFT JOIN [Brand] T2 ON T2.[BrandId] = T1.[BrandId]) LEFT JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) WHERE T1.[SupplierId] = @AV6SupplierId ORDER BY T1.[SupplierId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001C3", "SELECT COUNT(*) FROM (([Product] T1 LEFT JOIN [Brand] T2 ON T2.[BrandId] = T1.[BrandId]) LEFT JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) WHERE T1.[SupplierId] = @AV6SupplierId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
