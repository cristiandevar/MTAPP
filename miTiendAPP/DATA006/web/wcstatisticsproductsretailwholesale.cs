...
namespace GeneXus.Programs {
   public class wcstatisticsproductsretailwholesale : GXWebComponent
   {
      public wcstatisticsproductsretailwholesale( )
      {
      ...
      public wcstatisticsproductsretailwholesale( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV28Type = StringUtil.StrToBool( GetPar( "Type"));
                  AssignAttri(sPrefix, false, "AV28Type", AV28Type);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV20Year,(short)AV14Month,(bool)AV28Type});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCStatistics Products Retail Wholesale") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcstatisticsproductsretailwholesale.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV20Year,4,0)),UrlEncode(StringUtil.LTrimStr(AV14Month,4,0)),UrlEncode(StringUtil.BoolToStr(AV28Type))}, new string[] {"Year","Month","Type"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"wcpOAV28Type", wcpOAV28Type);
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vTYPE", AV28Type);
      ...
      {
         return "WCStatisticsProductsRetailWholesale" ;
      }

      public override string GetPgmdesc( )
      {
         return "WCStatistics Products Retail Wholesale" ;
      }
      ...
      protected void WB440( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcstatisticsproductsretailwholesale.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
            }
      ...
      protected void START442( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCStatistics Products Retail Wholesale", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP440( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV28Type = StringUtil.StrToBool( cgiGet( sPrefix+"wcpOAV28Type"));
      ...
      protected void S112( )
      {
         ...
         AV16Parameters.Add(AV15Parameter, 0);
         AV15Parameter = new GeneXus.Programs.genexusreporting.SdtQueryViewerParameters_Parameter(context);
         AV15Parameter.gxTpr_Name = "Type";
         AV15Parameter.gxTpr_Value = StringUtil.BoolToStr( AV28Type);
         AV16Parameters.Add(AV15Parameter, 0);
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV28Type = (string)((string)getParm(obj,2));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcstatisticsproductsretailwholesale", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV14Month", StringUtil.LTrimStr( (decimal)(AV14Month), 4, 0));
            AV28Type = (bool)getParm(obj,4);
            AssignAttri(sPrefix, false, "AV28Type", AV28Type);
         }
         wcpOAV20Year = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV20Year"), ".", ","), 18, MidpointRounding.ToEven));
         wcpOAV14Month = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV14Month"), ".", ","), 18, MidpointRounding.ToEven));
         wcpOAV28Type = StringUtil.StrToBool( cgiGet( sPrefix+"wcpOAV28Type"));
         if ( ! GetJustCreated( ) && ( ( AV20Year != wcpOAV20Year ) || ( AV14Month != wcpOAV14Month ) || ( AV28Type != wcpOAV28Type ) ) )
         {
            setjustcreated();
         }
         wcpOAV20Year = AV20Year;
         wcpOAV14Month = AV14Month;
         wcpOAV28Type = AV28Type;
      }
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV28Type = cgiGet( sPrefix+"AV28Type_CTRL");
         if ( StringUtil.Len( sCtrlAV28Type) > 0 )
         {
            AV28Type = StringUtil.StrToBool( cgiGet( sCtrlAV28Type));
            AssignAttri(sPrefix, false, "AV28Type", AV28Type);
         }
         else
         {
            AV28Type = StringUtil.StrToBool( cgiGet( sPrefix+"AV28Type_PARM"));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV28Type_PARM", StringUtil.BoolToStr( AV28Type));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV28Type)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV28Type_CTRL", StringUtil.RTrim( sCtrlAV28Type));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112312253619", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wcstatisticsproductsretailwholesale.js", "?2024112312253619", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV20Year',fld:'vYEAR',pic:'ZZZ9'},{av:'AV14Month',fld:'vMONTH',pic:'ZZZ9'},{av:'AV28Type',fld:'vTYPE',pic:''}]");
      ...
      private string sCtrlAV28Type ;
      private bool AV28Type ;
      private bool wcpOAV28Type ;
