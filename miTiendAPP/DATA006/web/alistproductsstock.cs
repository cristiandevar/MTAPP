...
namespace GeneXus.Programs {
   public class alistproductsstock : GXWebProcedure
   {
      ...
      public alistproductsstock( IGxContext context )
      {
      ...
      {
         alistproductsstock objalistproductsstock;
         objalistproductsstock = new alistproductsstock();
         objalistproductsstock.AV8Supplier = aP0_Supplier;
         objalistproductsstock.context.SetSubmitInitialConfig(context);
         objalistproductsstock.initialize();
         Submit( executePrivateCatch,objalistproductsstock);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((alistproductsstock)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A4SupplierId = P000L2_A4SupplierId[0];
               A29ProductModifiedDate = P000L2_A29ProductModifiedDate[0];
               n29ProductModifiedDate = P000L2_n29ProductModifiedDate[0];
               A28ProductCreatedDate = P000L2_A28ProductCreatedDate[0];
               A18ProductPrice = P000L2_A18ProductPrice[0];
               A69ProductMiniumStock = P000L2_A69ProductMiniumStock[0];
               A55ProductCode = P000L2_A55ProductCode[0];
               n55ProductCode = P000L2_n55ProductCode[0];
               A16ProductName = P000L2_A16ProductName[0];
               A17ProductStock = P000L2_A17ProductStock[0];
               A15ProductId = P000L2_A15ProductId[0];
               H0L0( false, 100) ;
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm = "";
         scmdbuf = "";
         P000L2_A4SupplierId = new int[1] ;
         P000L2_A29ProductModifiedDate = new DateTime[] {DateTime.MinValue} ;
         P000L2_n29ProductModifiedDate = new bool[] {false} ;
         P000L2_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         P000L2_A18ProductPrice = new decimal[1] ;
         P000L2_A69ProductMiniumStock = new int[1] ;
         P000L2_A55ProductCode = new string[] {""} ;
         P000L2_n55ProductCode = new bool[] {false} ;
         P000L2_A16ProductName = new string[] {""} ;
         P000L2_A17ProductStock = new int[1] ;
         P000L2_A15ProductId = new int[1] ;
         ...
         A5SupplierName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.alistproductsstock__default(),
            new Object[][] {
                new Object[] {
               P000L2_A4SupplierId, P000L2_A29ProductModifiedDate, P000L2_n29ProductModifiedDate, P000L2_A28ProductCreatedDate, P000L2_A18ProductPrice, P000L2_A69ProductMiniumStock, P000L2_A55ProductCode, P000L2_n55ProductCode, P000L2_A16ProductName, P000L2_A17ProductStock,
               P000L2_A15ProductId
               }
            }
         );
      ...
      private int[] P000L2_A4SupplierId ;
      private DateTime[] P000L2_A29ProductModifiedDate ;
      private bool[] P000L2_n29ProductModifiedDate ;
      private DateTime[] P000L2_A28ProductCreatedDate ;
      private decimal[] P000L2_A18ProductPrice ;
      private int[] P000L2_A69ProductMiniumStock ;
      private string[] P000L2_A55ProductCode ;
      private bool[] P000L2_n55ProductCode ;
      private string[] P000L2_A16ProductName ;
      private int[] P000L2_A17ProductStock ;
      private int[] P000L2_A15ProductId ;
   }

   public class alistproductsstock__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A4SupplierId )
      {
         ...
         scmdbuf += " ORDER BY [ProductStock], [ProductName], [ProductCode]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P000L2(context, (short)dynConstraints[0] , (int)dynConstraints[1] );
         }
