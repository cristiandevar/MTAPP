...
namespace GeneXus.Programs {
   public class wpstatistics : GXDataArea
   {
      public wpstatistics( )
      {
      ...
      public wpstatistics( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpstatistics.aspx") +"\">") ;
      ...
      {
         return formatLink("wpstatistics.aspx")  ;
      }
      ...
      protected void START2A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPStatistics", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E112A2( )
      {
         ...
         AssignAttri("", false, "AV16AllOk", AV16AllOk);
         if ( ! AV16AllOk )
         {
            AV17WebSession.Set("SecLogIn", "Error");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241242141564", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpstatistics.js", "?20241242141566", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Queryviewer1_Title = "Total Raised per Product";
         Queryviewer1_Type = "Chart";
         Queryviewer1_Objectname = "QueryProductsSold";
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "WPStatistics";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
