...
namespace GeneXus.Programs {
   public class wwsector : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11SectorName, AV12Update, AV13Delete, A9SectorId) ;
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, bttBtninsert_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSector.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
      ...
      protected void E12162( )
      {
         ...
         if ( ! new haspermission(context).executeUdp(  "sector insert") )
         {
         ...
         if ( ! new haspermission(context).executeUdp(  "sector update") )
         {
         ...
         if ( ! new haspermission(context).executeUdp(  "sector delete") )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241115213831", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwsector.js", "?20241115213831", false, true);
         }
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavUpdate_Enabled!=0)&&(edtavUpdate_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 32,'',false,'"+sGXsfl_27_idx+"',27)\"" : " ");
            ...
            /* Single line edit */
            TempTags = " " + ((edtavDelete_Enabled!=0)&&(edtavDelete_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 33,'',false,'"+sGXsfl_27_idx+"',27)\"" : " ");
            ROClassString = "TextActionAttribute TextLikeLink";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsector__default(),
            new Object[][] {
                new Object[] {
               H00162_A9SectorId, H00162_A35SectorModifiedDate, H00162_n35SectorModifiedDate, H00162_A34SectorCreatedDate, H00162_A11SectorDescription, H00162_n11SectorDescription, H00162_A10SectorName
               }
               , new Object[] {
   ...
   public class wwsector__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A10SectorName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [SectorId], [SectorModifiedDate], [SectorCreatedDate], [SectorDescription], [SectorName]";
