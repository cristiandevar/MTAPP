...
namespace GeneXus.Programs {
   public class productgetstate : GXProcedure
   {
      public productgetstate( )
      {
      ...
      public productgetstate( IGxContext context )
      {
      ...
      public void executeSubmit( int aP0_ProductId ,
                                 out string aP1_State )
      {
         productgetstate objproductgetstate;
         objproductgetstate = new productgetstate();
         objproductgetstate.AV8ProductId = aP0_ProductId;
         objproductgetstate.AV9State = "" ;
         objproductgetstate.context.SetSubmitInitialConfig(context);
         objproductgetstate.initialize();
         Submit( executePrivateCatch,objproductgetstate);
         aP1_State=this.AV9State;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((productgetstate)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productgetstate__default(),
            new Object[][] {
                new Object[] {
   ...
   public class productgetstate__default : DataStoreHelperBase, IDataStoreHelper
   {
