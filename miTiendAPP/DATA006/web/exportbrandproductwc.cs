...
namespace GeneXus.Programs {
   public class exportbrandproductwc : GXProcedure
   {
      public exportbrandproductwc( )
      {
      ...
      public exportbrandproductwc( IGxContext context )
      {
      ...
      public string executeUdp( int aP0_BrandId ,
                                out string aP1_Filename )
      {
         execute(aP0_BrandId, out aP1_Filename, out aP2_ErrorMessage);
         return AV11ErrorMessage ;
      }

      public void executeSubmit( int aP0_BrandId ,
                                 out string aP1_Filename ,
                                 out string aP2_ErrorMessage )
      {
         exportbrandproductwc objexportbrandproductwc;
         objexportbrandproductwc = new exportbrandproductwc();
         objexportbrandproductwc.AV18BrandId = aP0_BrandId;
         objexportbrandproductwc.AV10Filename = "" ;
         objexportbrandproductwc.AV11ErrorMessage = "" ;
         objexportbrandproductwc.context.SetSubmitInitialConfig(context);
         objexportbrandproductwc.initialize();
         Submit( executePrivateCatch,objexportbrandproductwc);
         aP1_Filename=this.AV10Filename;
         aP2_ErrorMessage=this.AV11ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((exportbrandproductwc)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV10Filename = "ExportBrandProductWC-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV14Random), 8, 0)) + ".xlsx";
         ...
         AV9ExcelDocument.get_Cells(AV12CellRow, AV13FirstColumn+3, 1, 1).Text = "Min. Stock";
         ...
         AV9ExcelDocument.get_Cells(AV12CellRow, AV13FirstColumn+9, 1, 1).Text = "Min. Qty. Wholesale";
         AV9ExcelDocument.get_Cells(AV12CellRow, AV13FirstColumn+10, 1, 1).Bold = 1;
         AV9ExcelDocument.get_Cells(AV12CellRow, AV13FirstColumn+10, 1, 1).Text = "Sector";
         ...
         /* Using cursor P002I2 */
         pr_default.execute(0, new Object[] {AV18BrandId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A9SectorId = P002I2_A9SectorId[0];
            n9SectorId = P002I2_n9SectorId[0];
            A4SupplierId = P002I2_A4SupplierId[0];
            A1BrandId = P002I2_A1BrandId[0];
            n1BrandId = P002I2_n1BrandId[0];
            A55ProductCode = P002I2_A55ProductCode[0];
            n55ProductCode = P002I2_n55ProductCode[0];
            A16ProductName = P002I2_A16ProductName[0];
            A17ProductStock = P002I2_A17ProductStock[0];
            n17ProductStock = P002I2_n17ProductStock[0];
            A69ProductMiniumStock = P002I2_A69ProductMiniumStock[0];
            n69ProductMiniumStock = P002I2_n69ProductMiniumStock[0];
            A93ProductMiniumQuantityWholesale = P002I2_A93ProductMiniumQuantityWholesale[0];
            n93ProductMiniumQuantityWholesale = P002I2_n93ProductMiniumQuantityWholesale[0];
            A10SectorName = P002I2_A10SectorName[0];
            A5SupplierName = P002I2_A5SupplierName[0];
            A15ProductId = P002I2_A15ProductId[0];
            A19ProductDescription = P002I2_A19ProductDescription[0];
            n19ProductDescription = P002I2_n19ProductDescription[0];
            A28ProductCreatedDate = P002I2_A28ProductCreatedDate[0];
            A29ProductModifiedDate = P002I2_A29ProductModifiedDate[0];
            A87ProductWholesaleProfit = P002I2_A87ProductWholesaleProfit[0];
            n87ProductWholesaleProfit = P002I2_n87ProductWholesaleProfit[0];
            A85ProductCostPrice = P002I2_A85ProductCostPrice[0];
            n85ProductCostPrice = P002I2_n85ProductCostPrice[0];
            A89ProductRetailProfit = P002I2_A89ProductRetailProfit[0];
            n89ProductRetailProfit = P002I2_n89ProductRetailProfit[0];
            A10SectorName = P002I2_A10SectorName[0];
            A5SupplierName = P002I2_A5SupplierName[0];
            ...
            AV9ExcelDocument.get_Cells(AV12CellRow, AV13FirstColumn+10, 1, 1).Text = A10SectorName;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P002I2_A9SectorId = new int[1] ;
         P002I2_n9SectorId = new bool[] {false} ;
         P002I2_A4SupplierId = new int[1] ;
         P002I2_A1BrandId = new int[1] ;
         P002I2_n1BrandId = new bool[] {false} ;
         P002I2_A55ProductCode = new string[] {""} ;
         P002I2_n55ProductCode = new bool[] {false} ;
         P002I2_A16ProductName = new string[] {""} ;
         P002I2_A17ProductStock = new int[1] ;
         P002I2_n17ProductStock = new bool[] {false} ;
         P002I2_A69ProductMiniumStock = new int[1] ;
         P002I2_n69ProductMiniumStock = new bool[] {false} ;
         P002I2_A93ProductMiniumQuantityWholesale = new short[1] ;
         P002I2_n93ProductMiniumQuantityWholesale = new bool[] {false} ;
         P002I2_A10SectorName = new string[] {""} ;
         P002I2_A5SupplierName = new string[] {""} ;
         P002I2_A15ProductId = new int[1] ;
         P002I2_A19ProductDescription = new string[] {""} ;
         P002I2_n19ProductDescription = new bool[] {false} ;
         P002I2_A28ProductCreatedDate = new DateTime[] {DateTime.MinValue} ;
         P002I2_A29ProductModifiedDate = new DateTime[] {DateTime.MinValue} ;
         P002I2_A87ProductWholesaleProfit = new decimal[1] ;
         P002I2_n87ProductWholesaleProfit = new bool[] {false} ;
         P002I2_A85ProductCostPrice = new decimal[1] ;
         P002I2_n85ProductCostPrice = new bool[] {false} ;
         P002I2_A89ProductRetailProfit = new decimal[1] ;
         P002I2_n89ProductRetailProfit = new bool[] {false} ;
         A55ProductCode = "";
         A16ProductName = "";
         A10SectorName = "";
         A5SupplierName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportbrandproductwc__default(),
            new Object[][] {
                new Object[] {
               P002I2_A9SectorId, P002I2_n9SectorId, P002I2_A4SupplierId, P002I2_A1BrandId, P002I2_n1BrandId, P002I2_A55ProductCode, P002I2_n55ProductCode, P002I2_A16ProductName, P002I2_A17ProductStock, P002I2_n17ProductStock,
               P002I2_A69ProductMiniumStock, P002I2_n69ProductMiniumStock, P002I2_A93ProductMiniumQuantityWholesale, P002I2_n93ProductMiniumQuantityWholesale, P002I2_A10SectorName, P002I2_A5SupplierName, P002I2_A15ProductId, P002I2_A19ProductDescription, P002I2_n19ProductDescription, P002I2_A28ProductCreatedDate,
               P002I2_A29ProductModifiedDate, P002I2_A87ProductWholesaleProfit, P002I2_n87ProductWholesaleProfit, P002I2_A85ProductCostPrice, P002I2_n85ProductCostPrice, P002I2_A89ProductRetailProfit, P002I2_n89ProductRetailProfit
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] P002I2_A9SectorId ;
      private bool[] P002I2_n9SectorId ;
      private int[] P002I2_A4SupplierId ;
      private int[] P002I2_A1BrandId ;
      private bool[] P002I2_n1BrandId ;
      private string[] P002I2_A55ProductCode ;
      private bool[] P002I2_n55ProductCode ;
      private string[] P002I2_A16ProductName ;
      private int[] P002I2_A17ProductStock ;
      private bool[] P002I2_n17ProductStock ;
      private int[] P002I2_A69ProductMiniumStock ;
      private bool[] P002I2_n69ProductMiniumStock ;
      private short[] P002I2_A93ProductMiniumQuantityWholesale ;
      private bool[] P002I2_n93ProductMiniumQuantityWholesale ;
      private string[] P002I2_A10SectorName ;
      private string[] P002I2_A5SupplierName ;
      private int[] P002I2_A15ProductId ;
      private string[] P002I2_A19ProductDescription ;
      private bool[] P002I2_n19ProductDescription ;
      private DateTime[] P002I2_A28ProductCreatedDate ;
      private DateTime[] P002I2_A29ProductModifiedDate ;
      private decimal[] P002I2_A87ProductWholesaleProfit ;
      private bool[] P002I2_n87ProductWholesaleProfit ;
      private decimal[] P002I2_A85ProductCostPrice ;
      private bool[] P002I2_n85ProductCostPrice ;
      private decimal[] P002I2_A89ProductRetailProfit ;
      private bool[] P002I2_n89ProductRetailProfit ;
   ...
   public class exportbrandproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV18BrandId",GXType.Int32,6,0)
          };
          def= new CursorDef[] {
              new CursorDef("P002I2", "SELECT T1.[SectorId], T1.[SupplierId], T1.[BrandId], T1.[ProductCode], T1.[ProductName], T1.[ProductStock], T1.[ProductMiniumStock], T1.[ProductMiniumQuantityWholesale], T2.[SectorName], T3.[SupplierName], T1.[ProductId], T1.[ProductDescription], T1.[ProductCreatedDate], T1.[ProductModifiedDate], T1.[ProductWholesaleProfit], T1.[ProductCostPrice], T1.[ProductRetailProfit] FROM (([Product] T1 LEFT JOIN [Sector] T2 ON T2.[SectorId] = T1.[SectorId]) INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T1.[SupplierId]) WHERE T1.[BrandId] = @AV18BrandId ORDER BY T1.[BrandId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002I2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
