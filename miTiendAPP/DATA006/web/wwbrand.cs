...
namespace GeneXus.Programs {
   public class wwbrand : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11BrandName, AV12Update, AV13Delete, A1BrandId) ;
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, bttBtninsert_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWBrand.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
      ...
      protected void E120F2( )
      {
         ...
         if ( ! new haspermission(context).executeUdp(  "brand insert") )
         {
         ...
         if ( ! new haspermission(context).executeUdp(  "brand update") )
         {
         ...
         if ( ! new haspermission(context).executeUdp(  "brand delete") )
         {
            edtavUpdate_Visible = 0;
            AssignProp("", false, edtavUpdate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavUpdate_Visible), 5, 0), !bGXsfl_27_Refreshing);
            edtavUpdate_Enabled = 0;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241115213563", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwbrand.js", "?20241115213563", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11BrandName',fld:'vBRANDNAME',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'A1BrandId',fld:'BRANDID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H000F3_n1BrandId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwbrand__default(),
            new Object[][] {
                new Object[] {
               H000F3_A1BrandId, H000F3_A30BrandCreatedDate, H000F3_A3BrandDescription, H000F3_n3BrandDescription, H000F3_A2BrandName, H000F3_A56BrandProductQuantity, H000F3_n56BrandProductQuantity
               }
               , new Object[] {
   ...
   public class wwbrand__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A2BrandName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[BrandId], T1.[BrandCreatedDate], T1.[BrandDescription], T1.[BrandName], COALESCE( T2.[BrandProductQuantity], 0) AS BrandProductQuantity";
