...
namespace GeneXus.Programs {
   public class sector : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtSectorName_Internalname, A10SectorName, StringUtil.RTrim( context.localUtil.Format( A10SectorName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSectorName_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_Sector.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtSectorDescription_Internalname, A11SectorDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", 0, 1, edtSectorDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "GeneXusUnanimo\\Description", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Sector.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSectorModifiedDate_Internalname, context.localUtil.Format(A35SectorModifiedDate, "99/99/99"), context.localUtil.Format( A35SectorModifiedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorModifiedDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSectorModifiedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_Sector.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               A9SectorId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "SECTORID"), ".", ","), 18, MidpointRounding.ToEven));
               n9SectorId = false;
               ...
               n35SectorModifiedDate = false;
               AssignAttri("", false, "A35SectorModifiedDate", context.localUtil.Format(A35SectorModifiedDate, "99/99/99"));
               forbiddenHiddens.Add("SectorModifiedDate", context.localUtil.Format(A35SectorModifiedDate, "99/99/99"));
      ...
      protected void E11032( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 ) && ! new haspermission(context).executeUdp(  "sector view") )
         {
         ...
         else if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! new haspermission(context).executeUdp(  "sector insert") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
         else if ( ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 ) && ! new haspermission(context).executeUdp(  "sector update") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
         else if ( ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 ) && ! new haspermission(context).executeUdp(  "sector delete") )
         {
            CallWebObject(formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV12Pgmname))}, new string[] {"GxObject"}) );
            context.wjLocDisableFrm = 1;
         }
      ...
      {
         /* Using cursor T00034 */
         pr_default.execute(2, new Object[] {n9SectorId, A9SectorId});
      ...
      {
         /* Using cursor T00033 */
         pr_default.execute(1, new Object[] {n9SectorId, A9SectorId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM033( 6) ;
            RcdFound3 = 1;
            A9SectorId = T00033_A9SectorId[0];
            n9SectorId = T00033_n9SectorId[0];
      ...
      protected void move_next( )
      {
         RcdFound3 = 0;
         /* Using cursor T00036 */
         pr_default.execute(4, new Object[] {n9SectorId, A9SectorId});
      ...
      protected void move_previous( )
      {
         RcdFound3 = 0;
         /* Using cursor T00037 */
         pr_default.execute(5, new Object[] {n9SectorId, A9SectorId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            if ( (pr_default.getStatus(5) != 101) && ( ( T00037_A9SectorId[0] < A9SectorId ) ) )
            {
               ...
               n9SectorId = T00037_n9SectorId[0];
               RcdFound3 = 1;
            }
         }
         pr_default.close(5);
      ...
      protected void CheckOptimisticConcurrency033( )
      {
         ...
         {
            /* Using cursor T00032 */
            pr_default.execute(0, new Object[] {n9SectorId, A9SectorId});
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     n9SectorId = T00038_n9SectorId[0];
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00039 */
                     pr_default.execute(7, new Object[] {A10SectorName, n11SectorDescription, A11SectorDescription, A34SectorCreatedDate, n35SectorModifiedDate, A35SectorModifiedDate, n9SectorId, A9SectorId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Sector");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {n9SectorId, A9SectorId});
                  pr_default.close(8);
                  pr_default.SmartCacheProvider.SetUpdated("Sector");
                  if ( AnyError == 0 )
                  {
      ...
      public void ScanStart033( )
      {
         ...
         if ( (pr_default.getStatus(10) != 101) )
         {
            ...
            n9SectorId = T000312_n9SectorId[0];
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411152124223", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("sector.js", "?202411152124224", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV9TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7SectorId',fld:'vSECTORID',pic:'ZZZZZ9',hsh:true},{av:'A34SectorCreatedDate',fld:'SECTORCREATEDDATE',pic:''},{av:'A35SectorModifiedDate',fld:'SECTORMODIFIEDDATE',pic:''},{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         T00034_n9SectorId = new bool[] {false} ;
         ...
         T00033_n9SectorId = new bool[] {false} ;
         ...
         T00037_n9SectorId = new bool[] {false} ;
         T00032_A9SectorId = new int[1] ;
         T00032_n9SectorId = new bool[] {false} ;
         ...
         T00038_n9SectorId = new bool[] {false} ;
         T000311_A15ProductId = new int[1] ;
         T000312_A9SectorId = new int[1] ;
         T000312_n9SectorId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
      ...
      private bool[] T00034_n9SectorId ;
      ...
      private bool[] T00033_n9SectorId ;
      ...
      private bool[] T00037_n9SectorId ;
      private int[] T00032_A9SectorId ;
      private bool[] T00032_n9SectorId ;
