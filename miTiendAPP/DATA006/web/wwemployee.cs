...
namespace GeneXus.Programs {
   public class wwemployee : GXDataArea
   {
      public wwemployee( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11EmployeeFirstName = GetPar( "EmployeeFirstName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11EmployeeFirstName, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEMPLOYEEFIRSTNAME", AV11EmployeeFirstName);
         /* Send saved values. */
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Employees", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWEmployee.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEmployee.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavEmployeefirstname_Internalname, "Employee First Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmployeefirstname_Internalname, AV11EmployeeFirstName, StringUtil.RTrim( context.localUtil.Format( AV11EmployeeFirstName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "First Name", edtavEmployeefirstname_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavEmployeefirstname_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWEmployee.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Employeefirstname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vEMPLOYEEFIRSTNAME"), AV11EmployeeFirstName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavEmployeefirstname_Internalname;
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11EmployeeFirstName ,
                                                 A13EmployeeFirstName } ,
                                                 new int[]{
                                                 }
            });
            lV11EmployeeFirstName = StringUtil.Concat( StringUtil.RTrim( AV11EmployeeFirstName), "%", "");
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {lV11EmployeeFirstName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A37EmployeeModifiedDate = H000J2_A37EmployeeModifiedDate[0];
               A36EmployeeCreatedDate = H000J2_A36EmployeeCreatedDate[0];
               A14EmployeeLastName = H000J2_A14EmployeeLastName[0];
               A13EmployeeFirstName = H000J2_A13EmployeeFirstName[0];
               A12EmployeeId = H000J2_A12EmployeeId[0];
               E140J2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_EMPLOYEEID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A12EmployeeId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11EmployeeFirstName = StringUtil.Concat( StringUtil.RTrim( AV11EmployeeFirstName), "%", "");
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {lV11EmployeeFirstName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11EmployeeFirstName = GridState.FilterValues("Employeefirstname");
            AssignAttri("", false, "AV11EmployeeFirstName", AV11EmployeeFirstName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("EmployeeFirstName", AV11EmployeeFirstName);
      }
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11EmployeeFirstName = cgiGet( edtavEmployeefirstname_Internalname);
            AssignAttri("", false, "AV11EmployeeFirstName", AV11EmployeeFirstName);
      ...
      private void E140J2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("employee.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A12EmployeeId,6,0))}, new string[] {"Mode","EmployeeId"}) ;
         edtavDelete_Link = formatLink("employee.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A12EmployeeId,6,0))}, new string[] {"Mode","EmployeeId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202432623583468", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwemployee.js", "?202432623583469", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtEmployeeCreatedDate_Internalname = "EMPLOYEECREATEDDATE_"+sGXsfl_27_idx;
         edtEmployeeModifiedDate_Internalname = "EMPLOYEEMODIFIEDDATE_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtEmployeeCreatedDate_Internalname = "EMPLOYEECREATEDDATE_"+sGXsfl_27_fel_idx;
         edtEmployeeModifiedDate_Internalname = "EMPLOYEEMODIFIEDDATE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeCreatedDate_Internalname,context.localUtil.Format(A36EmployeeCreatedDate, "99/99/99"),context.localUtil.Format( A36EmployeeCreatedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeCreatedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeModifiedDate_Internalname,context.localUtil.Format(A37EmployeeModifiedDate, "99/99/99"),context.localUtil.Format( A37EmployeeModifiedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeModifiedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A36EmployeeCreatedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A37EmployeeModifiedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavEmployeefirstname_Internalname = "vEMPLOYEEFIRSTNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavEmployeefirstname_Jsonclick = "";
         edtavEmployeefirstname_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11EmployeeFirstName',fld:'vEMPLOYEEFIRSTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140J2',iparms:[{av:'A12EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtEmployeeFirstName_Link',ctrl:'EMPLOYEEFIRSTNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110J2',iparms:[{av:'A12EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11EmployeeFirstName',fld:'vEMPLOYEEFIRSTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11EmployeeFirstName',fld:'vEMPLOYEEFIRSTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11EmployeeFirstName',fld:'vEMPLOYEEFIRSTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11EmployeeFirstName',fld:'vEMPLOYEEFIRSTNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11EmployeeFirstName = "";
         H000J2_A37EmployeeModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H000J2_A36EmployeeCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H000J2_A14EmployeeLastName = new string[] {""} ;
         H000J2_A13EmployeeFirstName = new string[] {""} ;
         H000J2_A12EmployeeId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwemployee__default(),
            new Object[][] {
                new Object[] {
               H000J2_A37EmployeeModifiedDate, H000J2_A36EmployeeCreatedDate, H000J2_A14EmployeeLastName, H000J2_A13EmployeeFirstName, H000J2_A12EmployeeId
               }
               , new Object[] {
      ...
      private int edtavEmployeefirstname_Enabled ;
      ...
      private string edtavEmployeefirstname_Internalname ;
      private string edtavEmployeefirstname_Jsonclick ;
      ...
      private string AV11EmployeeFirstName ;
      private string A13EmployeeFirstName ;
      private string A14EmployeeLastName ;
      private string lV11EmployeeFirstName ;
      ...
      private DateTime[] H000J2_A37EmployeeModifiedDate ;
      private DateTime[] H000J2_A36EmployeeCreatedDate ;
      private string[] H000J2_A14EmployeeLastName ;
      private string[] H000J2_A13EmployeeFirstName ;
      private int[] H000J2_A12EmployeeId ;
   ...
   public class wwemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A13EmployeeFirstName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EmployeeModifiedDate], [EmployeeCreatedDate], [EmployeeLastName], [EmployeeFirstName], [EmployeeId]";
         sFromString = " FROM [Employee]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11EmployeeFirstName)) )
         {
            AddWhere(sWhereString, "([EmployeeFirstName] like @lV11EmployeeFirstName)");
         }
         else
         {
            GXv_int1[0] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11EmployeeFirstName",GXType.NVarChar,60,0) ,
