...
namespace GeneXus.Programs {
   public class wwrole : GXDataArea
   {
      public wwrole( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11RoleName, AV12Update, AV13Delete, A104RoleId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwrole.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vROLENAME", AV11RoleName);
         /* Send saved values. */
      ...
      protected void WB370( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Roles", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWRole.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lbllbl15_Internalname, "", "", "", lbllbl15_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "navbar-brand", 0, "", 1, 1, 0, 0, "HLP_WWRole.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(30), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, bttBtninsert_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWRole.htm");
            context.WriteHtmlText( "</li>") ;
            context.WriteHtmlText( "<li>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'',0)\"";
            ClassString = "Button button-tertiary";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(30), 2, 0)+","+"null"+");", "Export", bttBtnexport_Jsonclick, 5, "Export to Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWRole.htm");
            context.WriteHtmlText( "</li>") ;
            ...
            GxWebStd.gx_label_element( context, edtavRolename_Internalname, "Role Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'" + sGXsfl_30_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavRolename_Internalname, AV11RoleName, StringUtil.RTrim( context.localUtil.Format( AV11RoleName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavRolename_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavRolename_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWRole.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Rolename Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vROLENAME"), AV11RoleName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF372( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11RoleName = StringUtil.Concat( StringUtil.RTrim( AV11RoleName), "%", "");
            /* Using cursor H00372 */
            pr_default.execute(0, new Object[] {lV11RoleName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_30_idx = 1;
            sGXsfl_30_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_30_idx), 4, 0), 4, "0");
            SubsflControlProps_302( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A104RoleId = H00372_A104RoleId[0];
               A105RoleName = H00372_A105RoleName[0];
               E14372 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11RoleName = StringUtil.Concat( StringUtil.RTrim( AV11RoleName), "%", "");
         /* Using cursor H00373 */
         pr_default.execute(1, new Object[] {lV11RoleName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11RoleName = GridState.FilterValues("Rolename");
            AssignAttri("", false, "AV11RoleName", AV11RoleName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("RoleName", AV11RoleName);
      }
      ...
      protected void STRUP370( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11RoleName = cgiGet( edtavRolename_Internalname);
            AssignAttri("", false, "AV11RoleName", AV11RoleName);
      ...
      protected void E12372( )
      {
         ...
         if ( ! new haspermission(context).executeUdp(  "role insert") )
         {
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Role";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411152133355", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwrole.js", "?202411152133355", false, true);
         }
      ...
      {
         edtRoleName_Internalname = "ROLENAME_"+sGXsfl_30_idx;
      ...
      {
         edtRoleName_Internalname = "ROLENAME_"+sGXsfl_30_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11RoleName',fld:'vROLENAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14372',iparms:[{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11372',iparms:[{av:'A104RoleId',fld:'ROLEID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11RoleName = "";
         H00372_A104RoleId = new int[1] ;
         H00372_A105RoleName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwrole__default(),
            new Object[][] {
                new Object[] {
               H00372_A104RoleId, H00372_A105RoleName
               }
               , new Object[] {
      ...
      private int[] H00372_A104RoleId ;
      private string[] H00372_A105RoleName ;
   ...
   public class wwrole__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A105RoleName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [RoleId], [RoleName]";
         sFromString = " FROM [Role]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11RoleName)) )
         {
            AddWhere(sWhereString, "([RoleName] like @lV11RoleName)");
         }
         else
         {
            GXv_int2[0] = 1;
         }
         sOrderString += " ORDER BY [RoleName]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00372(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H00373(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11RoleName",GXType.NVarChar,60,0) ,
