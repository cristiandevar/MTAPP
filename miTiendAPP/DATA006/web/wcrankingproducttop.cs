...
namespace GeneXus.Programs {
   public class wcrankingproducttop : GXWebComponent
   {
      public wcrankingproducttop( )
      {
      ...
      public wcrankingproducttop( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCRanking Product Top") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcrankingproducttop.aspx") +"\">") ;
      ...
      {
         return "WCRankingProductTop" ;
      }

      public override string GetPgmdesc( )
      {
         return "WCRanking Product Top" ;
      }
      ...
      protected void WB3V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcrankingproducttop.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavYear, cmbavYear_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV16Year), 4, 0)), 1, cmbavYear_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavYear.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "", false, 0, "HLP_WCRankingProductTop.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavMonth, cmbavMonth_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV15Month), 4, 0)), 1, cmbavMonth_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavMonth.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "", false, 0, "HLP_WCRankingProductTop.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavOption, cmbavOption_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV30Option), 4, 0)), 1, cmbavOption_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavOption.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "", false, 0, "HLP_WCRankingProductTop.htm");
      ...
      protected void START3V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCRanking Product Top", 0) ;
            }
            context.wjLoc = "";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcrankingproducttop", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024111423503158", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wcrankingproducttop.js", "?2024111423503158", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerRender.js", "", false, true);
