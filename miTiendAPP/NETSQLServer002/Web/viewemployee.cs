...
namespace GeneXus.Programs {
   public class viewemployee : GXDataArea
   {
      public viewemployee( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EmployeeId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZ9"), context));
      ...
      {
         GxWebStd.gx_hidden_field( context, "vEMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EmployeeId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZ9"), context));
         ...
         forbiddenHiddens.Add("EmployeeFirstName", StringUtil.RTrim( context.localUtil.Format( A13EmployeeFirstName, "")));
      ...
      {
         return formatLink("viewemployee.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmployeeId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmployeeId","TabCode"})  ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Employees", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEmployee.htm");
            ...
            GxWebStd.gx_label_element( context, edtEmployeeFirstName_Internalname, "First Name", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtEmployeeFirstName_Internalname, A13EmployeeFirstName, StringUtil.RTrim( context.localUtil.Format( A13EmployeeFirstName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEmployeeFirstName_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtEmployeeFirstName_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "Name", "left", true, "", "HLP_ViewEmployee.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblInvoice_title_Internalname, "Invoice", "", "", lblInvoice_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEmployee.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A12EmployeeId = H000I2_A12EmployeeId[0];
               A13EmployeeFirstName = H000I2_A13EmployeeFirstName[0];
      ...
      protected void STRUP0I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EmployeeId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vEMPLOYEEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E110I2( )
      {
         ...
         {
            A12EmployeeId = H000I3_A12EmployeeId[0];
            A13EmployeeFirstName = H000I3_A13EmployeeFirstName[0];
            AssignAttri("", false, "A13EmployeeFirstName", A13EmployeeFirstName);
            AV16GXLvl7 = 1;
            Form.Caption = A13EmployeeFirstName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12EmployeeId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Invoice") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Invoicewc_Component), StringUtil.Lower( "EmployeeInvoiceWC")) != 0 )
            {
               WebComp_Invoicewc = getWebComponent(GetType(), "GeneXus.Programs", "employeeinvoicewc", new Object[] {context} );
               WebComp_Invoicewc.ComponentInit();
               WebComp_Invoicewc.Name = "EmployeeInvoiceWC";
               WebComp_Invoicewc_Component = "EmployeeInvoiceWC";
            }
            if ( StringUtil.Len( WebComp_Invoicewc_Component) != 0 )
            {
               WebComp_Invoicewc.setjustcreated();
               WebComp_Invoicewc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12EmployeeId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EmployeeId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273977", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewemployee.js", "?202311222273977", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmployeeId',fld:'vEMPLOYEEID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A13EmployeeFirstName',fld:'EMPLOYEEFIRSTNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000I2_A12EmployeeId = new int[1] ;
         H000I2_A13EmployeeFirstName = new string[] {""} ;
         hsh = "";
         H000I3_A12EmployeeId = new int[1] ;
         H000I3_A13EmployeeFirstName = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewemployee__default(),
            new Object[][] {
                new Object[] {
               H000I2_A12EmployeeId, H000I2_A13EmployeeFirstName
               }
               , new Object[] {
               H000I3_A12EmployeeId, H000I3_A13EmployeeFirstName
               }
            }
         );
      ...
      private int AV12EmployeeId ;
      private int wcpOAV12EmployeeId ;
      ...
      private int[] H000I2_A12EmployeeId ;
      private string[] H000I2_A13EmployeeFirstName ;
      private int[] H000I3_A12EmployeeId ;
      private string[] H000I3_A13EmployeeFirstName ;
   ...
   public class viewemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12EmployeeId",GXType.Int32,6,0)
          };
          Object[] prmH000I3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [EmployeeId], [EmployeeFirstName] FROM [Employee] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [EmployeeId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000I3", "SELECT [EmployeeId], [EmployeeFirstName] FROM [Employee] WHERE [EmployeeId] = @AV12EmployeeId ORDER BY [EmployeeId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
