   ...
   public class supplierproductwc : GXWebComponent
   {
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierProductWC.htm");
      ...
      protected void RF1C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               n29ProductModifiedDate = H001C2_n29ProductModifiedDate[0];
               ...
               A18ProductPrice = H001C2_A18ProductPrice[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273225", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("supplierproductwc.js", "?202311222273225", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E131C2',iparms:[{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'A1BrandId',fld:'BRANDID',pic:'ZZZZZ9'},{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtBrandName_Link',ctrl:'BRANDNAME',prop:'Link'},{av:'edtSectorName_Link',ctrl:'SECTORNAME',prop:'Link'},{av:'edtProductCode_Link',ctrl:'PRODUCTCODE',prop:'Link'}]}");
      ...
      public override void initialize( )
      {
         ...
         H001C2_n29ProductModifiedDate = new bool[] {false} ;
         ...
         H001C2_A18ProductPrice = new decimal[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplierproductwc__default(),
            new Object[][] {
                new Object[] {
               H001C2_A4SupplierId, H001C2_A55ProductCode, H001C2_n55ProductCode, H001C2_A29ProductModifiedDate, H001C2_n29ProductModifiedDate, H001C2_A28ProductCreatedDate, H001C2_A10SectorName, H001C2_A9SectorId, H001C2_A2BrandName, H001C2_A1BrandId,
               H001C2_A19ProductDescription, H001C2_n19ProductDescription, H001C2_A18ProductPrice, H001C2_A17ProductStock, H001C2_A16ProductName, H001C2_A15ProductId
               }
               , new Object[] {
      ...
      private bool[] H001C2_n29ProductModifiedDate ;
      ...
      private decimal[] H001C2_A18ProductPrice ;
   ...
   public class supplierproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001C2", "SELECT T1.[SupplierId], T1.[ProductCode], T1.[ProductModifiedDate], T1.[ProductCreatedDate], T2.[SectorName], T1.[SectorId], T3.[BrandName], T1.[BrandId], T1.[ProductDescription], T1.[ProductPrice], T1.[ProductStock], T1.[ProductName], T1.[ProductId] FROM (([Product] T1 INNER JOIN [Sector] T2 ON T2.[SectorId] = T1.[SectorId]) INNER JOIN [Brand] T3 ON T3.[BrandId] = T1.[BrandId]) WHERE T1.[SupplierId] = @AV6SupplierId ORDER BY T1.[SupplierId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001C3", "SELECT COUNT(*) FROM (([Product] T1 INNER JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) INNER JOIN [Brand] T2 ON T2.[BrandId] = T1.[BrandId]) WHERE T1.[SupplierId] = @AV6SupplierId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001C3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
