...
namespace GeneXus.Programs {
   public class gx00d1 : GXDataArea
   {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV8cInvoiceDetailHistoricPrice = NumberUtil.Val( GetPar( "cInvoiceDetailHistoricPrice"), ".");
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cInvoiceDetailId, AV7cInvoiceDetailQuantity, AV8cInvoiceDetailHistoricPrice, AV9cProductId, AV10pInvoiceId) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCINVOICEDETAILHISTORICPRICE", StringUtil.LTrim( StringUtil.NToC( AV8cInvoiceDetailHistoricPrice, 10, 2, ".", "")));
      ...
      protected void WB1K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblinvoicedetailhistoricpricefilter_Internalname, "Invoice Detail Historic Price", "", "", lblLblinvoicedetailhistoricpricefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e131k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCinvoicedetailhistoricprice_Internalname, StringUtil.LTrim( StringUtil.NToC( AV8cInvoiceDetailHistoricPrice, 10, 2, ".", "")), StringUtil.LTrim( ((edtavCinvoicedetailhistoricprice_Enabled!=0) ? context.localUtil.Format( AV8cInvoiceDetailHistoricPrice, "ZZZZZZ9.99") : context.localUtil.Format( AV8cInvoiceDetailHistoricPrice, "ZZZZZZ9.99"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCinvoicedetailhistoricprice_Jsonclick, 0, "Attribute", "", "", "", "", edtavCinvoicedetailhistoricprice_Visible, edtavCinvoicedetailhistoricprice_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductidfilter_Internalname, "Product Id", "", "", lblLblproductidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e141k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e151k1_client"+"'", TempTags, "", 2, "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 54 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00D1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToN( cgiGet( "GXH_vCINVOICEDETAILHISTORICPRICE"), ".", ",") != AV8cInvoiceDetailHistoricPrice )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        decimal AV8cInvoiceDetailHistoricPrice ,
                                        int AV9cProductId ,
                                        int AV10pInvoiceId )
      {
         initialize_formulas( ) ;
      ...
      protected void RF1K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8cInvoiceDetailHistoricPrice ,
                                                 AV9cProductId ,
                                                 ...
                                                 A20InvoiceId } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.INT, TypeConstants.INT, TypeConstants.DECIMAL, TypeConstants.INT, TypeConstants.INT, TypeConstants.INT, TypeConstants.INT
                                                 }
            });
            /* Using cursor H001K2 */
            pr_default.execute(0, new Object[] {AV10pInvoiceId, AV6cInvoiceDetailId, AV7cInvoiceDetailQuantity, AV8cInvoiceDetailHistoricPrice, AV9cProductId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_54_idx = 1;
            sGXsfl_54_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_54_idx), 4, 0), 4, "0");
            SubsflControlProps_542( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_INVOICEDETAILID"+"_"+sGXsfl_54_idx, GetSecureSignedToken( sGXsfl_54_idx, context.localUtil.Format( (decimal)(A25InvoiceDetailId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         /* Using cursor H001K3 */
         pr_default.execute(1, new Object[] {AV10pInvoiceId, AV6cInvoiceDetailId, AV7cInvoiceDetailQuantity, AV8cInvoiceDetailHistoricPrice, AV9cProductId});
      ...
      protected void STRUP1K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCinvoicedetailhistoricprice_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCinvoicedetailhistoricprice_Internalname), ".", ",") > 9999999.99m ) ) )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV8cInvoiceDetailHistoricPrice = 0;
               AssignAttri("", false, "AV8cInvoiceDetailHistoricPrice", StringUtil.LTrimStr( AV8cInvoiceDetailHistoricPrice, 10, 2));
            }
            else
            {
               AV8cInvoiceDetailHistoricPrice = context.localUtil.CToN( cgiGet( edtavCinvoicedetailhistoricprice_Internalname), ".", ",");
               AssignAttri("", false, "AV8cInvoiceDetailHistoricPrice", StringUtil.LTrimStr( AV8cInvoiceDetailHistoricPrice, 10, 2));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274923", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00d1.js", "?202311222274923", false, true);
      ...
      protected void SubsflControlProps_542( )
      {
         ...
         edtInvoiceDetailId_Internalname = "INVOICEDETAILID_"+sGXsfl_54_idx;
         edtInvoiceDetailQuantity_Internalname = "INVOICEDETAILQUANTITY_"+sGXsfl_54_idx;
         edtInvoiceDetailHistoricPrice_Internalname = "INVOICEDETAILHISTORICPRICE_"+sGXsfl_54_idx;
      ...
      protected void SubsflControlProps_fel_542( )
      {
         ...
         edtInvoiceDetailId_Internalname = "INVOICEDETAILID_"+sGXsfl_54_fel_idx;
         edtInvoiceDetailQuantity_Internalname = "INVOICEDETAILQUANTITY_"+sGXsfl_54_fel_idx;
         edtInvoiceDetailHistoricPrice_Internalname = "INVOICEDETAILHISTORICPRICE_"+sGXsfl_54_fel_idx;
      ...
      protected void sendrow_542( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_54_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, edtInvoiceDetailQuantity_Internalname, "Link", edtInvoiceDetailQuantity_Link, !bGXsfl_54_Refreshing);
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtInvoiceDetailHistoricPrice_Internalname,StringUtil.LTrim( StringUtil.NToC( A65InvoiceDetailHistoricPrice, 10, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A65InvoiceDetailHistoricPrice, "ZZZZZZ9.99")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtInvoiceDetailHistoricPrice_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)54,(short)0,(short)-1,(short)0,(bool)true,(string)"Price",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl54( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A65InvoiceDetailHistoricPrice, 10, 2, ".", ""))));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLINVOICEDETAILHISTORICPRICEFILTER.CLICK","{handler:'E131K1',iparms:[{av:'divInvoicedetailhistoricpricefiltercontainer_Class',ctrl:'INVOICEDETAILHISTORICPRICEFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRODUCTIDFILTER.CLICK","{handler:'E141K1',iparms:[{av:'divProductidfiltercontainer_Class',ctrl:'PRODUCTIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E181K2',iparms:[{av:'A25InvoiceDetailId',fld:'INVOICEDETAILID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00d1__default(),
            new Object[][] {
                new Object[] {
               H001K2_A20InvoiceId, H001K2_A15ProductId, H001K2_A65InvoiceDetailHistoricPrice, H001K2_A26InvoiceDetailQuantity, H001K2_A25InvoiceDetailId
               }
               , new Object[] {
      ...
      private decimal AV8cInvoiceDetailHistoricPrice ;
   ...
   public class gx00d1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A20InvoiceId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [InvoiceId], [ProductId], [InvoiceDetailHistoricPrice], [InvoiceDetailQuantity], [InvoiceDetailId]";
         ...
         if ( ! (Convert.ToDecimal(0)==AV8cInvoiceDetailHistoricPrice) )
         {
            AddWhere(sWhereString, "([InvoiceDetailHistoricPrice] >= @AV8cInvoiceDetailHistoricPrice)");
         }
         else
         {
            GXv_int1[3] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001K2(context, (int)dynConstraints[0] , (decimal)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] , (decimal)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (int)dynConstraints[8] );
               case 1 :
                     return conditional_H001K3(context, (int)dynConstraints[0] , (decimal)dynConstraints[1] , (int)dynConstraints[2] , (int)dynConstraints[3] , (decimal)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (int)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8cInvoiceDetailHistoricPrice",GXType.Decimal,10,2) ,
