...
namespace GeneXus.Programs {
   public class wwpurchaseorder : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV15PurchaseOrderCreatedDate = context.localUtil.ParseDateParm( GetPar( "PurchaseOrderCreatedDate"));
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV15PurchaseOrderCreatedDate, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPURCHASEORDERCREATEDDATE", context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"));
         /* Send saved values. */
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPurchaseOrder.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavPurchaseordercreateddate_Internalname, "Purchase Order Created Date", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPurchaseordercreateddate_Internalname, context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"), context.localUtil.Format( AV15PurchaseOrderCreatedDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPurchaseordercreateddate_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPurchaseordercreateddate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_WWPurchaseOrder.htm");
            GxWebStd.gx_bitmap( context, edtavPurchaseordercreateddate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavPurchaseordercreateddate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWPurchaseOrder.htm");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Purchaseordercreateddate Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vPURCHASEORDERCREATEDDATE"), 0) != AV15PurchaseOrderCreatedDate )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       DateTime AV15PurchaseOrderCreatedDate ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      protected void RF122( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00123 */
            pr_default.execute(0, new Object[] {AV15PurchaseOrderCreatedDate, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A66PurchaseOrderClosedDate = H00123_A66PurchaseOrderClosedDate[0];
               n66PurchaseOrderClosedDate = H00123_n66PurchaseOrderClosedDate[0];
               A52PurchaseOrderCreatedDate = H00123_A52PurchaseOrderCreatedDate[0];
               A5SupplierName = H00123_A5SupplierName[0];
               A4SupplierId = H00123_A4SupplierId[0];
               A50PurchaseOrderId = H00123_A50PurchaseOrderId[0];
               A67PurchaseOrderDetailsQuantity = H00123_A67PurchaseOrderDetailsQuantity[0];
               n67PurchaseOrderDetailsQuantity = H00123_n67PurchaseOrderDetailsQuantity[0];
               A5SupplierName = H00123_A5SupplierName[0];
               A67PurchaseOrderDetailsQuantity = H00123_A67PurchaseOrderDetailsQuantity[0];
               n67PurchaseOrderDetailsQuantity = H00123_n67PurchaseOrderDetailsQuantity[0];
               E14122 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PURCHASEORDERID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A50PurchaseOrderId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00125 */
         pr_default.execute(1, new Object[] {AV15PurchaseOrderCreatedDate});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV15PurchaseOrderCreatedDate = context.localUtil.CToD( GridState.FilterValues("Purchaseordercreateddate"), 1);
            AssignAttri("", false, "AV15PurchaseOrderCreatedDate", context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"));
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("PurchaseOrderCreatedDate", context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"));
      }
      ...
      protected void STRUP120( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavPurchaseordercreateddate_Internalname), 1) == 0 )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV15PurchaseOrderCreatedDate = DateTime.MinValue;
               AssignAttri("", false, "AV15PurchaseOrderCreatedDate", context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"));
            }
            else
            {
               AV15PurchaseOrderCreatedDate = context.localUtil.CToD( cgiGet( edtavPurchaseordercreateddate_Internalname), 1);
               AssignAttri("", false, "AV15PurchaseOrderCreatedDate", context.localUtil.Format(AV15PurchaseOrderCreatedDate, "99/99/99"));
            }
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vPURCHASEORDERCREATEDDATE"), 1) ) != DateTimeUtil.ResetTime ( AV15PurchaseOrderCreatedDate ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274396", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpurchaseorder.js", "?202311222274397", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtPurchaseOrderCreatedDate_Internalname = "PURCHASEORDERCREATEDDATE_"+sGXsfl_27_idx;
         edtPurchaseOrderClosedDate_Internalname = "PURCHASEORDERCLOSEDDATE_"+sGXsfl_27_idx;
         edtPurchaseOrderDetailsQuantity_Internalname = "PURCHASEORDERDETAILSQUANTITY_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtPurchaseOrderCreatedDate_Internalname = "PURCHASEORDERCREATEDDATE_"+sGXsfl_27_fel_idx;
         edtPurchaseOrderClosedDate_Internalname = "PURCHASEORDERCLOSEDDATE_"+sGXsfl_27_fel_idx;
         edtPurchaseOrderDetailsQuantity_Internalname = "PURCHASEORDERDETAILSQUANTITY_"+sGXsfl_27_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15PurchaseOrderCreatedDate',fld:'vPURCHASEORDERCREATEDDATE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14122',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11122',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15PurchaseOrderCreatedDate',fld:'vPURCHASEORDERCREATEDDATE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15PurchaseOrderCreatedDate',fld:'vPURCHASEORDERCREATEDDATE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15PurchaseOrderCreatedDate',fld:'vPURCHASEORDERCREATEDDATE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV15PurchaseOrderCreatedDate',fld:'vPURCHASEORDERCREATEDDATE',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00123_A66PurchaseOrderClosedDate = new DateTime[] {DateTime.MinValue} ;
         H00123_n66PurchaseOrderClosedDate = new bool[] {false} ;
         H00123_A52PurchaseOrderCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H00123_A5SupplierName = new string[] {""} ;
         H00123_A4SupplierId = new int[1] ;
         H00123_A50PurchaseOrderId = new int[1] ;
         H00123_A67PurchaseOrderDetailsQuantity = new short[1] ;
         H00123_n67PurchaseOrderDetailsQuantity = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpurchaseorder__default(),
            new Object[][] {
                new Object[] {
               H00123_A66PurchaseOrderClosedDate, H00123_n66PurchaseOrderClosedDate, H00123_A52PurchaseOrderCreatedDate, H00123_A5SupplierName, H00123_A4SupplierId, H00123_A50PurchaseOrderId, H00123_A67PurchaseOrderDetailsQuantity, H00123_n67PurchaseOrderDetailsQuantity
               }
               , new Object[] {
      ...
      private DateTime AV15PurchaseOrderCreatedDate ;
      ...
      private DateTime[] H00123_A66PurchaseOrderClosedDate ;
      private bool[] H00123_n66PurchaseOrderClosedDate ;
      private DateTime[] H00123_A52PurchaseOrderCreatedDate ;
      private string[] H00123_A5SupplierName ;
      private int[] H00123_A4SupplierId ;
      private int[] H00123_A50PurchaseOrderId ;
      private short[] H00123_A67PurchaseOrderDetailsQuantity ;
      private bool[] H00123_n67PurchaseOrderDetailsQuantity ;
   ...
   public class wwpurchaseorder__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime A52PurchaseOrderCreatedDate )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[PurchaseOrderClosedDate], T1.[PurchaseOrderCreatedDate], T2.[SupplierName], T1.[SupplierId], T1.[PurchaseOrderId], COALESCE( T3.[PurchaseOrderDetailsQuantity], 0) AS PurchaseOrderDetailsQuantity";
         ...
         sOrderString = "";
         if ( ! (DateTime.MinValue==AV15PurchaseOrderCreatedDate) )
         {
            AddWhere(sWhereString, "(T1.[PurchaseOrderCreatedDate] >= @AV15PurchaseOrderCreatedDate)");
         }
         else
         {
            GXv_int1[0] = 1;
      ...
      protected Object[] conditional_H00125( IGxContext context ,
                                             DateTime AV15PurchaseOrderCreatedDate ,
                                             DateTime A52PurchaseOrderCreatedDate )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00123(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
               case 1 :
                     return conditional_H00125(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV15PurchaseOrderCreatedDate",GXType.Date,8,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00123", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00123,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00125", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00125,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
