   ...
   public class supplierpurchaseorderwc : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "SupplierPurchaseOrderWC";
               context.Gx_err = 0;
      ...
      protected void WB1D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_SupplierPurchaseOrderWC.htm");
      ...
      protected void RF1D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4SupplierId = H001D3_A4SupplierId[0];
               AssignAttri(sPrefix, false, "A4SupplierId", StringUtil.LTrimStr( (decimal)(A4SupplierId), 6, 0));
               A66PurchaseOrderClosedDate = H001D3_A66PurchaseOrderClosedDate[0];
               n66PurchaseOrderClosedDate = H001D3_n66PurchaseOrderClosedDate[0];
               A53PurchaseOrderModifiedDate = H001D3_A53PurchaseOrderModifiedDate[0];
               n53PurchaseOrderModifiedDate = H001D3_n53PurchaseOrderModifiedDate[0];
               A52PurchaseOrderCreatedDate = H001D3_A52PurchaseOrderCreatedDate[0];
               A50PurchaseOrderId = H001D3_A50PurchaseOrderId[0];
               A67PurchaseOrderDetailsQuantity = H001D3_A67PurchaseOrderDetailsQuantity[0];
               n67PurchaseOrderDetailsQuantity = H001D3_n67PurchaseOrderDetailsQuantity[0];
               A67PurchaseOrderDetailsQuantity = H001D3_A67PurchaseOrderDetailsQuantity[0];
               n67PurchaseOrderDetailsQuantity = H001D3_n67PurchaseOrderDetailsQuantity[0];
               E131D2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("supplierpurchaseorderwc.js", "?202311222273797", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131D2',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtPurchaseOrderCreatedDate_Link',ctrl:'PURCHASEORDERCREATEDDATE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111D2',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6SupplierId',fld:'vSUPPLIERID',pic:'ZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001D3_A4SupplierId = new int[1] ;
         H001D3_A66PurchaseOrderClosedDate = new DateTime[] {DateTime.MinValue} ;
         H001D3_n66PurchaseOrderClosedDate = new bool[] {false} ;
         H001D3_A53PurchaseOrderModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H001D3_n53PurchaseOrderModifiedDate = new bool[] {false} ;
         H001D3_A52PurchaseOrderCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H001D3_A50PurchaseOrderId = new int[1] ;
         H001D3_A67PurchaseOrderDetailsQuantity = new short[1] ;
         H001D3_n67PurchaseOrderDetailsQuantity = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplierpurchaseorderwc__default(),
            new Object[][] {
                new Object[] {
               H001D3_A4SupplierId, H001D3_A66PurchaseOrderClosedDate, H001D3_n66PurchaseOrderClosedDate, H001D3_A53PurchaseOrderModifiedDate, H001D3_n53PurchaseOrderModifiedDate, H001D3_A52PurchaseOrderCreatedDate, H001D3_A50PurchaseOrderId, H001D3_A67PurchaseOrderDetailsQuantity, H001D3_n67PurchaseOrderDetailsQuantity
               }
               , new Object[] {
      ...
      private int[] H001D3_A4SupplierId ;
      private DateTime[] H001D3_A66PurchaseOrderClosedDate ;
      private bool[] H001D3_n66PurchaseOrderClosedDate ;
      private DateTime[] H001D3_A53PurchaseOrderModifiedDate ;
      private bool[] H001D3_n53PurchaseOrderModifiedDate ;
      private DateTime[] H001D3_A52PurchaseOrderCreatedDate ;
      private int[] H001D3_A50PurchaseOrderId ;
      private short[] H001D3_A67PurchaseOrderDetailsQuantity ;
      private bool[] H001D3_n67PurchaseOrderDetailsQuantity ;
   ...
   public class supplierpurchaseorderwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001D3", "SELECT T1.[SupplierId], T1.[PurchaseOrderClosedDate], T1.[PurchaseOrderModifiedDate], T1.[PurchaseOrderCreatedDate], T1.[PurchaseOrderId], COALESCE( T2.[PurchaseOrderDetailsQuantity], 0) AS PurchaseOrderDetailsQuantity FROM ([PurchaseOrder] T1 LEFT JOIN (SELECT COUNT(*) AS PurchaseOrderDetailsQuantity, [PurchaseOrderId] FROM [PurchaseOrderDetail] GROUP BY [PurchaseOrderId] ) T2 ON T2.[PurchaseOrderId] = T1.[PurchaseOrderId]) WHERE T1.[SupplierId] = @AV6SupplierId ORDER BY T1.[SupplierId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001D5", "SELECT COUNT(*) FROM ([PurchaseOrder] T1 LEFT JOIN (SELECT COUNT(*) AS PurchaseOrderDetailsQuantity, [PurchaseOrderId] FROM [PurchaseOrderDetail] GROUP BY [PurchaseOrderId] ) T2 ON T2.[PurchaseOrderId] = T1.[PurchaseOrderId]) WHERE T1.[SupplierId] = @AV6SupplierId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
