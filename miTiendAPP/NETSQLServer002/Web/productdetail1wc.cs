...
namespace GeneXus.Programs {
   public class productdetail1wc : GXWebComponent
   {
      public productdetail1wc( )
      {
      ...
      public productdetail1wc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Product Detail1 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("productdetail1wc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ProductId,6,0))}, new string[] {"ProductId"}) +"\">") ;
      ...
      {
         return "ProductDetail1WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Product Detail1 WC" ;
      }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productdetail1wc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductDetail1WC.htm");
      ...
      protected void START1I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Product Detail1 WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15ProductId = H001I3_A15ProductId[0];
               AssignAttri(sPrefix, false, "A15ProductId", StringUtil.LTrimStr( (decimal)(A15ProductId), 6, 0));
               A39InvoiceModifiedDate = H001I3_A39InvoiceModifiedDate[0];
               n39InvoiceModifiedDate = H001I3_n39InvoiceModifiedDate[0];
               A38InvoiceCreatedDate = H001I3_A38InvoiceCreatedDate[0];
               A13EmployeeFirstName = H001I3_A13EmployeeFirstName[0];
               A14EmployeeLastName = H001I3_A14EmployeeLastName[0];
               A12EmployeeId = H001I3_A12EmployeeId[0];
               A21InvoiceDate = H001I3_A21InvoiceDate[0];
               A20InvoiceId = H001I3_A20InvoiceId[0];
               A68InvoiceProductQuantity = H001I3_A68InvoiceProductQuantity[0];
               n68InvoiceProductQuantity = H001I3_n68InvoiceProductQuantity[0];
               A39InvoiceModifiedDate = H001I3_A39InvoiceModifiedDate[0];
               n39InvoiceModifiedDate = H001I3_n39InvoiceModifiedDate[0];
               A38InvoiceCreatedDate = H001I3_A38InvoiceCreatedDate[0];
               A12EmployeeId = H001I3_A12EmployeeId[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001I5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      private void E131I2( )
      {
         ...
         edtInvoiceDate_Link = formatLink("viewinvoice.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A20InvoiceId,6,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"InvoiceId","TabCode"}) ;
         edtEmployeeFirstName_Link = formatLink("viewemployee.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A12EmployeeId,6,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"EmployeeId","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 22;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productdetail1wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273513", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productdetail1wc.js", "?202311222273513", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtInvoiceDate_Internalname = sPrefix+"INVOICEDATE_"+sGXsfl_22_idx;
         edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_22_idx;
         edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_22_idx;
         edtEmployeeFirstName_Internalname = sPrefix+"EMPLOYEEFIRSTNAME_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtInvoiceDate_Internalname = sPrefix+"INVOICEDATE_"+sGXsfl_22_fel_idx;
         edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_22_fel_idx;
         edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_22_fel_idx;
         edtEmployeeFirstName_Internalname = sPrefix+"EMPLOYEEFIRSTNAME_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12EmployeeId), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A12EmployeeId), "ZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeFirstName_Internalname,(string)A13EmployeeFirstName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtEmployeeFirstName_Link,(string)"",(string)"",(string)"",(string)edtEmployeeFirstName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)60,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl22( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Employee Last Name") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A21InvoiceDate, "99/99/99")));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtInvoiceDate_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A12EmployeeId), 6, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A14EmployeeLastName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A13EmployeeFirstName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtEmployeeFirstName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E131I2',iparms:[{av:'A20InvoiceId',fld:'INVOICEID',pic:'ZZZZZ9',hsh:true},{av:'A12EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtInvoiceDate_Link',ctrl:'INVOICEDATE',prop:'Link'},{av:'edtEmployeeFirstName_Link',ctrl:'EMPLOYEEFIRSTNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111I2',iparms:[{av:'A20InvoiceId',fld:'INVOICEID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001I3_A25InvoiceDetailId = new int[1] ;
         H001I3_A15ProductId = new int[1] ;
         H001I3_A39InvoiceModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H001I3_n39InvoiceModifiedDate = new bool[] {false} ;
         H001I3_A38InvoiceCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H001I3_A13EmployeeFirstName = new string[] {""} ;
         H001I3_A14EmployeeLastName = new string[] {""} ;
         H001I3_A12EmployeeId = new int[1] ;
         H001I3_A21InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         H001I3_A20InvoiceId = new int[1] ;
         H001I3_A68InvoiceProductQuantity = new short[1] ;
         H001I3_n68InvoiceProductQuantity = new bool[] {false} ;
         H001I5_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productdetail1wc__default(),
            new Object[][] {
                new Object[] {
               H001I3_A25InvoiceDetailId, H001I3_A15ProductId, H001I3_A39InvoiceModifiedDate, H001I3_n39InvoiceModifiedDate, H001I3_A38InvoiceCreatedDate, H001I3_A13EmployeeFirstName, H001I3_A14EmployeeLastName, H001I3_A12EmployeeId, H001I3_A21InvoiceDate, H001I3_A20InvoiceId,
               H001I3_A68InvoiceProductQuantity, H001I3_n68InvoiceProductQuantity
               }
               , new Object[] {
               H001I5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ProductDetail1WC";
      ...
      private int[] H001I3_A25InvoiceDetailId ;
      private int[] H001I3_A15ProductId ;
      private DateTime[] H001I3_A39InvoiceModifiedDate ;
      private bool[] H001I3_n39InvoiceModifiedDate ;
      private DateTime[] H001I3_A38InvoiceCreatedDate ;
      private string[] H001I3_A13EmployeeFirstName ;
      private string[] H001I3_A14EmployeeLastName ;
      private int[] H001I3_A12EmployeeId ;
      private DateTime[] H001I3_A21InvoiceDate ;
      private int[] H001I3_A20InvoiceId ;
      private short[] H001I3_A68InvoiceProductQuantity ;
      private bool[] H001I3_n68InvoiceProductQuantity ;
      private long[] H001I5_AGRID_nRecordCount ;
   ...
   public class productdetail1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH001I5;
          prmH001I5 = new Object[] {
          new ParDef("@AV6ProductId",GXType.Int32,6,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001I3", "SELECT T1.[InvoiceDetailId], T1.[ProductId], T2.[InvoiceModifiedDate], T2.[InvoiceCreatedDate], T3.[EmployeeFirstName], T3.[EmployeeLastName], T2.[EmployeeId], T2.[InvoiceDate], T1.[InvoiceId], COALESCE( T4.[InvoiceProductQuantity], 0) AS InvoiceProductQuantity FROM ((([InvoiceDetail] T1 INNER JOIN [Invoice] T2 ON T2.[InvoiceId] = T1.[InvoiceId]) INNER JOIN [Employee] T3 ON T3.[EmployeeId] = T2.[EmployeeId]) LEFT JOIN (SELECT COUNT(*) AS InvoiceProductQuantity, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T4 ON T4.[InvoiceId] = T1.[InvoiceId]) WHERE T1.[ProductId] = @AV6ProductId ORDER BY T1.[ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001I5", "SELECT COUNT(*) FROM ((([InvoiceDetail] T1 INNER JOIN [Invoice] T2 ON T2.[InvoiceId] = T1.[InvoiceId]) INNER JOIN [Employee] T3 ON T3.[EmployeeId] = T2.[EmployeeId]) LEFT JOIN (SELECT COUNT(*) AS InvoiceProductQuantity, [InvoiceId] FROM [InvoiceDetail] GROUP BY [InvoiceId] ) T4 ON T4.[InvoiceId] = T1.[InvoiceId]) WHERE T1.[ProductId] = @AV6ProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
