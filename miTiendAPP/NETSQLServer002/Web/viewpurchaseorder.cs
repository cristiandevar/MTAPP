...
namespace GeneXus.Programs {
   public class viewpurchaseorder : GXDataArea
   {
      ...
      public viewpurchaseorder( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewpurchaseorder.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12PurchaseOrderId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"PurchaseOrderId","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewPurchaseOrder");
         ...
         GXUtil.WriteLogInfo("viewpurchaseorder:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewpurchaseorder.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12PurchaseOrderId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"PurchaseOrderId","TabCode"})  ;
      }
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Purchase Orders", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewPurchaseOrder.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtPurchaseOrderCreatedDate_Internalname, context.localUtil.Format(A52PurchaseOrderCreatedDate, "99/99/99"), context.localUtil.Format( A52PurchaseOrderCreatedDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPurchaseOrderCreatedDate_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPurchaseOrderCreatedDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_ViewPurchaseOrder.htm");
            GxWebStd.gx_bitmap( context, edtPurchaseOrderCreatedDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtPurchaseOrderCreatedDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewPurchaseOrder.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPurchaseOrder.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDetail_title_Internalname, "Detail", "", "", lblDetail_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPurchaseOrder.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START112( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Purchase Order", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF112( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A50PurchaseOrderId = H00112_A50PurchaseOrderId[0];
               A52PurchaseOrderCreatedDate = H00112_A52PurchaseOrderCreatedDate[0];
      ...
      protected void STRUP110( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12PurchaseOrderId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vPURCHASEORDERID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewpurchaseorder:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11112( )
      {
         ...
         {
            A50PurchaseOrderId = H00113_A50PurchaseOrderId[0];
            A52PurchaseOrderCreatedDate = H00113_A52PurchaseOrderCreatedDate[0];
            AssignAttri("", false, "A52PurchaseOrderCreatedDate", context.localUtil.Format(A52PurchaseOrderCreatedDate, "99/99/99"));
            AV16GXLvl7 = 1;
            Form.Caption = context.localUtil.DToC( A52PurchaseOrderCreatedDate, 1, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwpurchaseorder.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "PurchaseOrderGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "purchaseordergeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "PurchaseOrderGeneral";
               WebComp_Generalwc_Component = "PurchaseOrderGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12PurchaseOrderId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detail") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Detailwc_Component), StringUtil.Lower( "PurchaseOrderDetailWC")) != 0 )
            {
               WebComp_Detailwc = getWebComponent(GetType(), "GeneXus.Programs", "purchaseorderdetailwc", new Object[] {context} );
               WebComp_Detailwc.ComponentInit();
               WebComp_Detailwc.Name = "PurchaseOrderDetailWC";
               WebComp_Detailwc_Component = "PurchaseOrderDetailWC";
            }
            if ( StringUtil.Len( WebComp_Detailwc_Component) != 0 )
            {
               WebComp_Detailwc.setjustcreated();
               WebComp_Detailwc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12PurchaseOrderId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274229", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpurchaseorder.js", "?202311222274229", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Purchase Order";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12PurchaseOrderId',fld:'vPURCHASEORDERID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A52PurchaseOrderCreatedDate',fld:'PURCHASEORDERCREATEDDATE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00112_A50PurchaseOrderId = new int[1] ;
         H00112_A52PurchaseOrderCreatedDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H00113_A50PurchaseOrderId = new int[1] ;
         H00113_A52PurchaseOrderCreatedDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpurchaseorder__default(),
            new Object[][] {
                new Object[] {
               H00112_A50PurchaseOrderId, H00112_A52PurchaseOrderCreatedDate
               }
               , new Object[] {
               H00113_A50PurchaseOrderId, H00113_A52PurchaseOrderCreatedDate
               }
            }
         );
      ...
      private int[] H00112_A50PurchaseOrderId ;
      private DateTime[] H00112_A52PurchaseOrderCreatedDate ;
      private int[] H00113_A50PurchaseOrderId ;
      private DateTime[] H00113_A52PurchaseOrderCreatedDate ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewpurchaseorder__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00112", "SELECT [PurchaseOrderId], [PurchaseOrderCreatedDate] FROM [PurchaseOrder] WHERE [PurchaseOrderId] = @AV12PurchaseOrderId ORDER BY [PurchaseOrderId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00112,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00113", "SELECT [PurchaseOrderId], [PurchaseOrderCreatedDate] FROM [PurchaseOrder] WHERE [PurchaseOrderId] = @AV12PurchaseOrderId ORDER BY [PurchaseOrderId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00113,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
