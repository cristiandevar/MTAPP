...
namespace GeneXus.Programs {
   public class wwsupplier : GXDataArea
   {
      ...
      protected void WB1A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSupplier.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
      ...
      protected void RF1A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A33SupplierModifiedDate = H001A3_A33SupplierModifiedDate[0];
               A32SupplierCreatedDate = H001A3_A32SupplierCreatedDate[0];
               A8SupplierEmail = H001A3_A8SupplierEmail[0];
               n8SupplierEmail = H001A3_n8SupplierEmail[0];
               A7SupplierPhone = H001A3_A7SupplierPhone[0];
               n7SupplierPhone = H001A3_n7SupplierPhone[0];
               A6SupplierDescription = H001A3_A6SupplierDescription[0];
               n6SupplierDescription = H001A3_n6SupplierDescription[0];
               A5SupplierName = H001A3_A5SupplierName[0];
               A4SupplierId = H001A3_A4SupplierId[0];
               A57SupplierProductQuantity = H001A3_A57SupplierProductQuantity[0];
               n57SupplierProductQuantity = H001A3_n57SupplierProductQuantity[0];
               A57SupplierProductQuantity = H001A3_A57SupplierProductQuantity[0];
               n57SupplierProductQuantity = H001A3_n57SupplierProductQuantity[0];
               E141A2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001A5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      private void E141A2( )
      {
         ...
         edtavDelete_Link = formatLink("supplier.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A4SupplierId,6,0))}, new string[] {"Mode","SupplierId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274583", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwsupplier.js", "?202311222274584", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtSupplierDescription_Internalname = "SUPPLIERDESCRIPTION_"+sGXsfl_27_idx;
         ...
         edtSupplierProductQuantity_Internalname = "SUPPLIERPRODUCTQUANTITY_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtSupplierDescription_Internalname = "SUPPLIERDESCRIPTION_"+sGXsfl_27_fel_idx;
         ...
         edtSupplierProductQuantity_Internalname = "SUPPLIERPRODUCTQUANTITY_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierDescription_Internalname,(string)A6SupplierDescription,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSupplierDescription_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)200,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"GeneXusUnanimo\\Description",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplierProductQuantity_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A57SupplierProductQuantity), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A57SupplierProductQuantity), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSupplierProductQuantity_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A6SupplierDescription));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A57SupplierProductQuantity), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize_properties( )
      {
         ...
         edtSupplierDescription_Jsonclick = "";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SupplierName',fld:'vSUPPLIERNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141A2',iparms:[{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SupplierName',fld:'vSUPPLIERNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SupplierName',fld:'vSUPPLIERNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SupplierName',fld:'vSUPPLIERNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SupplierName',fld:'vSUPPLIERNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11SupplierName = "";
         H001A3_A33SupplierModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H001A3_A32SupplierCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H001A3_A8SupplierEmail = new string[] {""} ;
         H001A3_n8SupplierEmail = new bool[] {false} ;
         H001A3_A7SupplierPhone = new string[] {""} ;
         H001A3_n7SupplierPhone = new bool[] {false} ;
         H001A3_A6SupplierDescription = new string[] {""} ;
         H001A3_n6SupplierDescription = new bool[] {false} ;
         H001A3_A5SupplierName = new string[] {""} ;
         H001A3_A4SupplierId = new int[1] ;
         H001A3_A57SupplierProductQuantity = new short[1] ;
         H001A3_n57SupplierProductQuantity = new bool[] {false} ;
         H001A5_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsupplier__default(),
            new Object[][] {
                new Object[] {
               H001A3_A33SupplierModifiedDate, H001A3_A32SupplierCreatedDate, H001A3_A8SupplierEmail, H001A3_n8SupplierEmail, H001A3_A7SupplierPhone, H001A3_n7SupplierPhone, H001A3_A6SupplierDescription, H001A3_n6SupplierDescription, H001A3_A5SupplierName, H001A3_A4SupplierId,
               H001A3_A57SupplierProductQuantity, H001A3_n57SupplierProductQuantity
               }
               , new Object[] {
               H001A5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "WWSupplier";
      ...
      private string edtSupplierDescription_Jsonclick ;
      ...
      private DateTime[] H001A3_A33SupplierModifiedDate ;
      private DateTime[] H001A3_A32SupplierCreatedDate ;
      private string[] H001A3_A8SupplierEmail ;
      private bool[] H001A3_n8SupplierEmail ;
      private string[] H001A3_A7SupplierPhone ;
      private bool[] H001A3_n7SupplierPhone ;
      private string[] H001A3_A6SupplierDescription ;
      private bool[] H001A3_n6SupplierDescription ;
      private string[] H001A3_A5SupplierName ;
      private int[] H001A3_A4SupplierId ;
      private short[] H001A3_A57SupplierProductQuantity ;
      private bool[] H001A3_n57SupplierProductQuantity ;
      private long[] H001A5_AGRID_nRecordCount ;
   ...
   public class wwsupplier__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A5SupplierName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[SupplierModifiedDate], T1.[SupplierCreatedDate], T1.[SupplierEmail], T1.[SupplierPhone], T1.[SupplierDescription], T1.[SupplierName], T1.[SupplierId], COALESCE( T2.[SupplierProductQuantity], 0) AS SupplierProductQuantity";
         sFromString = " FROM ([Supplier] T1 LEFT JOIN (SELECT COUNT(*) AS SupplierProductQuantity, [SupplierId] FROM [Product] GROUP BY [SupplierId] ) T2 ON T2.[SupplierId] = T1.[SupplierId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SupplierName)) )
         {
            AddWhere(sWhereString, "(T1.[SupplierName] like @lV11SupplierName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[SupplierName]";
      ...
      protected Object[] conditional_H001A5( IGxContext context ,
                                             string AV11SupplierName ,
                                             string A5SupplierName )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Supplier] T1 LEFT JOIN (SELECT COUNT(*) AS SupplierProductQuantity, [SupplierId] FROM [Product] GROUP BY [SupplierId] ) T2 ON T2.[SupplierId] = T1.[SupplierId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SupplierName)) )
         {
            AddWhere(sWhereString, "(T1.[SupplierName] like @lV11SupplierName)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         switch ( cursor )
         {
               ...
               case 1 :
                     return conditional_H001A5(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H001A5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001A5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
