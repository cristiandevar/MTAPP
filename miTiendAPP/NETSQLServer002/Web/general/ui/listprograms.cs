...
namespace GeneXus.Programs.general.ui {
   public class listprograms : GXProcedure
   {
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.general.ui.SdtProgramNames_ProgramName>( context, "ProgramName", "mtaKB") ;
      ...
      void executePrivate( )
      {
         ...
         AV11name = "WWBrand";
         AV12description = "Brands";
         AV13link = formatLink("wwbrand.aspx") ;
         ...
         AV13link = formatLink("wwemployee.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWInvoice";
         AV12description = "Invoices";
         AV13link = formatLink("wwinvoice.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWPurchaseOrder";
         AV12description = "Purchase Orders";
         AV13link = formatLink("wwpurchaseorder.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
