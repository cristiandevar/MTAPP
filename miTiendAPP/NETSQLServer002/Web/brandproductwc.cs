...
namespace GeneXus.Programs {
   public class brandproductwc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6BrandId, AV13Update, AV14Delete, sPrefix) ;
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BrandProductWC.htm");
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               n29ProductModifiedDate = H000H2_n29ProductModifiedDate[0];
               ...
               A18ProductPrice = H000H2_A18ProductPrice[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273274", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("brandproductwc.js", "?202311222273274", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtSectorName_Internalname = sPrefix+"SECTORNAME_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtSectorName_Internalname = sPrefix+"SECTORNAME_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9SectorId), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9SectorId), "ZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6BrandId',fld:'vBRANDID',pic:'ZZZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E130H2',iparms:[{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true},{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9'},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSectorName_Link',ctrl:'SECTORNAME',prop:'Link'},{av:'edtSupplierName_Link',ctrl:'SUPPLIERNAME',prop:'Link'},{av:'edtProductCode_Link',ctrl:'PRODUCTCODE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'A15ProductId',fld:'PRODUCTID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6BrandId',fld:'vBRANDID',pic:'ZZZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6BrandId',fld:'vBRANDID',pic:'ZZZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6BrandId',fld:'vBRANDID',pic:'ZZZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6BrandId',fld:'vBRANDID',pic:'ZZZZZ9'},{av:'AV13Update',fld:'vUPDATE',pic:''},{av:'AV14Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         H000H2_n29ProductModifiedDate = new bool[] {false} ;
         ...
         H000H2_A18ProductPrice = new decimal[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.brandproductwc__default(),
            new Object[][] {
                new Object[] {
               H000H2_A1BrandId, H000H2_A55ProductCode, H000H2_n55ProductCode, H000H2_A29ProductModifiedDate, H000H2_n29ProductModifiedDate, H000H2_A28ProductCreatedDate, H000H2_A5SupplierName, H000H2_A4SupplierId, H000H2_A10SectorName, H000H2_A9SectorId,
               H000H2_A19ProductDescription, H000H2_n19ProductDescription, H000H2_A18ProductPrice, H000H2_A17ProductStock, H000H2_A16ProductName, H000H2_A15ProductId
               }
               , new Object[] {
      ...
      private bool[] H000H2_n29ProductModifiedDate ;
      ...
      private decimal[] H000H2_A18ProductPrice ;
   ...
   public class brandproductwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT T1.[BrandId], T1.[ProductCode], T1.[ProductModifiedDate], T1.[ProductCreatedDate], T2.[SupplierName], T1.[SupplierId], T3.[SectorName], T1.[SectorId], T1.[ProductDescription], T1.[ProductPrice], T1.[ProductStock], T1.[ProductName], T1.[ProductId] FROM (([Product] T1 INNER JOIN [Supplier] T2 ON T2.[SupplierId] = T1.[SupplierId]) INNER JOIN [Sector] T3 ON T3.[SectorId] = T1.[SectorId]) WHERE T1.[BrandId] = @AV6BrandId ORDER BY T1.[BrandId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000H3", "SELECT COUNT(*) FROM (([Product] T1 INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T1.[SupplierId]) INNER JOIN [Sector] T2 ON T2.[SectorId] = T1.[SectorId]) WHERE T1.[BrandId] = @AV6BrandId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
