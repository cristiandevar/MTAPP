   ...
   public class productdetailwc : GXWebComponent
   {
      ...
      protected void WB1F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProductDetailWC.htm");
      ...
      protected void RF1F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A15ProductId = H001F3_A15ProductId[0];
               AssignAttri(sPrefix, false, "A15ProductId", StringUtil.LTrimStr( (decimal)(A15ProductId), 6, 0));
               A66PurchaseOrderClosedDate = H001F3_A66PurchaseOrderClosedDate[0];
               n66PurchaseOrderClosedDate = H001F3_n66PurchaseOrderClosedDate[0];
               A53PurchaseOrderModifiedDate = H001F3_A53PurchaseOrderModifiedDate[0];
               n53PurchaseOrderModifiedDate = H001F3_n53PurchaseOrderModifiedDate[0];
               A52PurchaseOrderCreatedDate = H001F3_A52PurchaseOrderCreatedDate[0];
               A5SupplierName = H001F3_A5SupplierName[0];
               A4SupplierId = H001F3_A4SupplierId[0];
               A50PurchaseOrderId = H001F3_A50PurchaseOrderId[0];
               A67PurchaseOrderDetailsQuantity = H001F3_A67PurchaseOrderDetailsQuantity[0];
               n67PurchaseOrderDetailsQuantity = H001F3_n67PurchaseOrderDetailsQuantity[0];
               A66PurchaseOrderClosedDate = H001F3_A66PurchaseOrderClosedDate[0];
               n66PurchaseOrderClosedDate = H001F3_n66PurchaseOrderClosedDate[0];
               A53PurchaseOrderModifiedDate = H001F3_A53PurchaseOrderModifiedDate[0];
               n53PurchaseOrderModifiedDate = H001F3_n53PurchaseOrderModifiedDate[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PURCHASEORDERID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A50PurchaseOrderId), "ZZZZZ9"), context));
      }
      ...
      private void E131F2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("purchaseorder.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A50PurchaseOrderId,6,0))}, new string[] {"Mode","PurchaseOrderId"}) ;
         edtavDelete_Link = formatLink("purchaseorder.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A50PurchaseOrderId,6,0))}, new string[] {"Mode","PurchaseOrderId"}) ;
      ...
      protected void E111F2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("purchaseorder.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","PurchaseOrderId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222273679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("productdetailwc.js", "?202311222273679", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtPurchaseOrderDetailsQuantity_Internalname = sPrefix+"PURCHASEORDERDETAILSQUANTITY_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtPurchaseOrderDetailsQuantity_Internalname = sPrefix+"PURCHASEORDERDETAILSQUANTITY_"+sGXsfl_22_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E131F2',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true},{av:'A4SupplierId',fld:'SUPPLIERID',pic:'ZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSupplierName_Link',ctrl:'SUPPLIERNAME',prop:'Link'},{av:'edtPurchaseOrderCreatedDate_Link',ctrl:'PURCHASEORDERCREATEDDATE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111F2',iparms:[{av:'A50PurchaseOrderId',fld:'PURCHASEORDERID',pic:'ZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001F3_A61PurchaseOrderDetailId = new int[1] ;
         H001F3_A15ProductId = new int[1] ;
         H001F3_A66PurchaseOrderClosedDate = new DateTime[] {DateTime.MinValue} ;
         H001F3_n66PurchaseOrderClosedDate = new bool[] {false} ;
         H001F3_A53PurchaseOrderModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H001F3_n53PurchaseOrderModifiedDate = new bool[] {false} ;
         H001F3_A52PurchaseOrderCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H001F3_A5SupplierName = new string[] {""} ;
         H001F3_A4SupplierId = new int[1] ;
         H001F3_A50PurchaseOrderId = new int[1] ;
         H001F3_A67PurchaseOrderDetailsQuantity = new short[1] ;
         H001F3_n67PurchaseOrderDetailsQuantity = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productdetailwc__default(),
            new Object[][] {
                new Object[] {
               H001F3_A61PurchaseOrderDetailId, H001F3_A15ProductId, H001F3_A66PurchaseOrderClosedDate, H001F3_n66PurchaseOrderClosedDate, H001F3_A53PurchaseOrderModifiedDate, H001F3_n53PurchaseOrderModifiedDate, H001F3_A52PurchaseOrderCreatedDate, H001F3_A5SupplierName, H001F3_A4SupplierId, H001F3_A50PurchaseOrderId,
               H001F3_A67PurchaseOrderDetailsQuantity, H001F3_n67PurchaseOrderDetailsQuantity
               }
               , new Object[] {
      ...
      private int[] H001F3_A61PurchaseOrderDetailId ;
      private int[] H001F3_A15ProductId ;
      private DateTime[] H001F3_A66PurchaseOrderClosedDate ;
      private bool[] H001F3_n66PurchaseOrderClosedDate ;
      private DateTime[] H001F3_A53PurchaseOrderModifiedDate ;
      private bool[] H001F3_n53PurchaseOrderModifiedDate ;
      private DateTime[] H001F3_A52PurchaseOrderCreatedDate ;
      private string[] H001F3_A5SupplierName ;
      private int[] H001F3_A4SupplierId ;
      private int[] H001F3_A50PurchaseOrderId ;
      private short[] H001F3_A67PurchaseOrderDetailsQuantity ;
      private bool[] H001F3_n67PurchaseOrderDetailsQuantity ;
   ...
   public class productdetailwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001F3", "SELECT T1.[PurchaseOrderDetailId], T1.[ProductId], T2.[PurchaseOrderClosedDate], T2.[PurchaseOrderModifiedDate], T2.[PurchaseOrderCreatedDate], T3.[SupplierName], T2.[SupplierId], T1.[PurchaseOrderId], COALESCE( T4.[PurchaseOrderDetailsQuantity], 0) AS PurchaseOrderDetailsQuantity FROM ((([PurchaseOrderDetail] T1 INNER JOIN [PurchaseOrder] T2 ON T2.[PurchaseOrderId] = T1.[PurchaseOrderId]) INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T2.[SupplierId]) LEFT JOIN (SELECT COUNT(*) AS PurchaseOrderDetailsQuantity, [PurchaseOrderId] FROM [PurchaseOrderDetail] GROUP BY [PurchaseOrderId] ) T4 ON T4.[PurchaseOrderId] = T1.[PurchaseOrderId]) WHERE T1.[ProductId] = @AV6ProductId ORDER BY T1.[ProductId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F3,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001F5", "SELECT COUNT(*) FROM ((([PurchaseOrderDetail] T1 INNER JOIN [PurchaseOrder] T2 ON T2.[PurchaseOrderId] = T1.[PurchaseOrderId]) INNER JOIN [Supplier] T3 ON T3.[SupplierId] = T2.[SupplierId]) LEFT JOIN (SELECT COUNT(*) AS PurchaseOrderDetailsQuantity, [PurchaseOrderId] FROM [PurchaseOrderDetail] GROUP BY [PurchaseOrderId] ) T4 ON T4.[PurchaseOrderId] = T1.[PurchaseOrderId]) WHERE T1.[ProductId] = @AV6ProductId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
