...
namespace GeneXus.Programs {
   public class viewinvoice : GXDataArea
   {
      public viewinvoice( )
      {
      ...
      public viewinvoice( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12InvoiceId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12InvoiceId", StringUtil.LTrimStr( (decimal)(AV12InvoiceId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewinvoice.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vINVOICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12InvoiceId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewInvoice");
         forbiddenHiddens.Add("InvoiceDate", context.localUtil.Format(A21InvoiceDate, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewinvoice:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewinvoice.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceId","TabCode"})  ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Invoices", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewInvoice.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtInvoiceDate_Internalname, context.localUtil.Format(A21InvoiceDate, "99/99/99"), context.localUtil.Format( A21InvoiceDate, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtInvoiceDate_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtInvoiceDate_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "right", false, "", "HLP_ViewInvoice.htm");
            GxWebStd.gx_bitmap( context, edtInvoiceDate_Internalname+"_dp_trigger", context.GetImagePath( "", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtInvoiceDate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewInvoice.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewInvoice.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDetail_title_Internalname, "Detail", "", "", lblDetail_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewInvoice.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Invoice", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A20InvoiceId = H000M2_A20InvoiceId[0];
               A21InvoiceDate = H000M2_A21InvoiceDate[0];
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12InvoiceId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vINVOICEID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewinvoice:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110M2( )
      {
         ...
         {
            A20InvoiceId = H000M3_A20InvoiceId[0];
            A21InvoiceDate = H000M3_A21InvoiceDate[0];
            AssignAttri("", false, "A21InvoiceDate", context.localUtil.Format(A21InvoiceDate, "99/99/99"));
            AV16GXLvl7 = 1;
            Form.Caption = context.localUtil.DToC( A21InvoiceDate, 1, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwinvoice.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "InvoiceGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "invoicegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "InvoiceGeneral";
               WebComp_Generalwc_Component = "InvoiceGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12InvoiceId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detail") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Detailwc_Component), StringUtil.Lower( "InvoiceDetailWC")) != 0 )
            {
               WebComp_Detailwc = getWebComponent(GetType(), "GeneXus.Programs", "invoicedetailwc", new Object[] {context} );
               WebComp_Detailwc.ComponentInit();
               WebComp_Detailwc.Name = "InvoiceDetailWC";
               WebComp_Detailwc_Component = "InvoiceDetailWC";
            }
            if ( StringUtil.Len( WebComp_Detailwc_Component) != 0 )
            {
               WebComp_Detailwc.setjustcreated();
               WebComp_Detailwc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12InvoiceId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12InvoiceId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12InvoiceId", StringUtil.LTrimStr( (decimal)(AV12InvoiceId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274091", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinvoice.js", "?202311222274091", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12InvoiceId',fld:'vINVOICEID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A21InvoiceDate',fld:'INVOICEDATE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000M2_A20InvoiceId = new int[1] ;
         H000M2_A21InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000M3_A20InvoiceId = new int[1] ;
         H000M3_A21InvoiceDate = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinvoice__default(),
            new Object[][] {
                new Object[] {
               H000M2_A20InvoiceId, H000M2_A21InvoiceDate
               }
               , new Object[] {
               H000M3_A20InvoiceId, H000M3_A21InvoiceDate
               }
            }
         );
      ...
      private int AV12InvoiceId ;
      private int wcpOAV12InvoiceId ;
      ...
      private int[] H000M2_A20InvoiceId ;
      private DateTime[] H000M2_A21InvoiceDate ;
      private int[] H000M3_A20InvoiceId ;
      private DateTime[] H000M3_A21InvoiceDate ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewinvoice__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12InvoiceId",GXType.Int32,6,0)
          };
          Object[] prmH000M3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000M2", "SELECT [InvoiceId], [InvoiceDate] FROM [Invoice] WHERE [InvoiceId] = @AV12InvoiceId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000M3", "SELECT [InvoiceId], [InvoiceDate] FROM [Invoice] WHERE [InvoiceId] = @AV12InvoiceId ORDER BY [InvoiceId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
