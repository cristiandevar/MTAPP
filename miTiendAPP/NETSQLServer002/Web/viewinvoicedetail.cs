...
namespace GeneXus.Programs {
   public class viewinvoicedetail : GXDataArea
   {
      ...
      public viewinvoicedetail( IGxContext context )
      {
      ...
      public void execute( int aP0_InvoiceDetailId ,
                           string aP1_TabCode )
      {
         this.AV12InvoiceDetailId = aP0_InvoiceDetailId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12InvoiceDetailId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12InvoiceDetailId", StringUtil.LTrimStr( (decimal)(AV12InvoiceDetailId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceDetailId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewinvoicedetail.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceDetailId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceDetailId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vINVOICEDETAILID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12InvoiceDetailId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceDetailId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewInvoiceDetail");
         forbiddenHiddens.Add("InvoiceDetailQuantity", context.localUtil.Format( (decimal)(A26InvoiceDetailQuantity), "ZZZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewinvoicedetail:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewinvoicedetail.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12InvoiceDetailId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"InvoiceDetailId","TabCode"})  ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Invoice Details", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewInvoiceDetail.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewInvoiceDetail.htm");
            /* Div Control */
      ...
      protected void START0Q2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Invoice Detail", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0Q2( )
      {
         ...
         {
            /* Using cursor H000Q2 */
            pr_default.execute(0, new Object[] {AV12InvoiceDetailId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A25InvoiceDetailId = H000Q2_A25InvoiceDetailId[0];
               A26InvoiceDetailQuantity = H000Q2_A26InvoiceDetailQuantity[0];
      ...
      protected void STRUP0Q0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12InvoiceDetailId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vINVOICEDETAILID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewinvoicedetail:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110Q2( )
      {
         ...
         AV16GXLvl7 = 0;
         /* Using cursor H000Q3 */
         pr_default.execute(1, new Object[] {AV12InvoiceDetailId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A25InvoiceDetailId = H000Q3_A25InvoiceDetailId[0];
            A26InvoiceDetailQuantity = H000Q3_A26InvoiceDetailQuantity[0];
            AssignAttri("", false, "A26InvoiceDetailQuantity", StringUtil.LTrimStr( (decimal)(A26InvoiceDetailQuantity), 6, 0));
            AV16GXLvl7 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A26InvoiceDetailQuantity), 6, 0);
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwinvoicedetail.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "InvoiceDetailGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "invoicedetailgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "InvoiceDetailGeneral";
               WebComp_Generalwc_Component = "InvoiceDetailGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12InvoiceDetailId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12InvoiceDetailId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12InvoiceDetailId", StringUtil.LTrimStr( (decimal)(AV12InvoiceDetailId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vINVOICEDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12InvoiceDetailId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231122039760", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinvoicedetail.js", "?20231122039760", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Invoice Detail";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12InvoiceDetailId',fld:'vINVOICEDETAILID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A26InvoiceDetailQuantity',fld:'INVOICEDETAILQUANTITY',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000Q2_A25InvoiceDetailId = new int[1] ;
         H000Q2_A26InvoiceDetailQuantity = new int[1] ;
         hsh = "";
         H000Q3_A25InvoiceDetailId = new int[1] ;
         H000Q3_A26InvoiceDetailQuantity = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinvoicedetail__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A25InvoiceDetailId, H000Q2_A26InvoiceDetailQuantity
               }
               , new Object[] {
               H000Q3_A25InvoiceDetailId, H000Q3_A26InvoiceDetailQuantity
               }
            }
         );
      ...
      private int AV12InvoiceDetailId ;
      private int wcpOAV12InvoiceDetailId ;
      ...
      private int[] H000Q2_A25InvoiceDetailId ;
      private int[] H000Q2_A26InvoiceDetailQuantity ;
      private int[] H000Q3_A25InvoiceDetailId ;
      private int[] H000Q3_A26InvoiceDetailQuantity ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewinvoicedetail__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12InvoiceDetailId",GXType.Int32,6,0)
          };
          Object[] prmH000Q3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT [InvoiceDetailId], [InvoiceDetailQuantity] FROM [InvoiceDetail] WHERE [InvoiceDetailId] = @AV12InvoiceDetailId ORDER BY [InvoiceDetailId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000Q3", "SELECT [InvoiceDetailId], [InvoiceDetailQuantity] FROM [InvoiceDetail] WHERE [InvoiceDetailId] = @AV12InvoiceDetailId ORDER BY [InvoiceDetailId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
