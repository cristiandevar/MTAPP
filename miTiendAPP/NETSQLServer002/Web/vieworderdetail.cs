...
namespace GeneXus.Programs {
   public class vieworderdetail : GXDataArea
   {
      ...
      public vieworderdetail( IGxContext context )
      {
      ...
      public void execute( int aP0_OrderDetailId ,
                           string aP1_TabCode )
      {
         this.AV12OrderDetailId = aP0_OrderDetailId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "OrderDetailId");
            ...
            {
               AV12OrderDetailId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12OrderDetailId", StringUtil.LTrimStr( (decimal)(AV12OrderDetailId), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vORDERDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12OrderDetailId), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("vieworderdetail.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12OrderDetailId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"OrderDetailId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vORDERDETAILID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12OrderDetailId), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vORDERDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12OrderDetailId), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewOrderDetail");
         forbiddenHiddens.Add("OrderDetailQuantity", context.localUtil.Format( (decimal)(A45OrderDetailQuantity), "ZZZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("vieworderdetail:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("vieworderdetail.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12OrderDetailId,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"OrderDetailId","TabCode"})  ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Order Details", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewOrderDetail.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewOrderDetail.htm");
            /* Div Control */
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Order Detail", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0T2( )
      {
         ...
         {
            /* Using cursor H000T2 */
            pr_default.execute(0, new Object[] {AV12OrderDetailId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A44OrderDetailId = H000T2_A44OrderDetailId[0];
               A45OrderDetailQuantity = H000T2_A45OrderDetailQuantity[0];
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12OrderDetailId = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vORDERDETAILID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("vieworderdetail:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110T2( )
      {
         ...
         AV16GXLvl7 = 0;
         /* Using cursor H000T3 */
         pr_default.execute(1, new Object[] {AV12OrderDetailId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A44OrderDetailId = H000T3_A44OrderDetailId[0];
            A45OrderDetailQuantity = H000T3_A45OrderDetailQuantity[0];
            AssignAttri("", false, "A45OrderDetailQuantity", StringUtil.LTrimStr( (decimal)(A45OrderDetailQuantity), 6, 0));
            AV16GXLvl7 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A45OrderDetailQuantity), 6, 0);
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wworderdetail.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "OrderDetailGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "orderdetailgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "OrderDetailGeneral";
               WebComp_Generalwc_Component = "OrderDetailGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12OrderDetailId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12OrderDetailId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12OrderDetailId", StringUtil.LTrimStr( (decimal)(AV12OrderDetailId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vORDERDETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12OrderDetailId), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231122039832", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("vieworderdetail.js", "?20231122039832", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Order Detail";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12OrderDetailId',fld:'vORDERDETAILID',pic:'ZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A45OrderDetailQuantity',fld:'ORDERDETAILQUANTITY',pic:'ZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000T2_A44OrderDetailId = new int[1] ;
         H000T2_A45OrderDetailQuantity = new int[1] ;
         hsh = "";
         H000T3_A44OrderDetailId = new int[1] ;
         H000T3_A45OrderDetailQuantity = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.vieworderdetail__default(),
            new Object[][] {
                new Object[] {
               H000T2_A44OrderDetailId, H000T2_A45OrderDetailQuantity
               }
               , new Object[] {
               H000T3_A44OrderDetailId, H000T3_A45OrderDetailQuantity
               }
            }
         );
      ...
      private int AV12OrderDetailId ;
      private int wcpOAV12OrderDetailId ;
      ...
      private int[] H000T2_A44OrderDetailId ;
      private int[] H000T2_A45OrderDetailQuantity ;
      private int[] H000T3_A44OrderDetailId ;
      private int[] H000T3_A45OrderDetailQuantity ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class vieworderdetail__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12OrderDetailId",GXType.Int32,6,0)
          };
          Object[] prmH000T3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT [OrderDetailId], [OrderDetailQuantity] FROM [OrderDetail] WHERE [OrderDetailId] = @AV12OrderDetailId ORDER BY [OrderDetailId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000T3", "SELECT [OrderDetailId], [OrderDetailQuantity] FROM [OrderDetail] WHERE [OrderDetailId] = @AV12OrderDetailId ORDER BY [OrderDetailId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
