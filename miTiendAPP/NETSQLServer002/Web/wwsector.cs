...
namespace GeneXus.Programs {
   public class wwsector : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11SectorName = GetPar( "SectorName");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11SectorName, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSECTORNAME", AV11SectorName);
         /* Send saved values. */
      ...
      protected void WB160( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavSectorname_Internalname, "Sector Name", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSectorname_Internalname, AV11SectorName, StringUtil.RTrim( context.localUtil.Format( AV11SectorName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavSectorname_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavSectorname_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "left", true, "", "HLP_WWSector.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Sectorname Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vSECTORNAME"), AV11SectorName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA162( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavSectorname_Internalname;
      ...
      protected void RF162( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11SectorName = StringUtil.Concat( StringUtil.RTrim( AV11SectorName), "%", "");
            /* Using cursor H00162 */
            pr_default.execute(0, new Object[] {lV11SectorName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A35SectorModifiedDate = H00162_A35SectorModifiedDate[0];
               n35SectorModifiedDate = H00162_n35SectorModifiedDate[0];
               A34SectorCreatedDate = H00162_A34SectorCreatedDate[0];
               A11SectorDescription = H00162_A11SectorDescription[0];
               n11SectorDescription = H00162_n11SectorDescription[0];
               A10SectorName = H00162_A10SectorName[0];
               A9SectorId = H00162_A9SectorId[0];
               E14162 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SECTORID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A9SectorId), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11SectorName = StringUtil.Concat( StringUtil.RTrim( AV11SectorName), "%", "");
         /* Using cursor H00163 */
         pr_default.execute(1, new Object[] {lV11SectorName});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11SectorName = GridState.FilterValues("Sectorname");
            AssignAttri("", false, "AV11SectorName", AV11SectorName);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("SectorName", AV11SectorName);
      }
      ...
      protected void STRUP160( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11SectorName = cgiGet( edtavSectorname_Internalname);
            AssignAttri("", false, "AV11SectorName", AV11SectorName);
      ...
      private void E14162( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("sector.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A9SectorId,6,0))}, new string[] {"Mode","SectorId"}) ;
         edtavDelete_Link = formatLink("sector.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A9SectorId,6,0))}, new string[] {"Mode","SectorId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202311222274444", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwsector.js", "?202311222274444", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtSectorName_Internalname = "SECTORNAME_"+sGXsfl_27_idx;
         edtSectorDescription_Internalname = "SECTORDESCRIPTION_"+sGXsfl_27_idx;
         edtSectorCreatedDate_Internalname = "SECTORCREATEDDATE_"+sGXsfl_27_idx;
         edtSectorModifiedDate_Internalname = "SECTORMODIFIEDDATE_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtSectorName_Internalname = "SECTORNAME_"+sGXsfl_27_fel_idx;
         edtSectorDescription_Internalname = "SECTORDESCRIPTION_"+sGXsfl_27_fel_idx;
         edtSectorCreatedDate_Internalname = "SECTORCREATEDDATE_"+sGXsfl_27_fel_idx;
         edtSectorModifiedDate_Internalname = "SECTORMODIFIEDDATE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9SectorId), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9SectorId), "ZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorDescription_Internalname,(string)A11SectorDescription,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorDescription_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)200,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"GeneXusUnanimo\\Description",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSectorModifiedDate_Internalname,context.localUtil.Format(A35SectorModifiedDate, "99/99/99"),context.localUtil.Format( A35SectorModifiedDate, "99/99/99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSectorModifiedDate_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A9SectorId), 6, 0, ".", ""))));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A11SectorDescription));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A34SectorCreatedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( context.localUtil.Format(A35SectorModifiedDate, "99/99/99")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavSectorname_Internalname = "vSECTORNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         edtSectorDescription_Jsonclick = "";
         edtSectorName_Jsonclick = "";
         edtSectorName_Link = "";
         edtSectorId_Jsonclick = "";
         subGrid_Class = "ww__grid";
         subGrid_Backcolorstyle = 0;
         edtavSectorname_Jsonclick = "";
         edtavSectorname_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14162',iparms:[{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSectorName_Link',ctrl:'SECTORNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11162',iparms:[{av:'A9SectorId',fld:'SECTORID',pic:'ZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11SectorName',fld:'vSECTORNAME',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11SectorName = "";
         H00162_A35SectorModifiedDate = new DateTime[] {DateTime.MinValue} ;
         H00162_n35SectorModifiedDate = new bool[] {false} ;
         H00162_A34SectorCreatedDate = new DateTime[] {DateTime.MinValue} ;
         H00162_A11SectorDescription = new string[] {""} ;
         H00162_n11SectorDescription = new bool[] {false} ;
         H00162_A10SectorName = new string[] {""} ;
         H00162_A9SectorId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsector__default(),
            new Object[][] {
                new Object[] {
               H00162_A35SectorModifiedDate, H00162_n35SectorModifiedDate, H00162_A34SectorCreatedDate, H00162_A11SectorDescription, H00162_n11SectorDescription, H00162_A10SectorName, H00162_A9SectorId
               }
               , new Object[] {
      ...
      private int edtavSectorname_Enabled ;
      ...
      private string edtavSectorname_Internalname ;
      private string edtavSectorname_Jsonclick ;
      ...
      private string edtSectorDescription_Jsonclick ;
      ...
      private DateTime[] H00162_A35SectorModifiedDate ;
      private bool[] H00162_n35SectorModifiedDate ;
      private DateTime[] H00162_A34SectorCreatedDate ;
      private string[] H00162_A11SectorDescription ;
      private bool[] H00162_n11SectorDescription ;
      private string[] H00162_A10SectorName ;
      private int[] H00162_A9SectorId ;
   ...
   public class wwsector__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A10SectorName )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [SectorModifiedDate], [SectorCreatedDate], [SectorDescription], [SectorName], [SectorId]";
         sFromString = " FROM [Sector]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11SectorName)) )
         {
            AddWhere(sWhereString, "([SectorName] like @lV11SectorName)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [SectorName]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00162(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H00163(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11SectorName",GXType.NVarChar,60,0) ,
